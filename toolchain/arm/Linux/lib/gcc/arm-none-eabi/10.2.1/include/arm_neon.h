...
{
    return (int8x8_t) __builtin_shuffle (__a, (uint8x8_t)
    {
        7, 6, 5, 4, 3, 2, 1, 0
    });
}
...
{
    return (int16x4_t) __builtin_shuffle (__a, (uint16x4_t)
    {
        3, 2, 1, 0
    });
}
...
{
    return (int32x2_t) __builtin_shuffle (__a, (uint32x2_t)
    {
        1, 0
    });
}
...
{
    return (float32x2_t) __builtin_shuffle (__a, (uint32x2_t)
    {
        1, 0
    });
}
...
{
    return (uint8x8_t) __builtin_shuffle (__a, (uint8x8_t)
    {
        7, 6, 5, 4, 3, 2, 1, 0
    });
}
...
{
    return (uint16x4_t) __builtin_shuffle (__a, (uint16x4_t)
    {
        3, 2, 1, 0
    });
}
...
{
    return (uint32x2_t) __builtin_shuffle (__a, (uint32x2_t)
    {
        1, 0
    });
}
...
{
    return (poly8x8_t) __builtin_shuffle (__a, (uint8x8_t)
    {
        7, 6, 5, 4, 3, 2, 1, 0
    });
}
...
{
    return (poly16x4_t) __builtin_shuffle (__a, (uint16x4_t)
    {
        3, 2, 1, 0
    });
}
...
{
    return (int16x8_t) __builtin_shuffle (__a, (uint16x8_t)
    {
        3, 2, 1, 0, 7, 6, 5, 4
    });
}
...
{
    return (int32x4_t) __builtin_shuffle (__a, (uint32x4_t)
    {
        1, 0, 3, 2
    });
}
...
{
    return (float32x4_t) __builtin_shuffle (__a, (uint32x4_t)
    {
        1, 0, 3, 2
    });
}
...
{
    return (uint16x8_t) __builtin_shuffle (__a, (uint16x8_t)
    {
        3, 2, 1, 0, 7, 6, 5, 4
    });
}
...
{
    return (uint32x4_t) __builtin_shuffle (__a, (uint32x4_t)
    {
        1, 0, 3, 2
    });
}
...
{
    return (poly8x16_t) __builtin_shuffle (__a, (uint8x16_t)
    {
        7, 6, 5, 4, 3, 2, 1, 0, 15, 14, 13, 12, 11, 10, 9, 8
    });
}
...
{
    return (poly16x8_t) __builtin_shuffle (__a, (uint16x8_t)
    {
        3, 2, 1, 0, 7, 6, 5, 4
    });
}
...
vtrn_s16 (int16x4_t __a, int16x4_t __b)
{
    int16x4x2_t __rv;
#ifdef __ARM_BIG_ENDIAN
    __rv.val[0] = __builtin_shuffle (__a, __b, (uint16x4_t)
    {
        5, 1, 7, 3
    });
...
vtrn_s32 (int32x2_t __a, int32x2_t __b)
{
    int32x2x2_t __rv;
#ifdef __ARM_BIG_ENDIAN
    __rv.val[0] = __builtin_shuffle (__a, __b, (uint32x2_t)
    {
        3, 1
    });
    __rv.val[1] = __builtin_shuffle (__a, __b, (uint32x2_t)
    {
        2, 0
    });
#else
...
vtrnq_s32 (int32x4_t __a, int32x4_t __b)
{
    int32x4x2_t __rv;
#ifdef __ARM_BIG_ENDIAN
    __rv.val[0] = __builtin_shuffle (__a, __b, (uint32x4_t)
    {
        5, 1, 7, 3
    });
    __rv.val[1] = __builtin_shuffle (__a, __b, (uint32x4_t)
    {
        4, 0, 6, 2
    });
#else
...
{
    return (float16x4_t)__builtin_shuffle (__a, (uint16x4_t)
    {
        3, 2, 1, 0
    });
}
