...
mode_inner_inline (machine_mode mode)
{
    ...
    case E_CC_DGTmode:
        return E_CC_DGTmode;
    case E_CC_DLEUmode:
        return E_CC_DLEUmode;
    case E_CC_DLTUmode:
        return E_CC_DLTUmode;
    case E_CC_DGEUmode:
        return E_CC_DGEUmode;
    case E_CC_DGTUmode:
        return E_CC_DGTUmode;
    case E_CC_Cmode:
        return E_CC_Cmode;
    case E_CC_Bmode:
        return E_CC_Bmode;
...
mode_unit_precision_inline (machine_mode mode)
{
    ...
    case E_BImode:
        return 1;
    case E_QImode:
        return 1 * BITS_PER_UNIT;
    case E_HImode:
        return 2 * BITS_PER_UNIT;
    case E_SImode:
        return 4 * BITS_PER_UNIT;
    case E_DImode:
        return 8 * BITS_PER_UNIT;
    case E_TImode:
        return 16 * BITS_PER_UNIT;
    case E_EImode:
        return 24 * BITS_PER_UNIT;
    case E_OImode:
        return 32 * BITS_PER_UNIT;
    case E_CImode:
        return 48 * BITS_PER_UNIT;
    case E_XImode:
        return 64 * BITS_PER_UNIT;
    case E_QQmode:
        return 1 * BITS_PER_UNIT;
    case E_HQmode:
        return 2 * BITS_PER_UNIT;
