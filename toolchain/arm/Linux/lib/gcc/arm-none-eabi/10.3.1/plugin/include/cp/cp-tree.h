...
struct named_decl_hash : ggc_remove <tree>
{
    ...
    static inline void mark_empty (value_type &p)
    {
        p = NULL_TREE;
    }
    static inline bool is_empty (value_type p)
    {
        return !p;
    }
...
public:
    ...
    tree &operator[] (unsigned i) const
    {
        return (*v)[i];
    }
...
public:
    ...
    ~temp_override()
    {
        overridden_variable = saved_value;
    }
};
...
struct named_label_hash : ggc_remove <named_label_entry *>
{
    ...
    static const bool empty_zero_p = true;
    inline static void mark_empty (value_type &p)
    {
        p = NULL;
    }
    inline static bool is_empty (value_type p)
    {
        return !p;
    }

    /* Nothing is deletable.  Everything is insertable.  */
    inline static bool is_deleted (value_type)
    {
        return false;
    }
    inline static void mark_deleted (value_type)
    {
        gcc_unreachable ();
    }
};
...
inline tree ovl_op_identifier (tree_code code)
{
...
public:
    ...
    bool was_inaccessible_p () const
    {
        return m_was_inaccessible;
    }
    tree get_decl () const
    {
        return m_decl;
    }
    tree get_diag_decl () const
    {
        return m_diag_decl;
    }
