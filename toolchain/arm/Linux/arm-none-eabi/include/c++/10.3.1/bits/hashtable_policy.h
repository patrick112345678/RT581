...
public:
    ...
    _M_curr() const
    {
        return _M_cur;    // for equality ops
    }

    std::size_t
    _M_get_bucket() const
    {
        return _M_bucket;    // for debug mode
    }
};
...
public:
    ...
    _M_curr() const
    {
        return _M_cur;    // for equality ops and debug mode
    }
