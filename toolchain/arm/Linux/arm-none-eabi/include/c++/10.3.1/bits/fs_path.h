...
template<typename _Source>
_Source
_S_range_begin(_Source __begin)
{
    return __begin;
}
...
private:
    ...
    struct _List
    {
        ...
        void clear();
        void swap(_List &__l) noexcept
        {
            _M_impl.swap(__l._M_impl);
        }
...
path::u16string() const
{
    return string<char16_t>();
}

inline std::u32string
path::u32string() const
{
