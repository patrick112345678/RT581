...
extern uint32_t Timer_Ch0_Capture_Value_Get(uint32_t timer_id);
extern uint32_t Timer_Ch1_Capture_Value_Get(uint32_t timer_id);
extern uint32_t Timer_Ch0_Capture_Int_Status(uint32_t timer_id);
extern uint32_t Timer_Ch1_Capture_Int_Status(uint32_t timer_id);

extern uint32_t get_timer_enable_status(uint32_t timer_id);
extern uint32_t get_timer32k_enable_status(uint32_t timer_id);
