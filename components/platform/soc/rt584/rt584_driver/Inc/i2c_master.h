...
/** @addtogroup I2C_MASTER_Driver I2C MASTER Driver
  @{
*/

/** @addtogroup I2C_MASTER_EXPORTED_CONSTANTS I2C MASTER Exported Constants
  @{
*/
...
#define I2C_CLOCK_100K      2       /*!< I2C Master running in 100KHz  \hideinitializer */
#define I2C_CLOCK_800K      3       /*!< I2C Master running in 800KHz  \hideinitializer */
#define I2C_CLOCK_1M        4       /*!< I2C Master running in 800KHz  \hideinitializer */
#define I2C_CLOCK_MAX       5       /*!< I2C Master running in 100KHz  \hideinitializer */
...
/*@}*/ /* end of group I2C_MASTER_EXPORTED_CONSTANTS */

/** @addtogroup I2C_MASTER_EXPORTED_FUNCTIONS I2C Master Exported Functions
  @{
*/


/**
 * @brief I2C finish routine callback for user application.
 *
...
uint32_t i2c_init(uint32_t master_id, uint32_t I2C_SPEED);
 ...
 *
 * @retval
 *     STATUS_EBUSY    ---  I2C Master is busy for previous tranfer request..
 *     STATUS_NO_INIT  ---  I2C Master does NOT initial, pleae call i2c_init before this request.
 *     STATUS_INVALID_PARAM --- transfer data size is too large.
 *     STATUS_SUCCESS  ---  This request is in progressing...
 *
 * @details
 ...
 *     STATUS_EBUSY    ---  I2C Master is busy for previous tranfer request..
 *     STATUS_NO_INIT  ---  I2C Master does NOT initial, pleae call i2c_init before this request.
 *     STATUS_INVALID_PARAM --- receive data size is too large.
 *     STATUS_SUCCESS  ---  This request is in progressing...
 *
 * @details
 *       Notice: This function is non-blocking and returns as soon as the driver
...
/*@}*/ /* end of group I2C_MASTER_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group I2C_MASTER_Driver */
