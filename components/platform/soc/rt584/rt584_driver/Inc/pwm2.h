...
#define PWM_DISABLE_PWM                 (0x01UL << PWM_CFG0_PWM_ENA_SHFT)
#define PWM_DISABLE_CLK                 (0x01UL << PWM_CFG0_CK_ENA_SHFT)
...
typedef struct
{
    ...
    pwm_dma_smp_fmt_t     pwm_dma_smp_fmt;     /**< PWM DMA sample format configuration. */
    pwm_counter_mode_t    pwm_counter_mode;    /**< PWM counter mode configuration. */
    pwm_counter_trig_t      pwm_counter_trig;
    pwm_register_mode_t     pwm_reg_mode;
    pwm_regmode_data_t      pwm_play_number;
    uint16_t              pwm_count_end_val;   /**< PWM counter end value configuration. */
} pwm_reg_para_head_t;
