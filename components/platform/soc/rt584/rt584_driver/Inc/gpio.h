...
#define  MAX_NUMBER_OF_PINS    (32)           /*!< Specify Maximum Pins of GPIO  \hideinitializer */
...
#define  DEBOUNCE_SLOWCLOCKS_32     (0)       /*!< setting for sampling cycle = 32 clocks  \hideinitializer */
#define  DEBOUNCE_SLOWCLOCKS_64     (1)       /*!< setting for sampling cycle = 64 clocks  \hideinitializer */
#define  DEBOUNCE_SLOWCLOCKS_128    (2)       /*!< setting for sampling cycle = 128 clocks  \hideinitializer */
#define  DEBOUNCE_SLOWCLOCKS_256    (3)       /*!< setting for sampling cycle = 256 clocks  \hideinitializer */
#define  DEBOUNCE_SLOWCLOCKS_512    (4)       /*!< setting for sampling cycle = 512 clocks  \hideinitializer */
#define  DEBOUNCE_SLOWCLOCKS_1024   (5)       /*!< setting for sampling cycle = 1024 clocks  \hideinitializer */
#define  DEBOUNCE_SLOWCLOCKS_2048   (6)       /*!< setting for sampling cycle = 2048 clocks  \hideinitializer */
#define  DEBOUNCE_SLOWCLOCKS_4096   (7)       /*!< setting for sampling cycle = 4096 clocks  \hideinitializer */
