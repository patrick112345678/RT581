...
{                                                                       \
  ...
  {                                                                     \
    ...
    ZB_HTOLE16((zb_uint8_t*)&((data_ptr)->zone_status_mask), (zb_uint8_t*)&(src_ptr->zone_status_mask)); \
  }                                                                     \
}
...
{                                                                               \
  ...
  {                                                                             \
    ...
    for(i=0; i<ZB_ZCL_IAS_ACE_GET_ZONE_ID_MAP_LENGTH; i++)                      \
    {                                                                           \
      ZB_HTOLE16((zb_uint8_t*)&((data_ptr)->zone_id_map[i]), (zb_uint8_t*)&(src_ptr->zone_id_map[i]));    \
    }                                                                           \
  }                                                                             \
}
