...
{                                                                               \
  ...
  {                                                                             \
    ...
    ZB_HTOLE16((zb_uint8_t*)&(_data_ptr)->manufacturer_code, (zb_uint8_t*)&(src_ptr->manufacturer_code)); \
    (_data_ptr)->flow_control_support = src_ptr->flow_control_support;          \
    ZB_HTOLE16((zb_uint8_t*)&(_data_ptr)->max_incoming_transfer_size,                        \
               (zb_uint8_t*)&(src_ptr->max_incoming_transfer_size));                         \
  }                                                                             \
}
...
{                                                                      \
  ...
  {                                                                    \
    (_status) = ZB_ZCL_PARSE_STATUS_SUCCESS;                           \
    ZB_HTOLE16((zb_uint8_t*)&(_data_ptr)->tunnel_id, (zb_uint8_t*)&(src_ptr->tunnel_id));        \
  }                                                                    \
}
