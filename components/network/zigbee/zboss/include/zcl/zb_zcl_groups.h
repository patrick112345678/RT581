...
{                                                                       \
  ...
  {                                                                     \
    ZB_HTOLE16((zb_uint8_t*)&(add_group_req).group_id, (zb_uint8_t*)&add_group_req_ptr->group_id);\
...
{                                                                             \
  ...
  {                                                                           \
    ZB_HTOLE16((zb_uint8_t*)&(view_group_req).group_id, (zb_uint8_t*)&view_group_req_ptr->group_id);    \
  }                                                                           \
  else                                                                        \
  {                                                                           \
...
{                                                                              \
  ...
  {                                                                            \
    ZB_HTOLE16((zb_uint8_t*)&(rem_group_req).group_id, (zb_uint8_t*)&rem_group_req_ptr->group_id);       \
  }                                                                            \
  else                                                                         \
  {                                                                            \
