...
{                                                                           \
  ...
  {                                                                         \
    ...
    (status) = ZB_ZCL_PARSE_STATUS_SUCCESS;                                 \
    ZB_HTOLE16((zb_uint8_t*)&((data_ptr)->zone_status), (zb_uint8_t*)&(src_ptr->zone_status));        \
    (data_ptr)->extended_status = src_ptr->extended_status;                 \
    (data_ptr)->zone_id = src_ptr->zone_id;                                   \
    ZB_HTOLE16((zb_uint8_t*)&((data_ptr)->delay), (zb_uint8_t*)&(src_ptr->delay));                      \
  }                                                                         \
}
...
{                                                                           \
  ...
  {                                                                         \
    ...
    (status) = ZB_ZCL_PARSE_STATUS_SUCCESS;                                 \
    ZB_HTOLE16((zb_uint8_t*)&((data_ptr)->zone_type), (zb_uint8_t*)&(src_ptr->zone_type));            \
    ZB_HTOLE16((zb_uint8_t*)&((data_ptr)->manufacturer_code), (zb_uint8_t*)&(src_ptr->manufacturer_code));  \
  }                                                                         \
}
