...
{                                                                                  \
  ...
  {                                                                                \
    ...
    ZB_HTOLE16((zb_uint8_t *)&(reset_alarm_req).cluster_id, (zb_uint8_t *)&(reset_alarm_req_ptr->cluster_id)); \
...
{                                                                       \
  ...
  {                                                                     \
    ...
    ZB_HTOLE16((zb_uint8_t*)&((data_ptr)->cluster_id), (zb_uint8_t*)&(src_ptr->cluster_id));      \
  }                                                                     \
}
...
{                                                                                \
  ...
  {                                                                              \
    ...
    {                                                                            \
      ...
      ZB_HTOLE16((zb_uint8_t*)&(get_alarm_res).cluster_id, (zb_uint8_t*)&(get_alarm_res_ptr->cluster_id)); \
      ZB_HTOLE32((zb_uint8_t*)&(get_alarm_res).timestamp, (zb_uint8_t*)&(get_alarm_res_ptr->timestamp));   \
    }                                                                            \
    status = ZB_TRUE;                                                            \
  }                                                                              \
  else                                                                           \
