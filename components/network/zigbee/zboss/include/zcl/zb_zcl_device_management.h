...
{
  ZB_ZCL_DEVICE_MANAGEMENT_PUSH_EVENT_TO_WAN    = 3,  /**< Push Event to WAN */
  ZB_ZCL_DEVICE_MANAGEMENT_PUSH_EVENT_TO_HAN    = 4,  /**< Push Event to HAN */
  ZB_ZCL_DEVICE_MANAGEMENT_RAISE_ALARM_ZIGBEE   = 5,  /**< Raise Alarm (Zigbee) */
  ZB_ZCL_DEVICE_MANAGEMENT_RAISE_ALARM_PHYSICAL = 6,  /**< Raise Alarm (Physical i.e. audible/visible) */
