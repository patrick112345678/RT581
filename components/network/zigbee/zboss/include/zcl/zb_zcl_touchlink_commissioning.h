...
{                                                                                                     \
  ...
  ZB_HTOLE16((zb_uint8_t*)&(scan_data->key_bitmask), (zb_uint8_t*)&(ZLL_DEVICE_INFO().key_info));                               \
  ZLL_DEVICE_INFO().response_id = ZB_ZLL_GET_NEW_RESPONSE_ID();                                       \
  ZB_HTOLE32_VAL(&(scan_data->resp_id), ZLL_DEVICE_INFO().response_id);                               \
  ...
  {                                                                                                   \
    ...
    ZB_HTOLE16((zb_uint8_t*)&(scan_data->endpoint_info.profile_id), (zb_uint8_t*)&(descriptor->profile_id));                    \
    ZB_HTOLE16((zb_uint8_t*)&(scan_data->endpoint_info.device_id), (zb_uint8_t*)&(descriptor->simple_desc->app_device_id));     \
...
{                                                                            \
  ...
  ZB_HTOLE32((zb_uint8_t*)&(req_data->trans_id), (zb_uint8_t*)&(ZLL_TRAN_CTX().transaction_id));       \
  ZB_HTOLE16((zb_uint8_t*)&(req_data->duration), (p_identify_duration));                  \
