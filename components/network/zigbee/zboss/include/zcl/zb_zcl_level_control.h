...
#define ZB_ZCL_LEVEL_CONTROL_LEVEL_MIN_VALUE 0x01
/** @brief Current Level attribute maximum value */
#define ZB_ZCL_LEVEL_CONTROL_LEVEL_MAX_VALUE 0xfe
/** @brief Current Level attribute maximum value */
#define ZB_ZCL_LEVEL_CONTROL_LEVEL_MAX_VALUE_SHADE 0xfe
...
{                                                                                                \
  ...
  {                                                                                              \
    ZB_HTOLE16((zb_uint8_t*)&(move_to_level_req).transition_time, (zb_uint8_t*)&(move_to_level_req_ptr->transition_time)); \
...
{                                                                                      \
  ...
  {                                                                                    \
    ...
    ZB_HTOLE16((zb_uint8_t*)&(step_req).transition_time, (zb_uint8_t*)&step_req_ptr->transition_time);           \
