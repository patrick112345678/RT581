...
{                                                                                   \
  ...
  {                                                                                 \
    ...
    ZB_HTOLE16((zb_uint8_t*)&(move_to_hue_req).transition_time, (zb_uint8_t*)&(move_to_hue_req_ptr->transition_time)); \
...
{                                                                                    \
  ...
  {                                                                                  \
    ...
    ZB_HTOLE16((zb_uint8_t*)&(move_to_saturation_req).transition_time, (zb_uint8_t*)&(move_to_saturation_req_ptr->transition_time)); \
...
{                                                                                       \
  ...
  {                                                                                     \
    ...
    ZB_HTOLE16((zb_uint8_t*)&(move_to_hue_saturation_req).transition_time, (zb_uint8_t*)&(move_to_hue_saturation_req_ptr->transition_time)); \
...
{                                                                                       \
  ...
  {                                                                                                  \
    ZB_HTOLE16((zb_uint8_t*)&(move_to_color_req).color_x, (zb_uint8_t*)&(move_to_color_req_ptr->color_x));                     \
    ZB_HTOLE16((zb_uint8_t*)&(move_to_color_req).color_y, (zb_uint8_t*)&(move_to_color_req_ptr->color_y));                     \
    ZB_HTOLE16((zb_uint8_t*)&(move_to_color_req).transition_time, (zb_uint8_t*)&(move_to_color_req_ptr->transition_time));     \
...
{                                                                               \
  ...
  {                                                                                                  \
    ZB_HTOLE16((zb_uint8_t*)&(move_color_req).rate_x, (zb_uint8_t*)&(move_color_req_ptr->rate_x));                             \
    ZB_HTOLE16((zb_uint8_t*)&(move_color_req).rate_y, (zb_uint8_t*)&(move_color_req_ptr->rate_y));                             \
...
{                                                                               \
  ...
  {                                                                                                  \
    ZB_HTOLE16((zb_uint8_t*)&(step_color_req).step_x, (zb_uint8_t*)&(step_color_req_ptr->step_x));                             \
    ZB_HTOLE16((zb_uint8_t*)&(step_color_req).step_y, (zb_uint8_t*)&(step_color_req_ptr->step_y));                             \
    ZB_HTOLE16((zb_uint8_t*)&(step_color_req).transition_time, (zb_uint8_t*)&(step_color_req_ptr->transition_time));           \
...
{                                                                                                                     \
  ...
  {                                                                                                                   \
    ZB_HTOLE16((zb_uint8_t*)&(move_to_color_temperature_req).color_temperature, (zb_uint8_t*)&(move_to_color_temp_req_ptr->color_temperature)); \
    ZB_HTOLE16((zb_uint8_t*)&(move_to_color_temperature_req).transition_time, (zb_uint8_t*)&(move_to_color_temp_req_ptr->transition_time));     \
...
{                                                                                       \
  ...
  {                                                                                     \
    ZB_HTOLE16((zb_uint8_t*)&(enhanced_move_to_hue_req).enhanced_hue, (zb_uint8_t*)&(enhanced_move_to_hue_req_ptr->enhanced_hue));       \
    enhanced_move_to_hue_req.direction = enhanced_move_to_hue_req_ptr->direction;                              \
    ZB_HTOLE16((zb_uint8_t*)&(enhanced_move_to_hue_req).transition_time, (zb_uint8_t*)&(enhanced_move_to_hue_req_ptr->transition_time)); \
...
{                                                                                   \
  ...
  {                                                                                 \
    ...
    ZB_HTOLE16((zb_uint8_t*)&(enhanced_move_hue_req).rate, (zb_uint8_t*)&(enhanced_move_hue_req_ptr->rate));               \
...
{                                                                                   \
  ...
  {                                                                                 \
    ...
    ZB_HTOLE16((zb_uint8_t*)&(enhanced_step_hue_req).step_size, (zb_uint8_t*)&(enhanced_step_hue_req_ptr->step_size));             \
    ZB_HTOLE16((zb_uint8_t*)&(enhanced_step_hue_req).transition_time, (zb_uint8_t*)&(enhanced_step_hue_req_ptr->transition_time)); \
...
{                                                                                                   \
  ...
  {                                                                                                 \
    ZB_HTOLE16((zb_uint8_t*)&(enhanced_move_to_hue_saturation_req).enhanced_hue, (zb_uint8_t*)&(enhanced_move_to_hue_saturation_req_ptr->enhanced_hue));       \
    enhanced_move_to_hue_saturation_req.saturation = enhanced_move_to_hue_saturation_req_ptr->saturation;                            \
    ZB_HTOLE16((zb_uint8_t*)&(enhanced_move_to_hue_saturation_req).transition_time, (zb_uint8_t*)&(enhanced_move_to_hue_saturation_req_ptr->transition_time)); \
...
{                                                                                       \
  ...
  {                                                                                      \
    ...
    ZB_HTOLE16((zb_uint8_t*)&(color_loop_set_req).time, (zb_uint8_t*)&(color_loop_set_req_ptr->time));             \
    ZB_HTOLE16((zb_uint8_t*)&(color_loop_set_req).start_hue, (zb_uint8_t*)&(color_loop_set_req_ptr->start_hue));   \
...
/*! @brief Stop move step command, see ZCL spec 5.2.2.3.19
    @param buffer - to put packet to
    @param addr - address to send packet to
    @param dst_addr_mode - addressing mode
    @param dst_ep - destination endpoint
...
{                                                                                   \
  ...
  {                                                                                 \
    ...
    ZB_HTOLE16((zb_uint8_t*)&(move_color_temp_req).rate, (zb_uint8_t*)&(move_color_temp_req_ptr->rate));                     \
    ZB_HTOLE16((zb_uint8_t*)&(move_color_temp_req).color_temp_min, (zb_uint8_t*)&(move_color_temp_req_ptr->color_temp_min)); \
    ZB_HTOLE16((zb_uint8_t*)&(move_color_temp_req).color_temp_max, (zb_uint8_t*)&(move_color_temp_req_ptr->color_temp_max)); \
...
{                                                                                                    \
  ...
  {                                                                                                  \
    ...
    ZB_HTOLE16((zb_uint8_t*)&(step_color_temp_req).step_size, (zb_uint8_t*)&(step_color_temp_req_ptr->step_size));             \
    ZB_HTOLE16((zb_uint8_t*)&(step_color_temp_req).transition_time, (zb_uint8_t*)&(step_color_temp_req_ptr->transition_time)); \
    ZB_HTOLE16((zb_uint8_t*)&(step_color_temp_req).color_temp_min, (zb_uint8_t*)&(step_color_temp_req_ptr->color_temp_min));   \
    ZB_HTOLE16((zb_uint8_t*)&(step_color_temp_req).color_temp_max, (zb_uint8_t*)&(step_color_temp_req_ptr->color_temp_max));   \
