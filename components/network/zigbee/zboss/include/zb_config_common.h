...
extern unsigned char ZB_STANDARD_TC_KEY[];
...
#define ZB_NWK_EXPIRY_BROADCAST_RX 5U //unit: second
#define ZB_NWK_EXPIRY_BROADCAST_TX 1U //unit: second
#define ZB_BTR_AGING_CYCLE 6U //unit: beacon interval
#define ZB_NWK_EXPIRY_BROADCAST_RX_CYCLE 55U //unit: ZB_BTR_AGING_CYCLE
#define ZB_NWK_EXPIRY_BROADCAST_TX_CYCLE 11U //unit: ZB_BTR_AGING_CYCLE
...
//#if defined ZB_RAF_NEIGHBOR_AUTO_DELETETION
/*!
 * The number of neighbor entry allow miss link status
 * after miss 6 (6 * 15s = 120s) link status, delete neighbor entry from table
 *
 * The value defined by Rafeal.
*/
#define ZB_RAF_NWK_NEIGHBOR_ENTRY_TIMEOUT_AGE 6U
//#endif
/** @cond internals_doc */
...
*/
//JJ #define ZB_MAX_FRAME_TOTAL_WAIT_TIME_2_4_GHZ (ZB_MILLISECONDS_TO_BEACON_INTERVAL(40U) + 1U)
#define ZB_MAX_FRAME_TOTAL_WAIT_TIME_2_4_GHZ (ZB_MILLISECONDS_TO_BEACON_INTERVAL(120U) + 1U)
/*!
