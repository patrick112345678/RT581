 ...
 *  @{
    ...
    - Declaring clusters:
        ...
        @snippet HA_samples/ias_ancillary_control_equipment/sample_zc.c COMMON_DECLARATION

    - Registering device list:

        @snippet HA_samples/ias_ancillary_control_equipment/sample_zc.c REGISTER

    - Example of command handler:

        @snippet HA_samples/ias_ancillary_control_equipment/sample_zc.c COMMAND_HANDLER
