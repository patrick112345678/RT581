...
/**
 *  @defgroup ZB_HA_IAS_CONTR_INDICATION IAS Control and Indicating Equipment
 *  @ingroup ZB_HA_DEVICES
 *  @{
    @details
    IAS Control and Indicating Equipment has 7 clusters (see spec 7.8.1): \n
        - @ref ZB_ZCL_BASIC \n
        - @ref ZB_ZCL_IDENTIFY \n
        - @ref ZB_ZCL_IAS_ACE \n
        - @ref ZB_ZCL_IAS_WD \n
    ...
    IAS Control and Indicating Equipment sample
    ...
    - Declaring clusters:
        ...
        @snippet HA_samples/ias_control_indicating_equipment/sample_zc.c COMMON_DECLARATION

    - Registering device list:

        @snippet HA_samples/ias_control_indicating_equipment/sample_zc.c REGISTER

    - Example of command handler:

        @snippet HA_samples/ias_control_indicating_equipment/sample_zc.c COMMAND_HANDLER
        @snippet HA_samples/ias_control_indicating_equipment/sample_zc.c ZCL_COMMAND_HANDLER
...
#define ZB_HA_IAS_CONTROL_INDICATING_EQUIPMENT_IN_CLUSTER_NUM  3

/** Output clusters number. */
#define ZB_HA_IAS_CONTROL_INDICATING_EQUIPMENT_OUT_CLUSTER_NUM 5
 ...
 */
#define ZB_HA_DECLARE_IAS_CONTROL_INDICATING_EQUIPMENT_CLUSTER_LIST(           \
  cluster_list_name,                                                           \
  basic_attr_list,                                                             \
  identify_attr_list,                                                          \
  ias_ace_attr_list)                                                           \
...
#define ZB_HA_DECLARE_IAS_CONTROL_INDICATING_EQUIPMENT_SIMPLE_DESC(                \
  ep_name, ep_id, in_clust_num, out_clust_num)                                     \
      ...
      {                                                                            \
        ...
        ZB_HA_IAS_CONTROL_INDICATING_EQUIPMENT_VER,                                \
        0,                                                                         \
        in_clust_num,                                                              \
        out_clust_num,                                                             \
        {                                                                          \
 ...
 */
#define ZB_HA_DECLARE_IAS_CONTROL_INDICATING_EQUIPMENT_EP(ep_name, ep_id, cluster_list)     \
      ZB_HA_DECLARE_IAS_CONTROL_INDICATING_EQUIPMENT_SIMPLE_DESC(                   \
          ep_name,                                                                  \
          ep_id,                                                                    \
          ZB_HA_IAS_CONTROL_INDICATING_EQUIPMENT_IN_CLUSTER_NUM,                    \
          ZB_HA_IAS_CONTROL_INDICATING_EQUIPMENT_OUT_CLUSTER_NUM);                  \
...
/**
 * @brief Declare application's device context for IAS Control Indicating Equipment
