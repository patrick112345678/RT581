...
#define ZB_HA_ON_OFF_SWITCH_1_IN_CLUSTER_NUM 3  /*!< On/Off switch IN clusters number */
#define ZB_HA_ON_OFF_SWITCH_2_IN_CLUSTER_NUM 1  /*!< On/Off switch IN clusters number */
...
/** @brief Declare On/Off Switch device context.
    ...
    @param ep_name - endpoint variable name.
*/
#define ZB_HA_DECLARE_ON_OFF_SWITCH_1_CTX(device_ctx, ep_name) \
...
/** @brief Declare On/Off Switch device context.
    ...
    @param ep_name - endpoint variable name.
*/
#define ZB_HA_DECLARE_ON_OFF_SWITCH_2_CTX(device_ctx, ep_name1, ep_name2)      \
