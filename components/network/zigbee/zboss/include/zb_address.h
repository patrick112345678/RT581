...
#define zb_address_update(ieee_address,short_address,lock,ref_p) zb_dbg_address_update(TRACE_CALL (ieee_address),(short_address),(lock),(ref_p))
#else
...
#define zb_address_lock(ref) zb_dbg_address_lock(TRACE_CALL (ref))
#else
...
#define zb_address_unlock(ref) zb_dbg_address_unlock(TRACE_CALL (ref))
#else
