...
typedef enum zb_zgpd_ch_options_e
{
  ...
  ZB_ZGPD_CH_EXIT_AFTER_REQ_SERIES  =27, // exit after channel request one serie completed
  ...
  ZB_ZGPD_CH_CORRUPT_COMM_MIC       =40  // corrupt MIC in commissioning comand
}
...
typedef struct zb_zgpd_ctx_s
{
  ...
  zb_uint8_t        application_info_present;  /**< Aplication Information Present */
