...
#define ZB_ZCL_DECLARE_KEC_ATTRIB_LIST(attr_list, kec_key_establishment_suite)                     \
  ZB_ZCL_START_DECLARE_ATTRIB_LIST_STATIC(attr_list)                                               \
 ...
 *  @par Example
 *  @snippet se/energy_service_interface/se_esi_zc.c SIGNAL_HANDLER_LOAD_CERT
 ...
 *  @details This procedure should be used if application got @ref ZB_SE_SIGNAL_CBKE_FAILED singal
 ...
 *  @see ZB_SE_SIGNAL_CBKE_FAILED - sample code of ZBOSS singal processing
 */
