...
#if defined ZB_RAF_NETWORKING_IMPROVEMENT

/* Neighbor entry shold be delete when device offline */
#ifndef ZB_RAF_NEIGHBOR_AUTO_DELETETION
#define ZB_RAF_NEIGHBOR_AUTO_DELETETION
#endif
/* We should check for address conflict after successfully decrypting the frame */
#ifndef ZB_RAF_MOVE_NWK_TEST_ADDRESS
#define ZB_RAF_MOVE_NWK_TEST_ADDRESS
#endif

#endif

/**
 *  Prevent zb_mac_indirect_data_rx_failed canceled by unrelated packet
*/
#ifndef ZB_RAF_INDIRECT_DATA_RX_FIX
#define ZB_RAF_INDIRECT_DATA_RX_FIX
#endif
 ...
 *  ex. receive packet size 114/115 bytes with ZGP protocol
*/
#ifndef ZB_RAF_INVALID_PACKET_PREVENT
#define ZB_RAF_INVALID_PACKET_PREVENT
#endif

/**
 *  Prevent set channel fail in function zdo_join_to_nwk_descr()
 *  caused by received beacon and MAC PIB channel and page set in invalid value
*/
#ifndef ZB_RAF_INVALID_MAC_PIB_CHANNEL_VALUE
#define ZB_RAF_INVALID_MAC_PIB_CHANNEL_VALUE
#endif

/**
 *  ZC OOM and made address lock cnt unsymmetrival (workaround)
*/
#ifndef ZB_RAF_ADDRESS_MAP_LOCK_CNT_UNSYMMETRICAL
#define ZB_RAF_ADDRESS_MAP_LOCK_CNT_UNSYMMETRICAL
#endif

/**
 * Let user cuold be configured scan duration,
 * primary channel and secondary channel
 */
#ifndef ZB_RAF_FAST_JOIN_CONFIGURATION
#define ZB_RAF_FAST_JOIN_CONFIGURATION
#endif

/* Permit Join changging join ZDO signal indication  */
#ifndef ZB_RAF_PERMIT_JOIN_ZDO_SIGNAL
#define ZB_RAF_PERMIT_JOIN_ZDO_SIGNAL
#endif

/**
 *  Device Join fail, ZC turn off permit join unexpected
 *  device type changed to none made joined child number invalid
*/
#ifndef ZB_RAF_PERMIT_JOIN_TURN_OFF_UNEXPECTED
#define ZB_RAF_PERMIT_JOIN_TURN_OFF_UNEXPECTED
#endif

/**
 *  NWK address confilist prevention
*/
#ifndef ZB_RAF_NWK_ADDRESS_CONFLICT_PREVENT
#define ZB_RAF_NWK_ADDRESS_CONFLICT_PREVENT
#endif

/**
 *  Debug address lock cnt invalid path
*/
#ifndef ZB_RAF_DEBUG_LOCK_COUNT
//#define ZB_RAF_DEBUG_LOCK_COUNT
#define ZB_RAF_DEBUG_RECORD_COUNT 10U
#endif
...
#define ZB_DEV_MANUFACTURER_TABLE_SIZE 200U
#endif
...
#define ZB_NWK_NEIGHBOUR_PATH_COST_RSSI_BASED   /* George, try to fixed in/out cost issue */
/** @cond DOXYGEN_INTERNAL_DOC */
...
/* For buffer pool size = 60, the recommended values are:
 * RAF_USAGES_COUNT = 10; RAF_RECORD_COUNT = 2
 * If a larger size is needed, remove some of these definition:
 * ZB_DEBUG_BUFFERS_RAF_USAGE_RECORD
 * ZB_DEBUG_BUFFERS_RAF_SIZE_RECORD
 * ZB_DEBUG_BUFFERS_RAF_SCHEDULE_RECORD
 */
#define ZB_DEBUG_BUFFERS_EXT_RAF_RECORD_COUNT 10U
#define ZB_DEBUG_BUFFERS_EXT_RAF_ROUND_COUNT 2U
#define ZB_DEBUG_BUFFERS_RAF_USAGE_RECORD
#define ZB_DEBUG_BUFFERS_RAF_SIZE_RECORD
#define ZB_DEBUG_BUFFERS_RAF_SCHEDULE_RECORD
#endif
...
#define xZB_CHECK_OOM_STATUS
#undef ZB_CHECK_OOM_STATUS

/* MAC tests do not use NVRAM */
#undef ZB_USE_NVRAM
