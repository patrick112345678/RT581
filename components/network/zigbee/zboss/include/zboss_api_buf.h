...
#if defined ZB_DEBUG_BUFFERS_EXT || defined ZB_DEBUG_BUFFERS_EXT_RAF
 ...
 * See any sample.
 */
#define zb_buf_free(buf) do { ZB_OSIF_GLOBAL_LOCK(); zb_buf_free_func(TRACE_CALL (buf)); ZB_OSIF_GLOBAL_UNLOCK(); } while(0)
