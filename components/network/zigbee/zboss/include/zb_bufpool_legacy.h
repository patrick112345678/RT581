...
/**
   ...
   @snippexbt tp_pro_bv_03_zc.c zb_get_in_buf

   See tp_pro_bv-03 sample
 */
zb_buf_t *zb_get_buf(
 ...
 *  If buffer is available, schedules callback for execution immediatly. If no buffers available now,
