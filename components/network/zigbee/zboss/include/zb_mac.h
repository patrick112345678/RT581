...
#define ZB_VALID_BEACON_LENGTH    28U
#endif
...
{                                                                     \
  ...
  {                                                                     \
    ZB_MEMCPY((zb_uint8_t *)&_p->coord_addr.addr_short, (p_address), sizeof(zb_uint16_t)); \
  }                                                                     \
...
/**
   Check destination PAN ID & address is to myself
*/
