...
echo -e "Start ZC"
../tests/zdo/zdo_startup/zdo_start_zc &
th1_pid=$!
wait_for_start "zdo_zc" "Device STARTED"
echo -e "ZC started\n"

sleep 1

echo -e "Start ZR host"
../tests/ncp/host/ctests/zdo_startup/zdo_start_zr &
host_pid=$!
wait_for_start "zdo_zr" "Device started with status 0"
echo -e "ZR host started\n"

sleep 1

echo -e "Start ZED"
../tests/zdo/zdo_startup/zdo_start_ze &
th2_pid=$!
wait_for_start "zdo_ze" "Device STARTED"
echo -e "ZED started\n"
