 ...
 * DSR.
 */
/* PURPOSE: ZR joins to ZC, then sends long APS messages packet.
*/
...
MAIN()
{
    ...
    ZB_INIT("zbs_echo_zr_long_aps_message");
...
#else
        ZB_SCHEDULE_ALARM(send_data, param, ZB_MILLISECONDS_TO_BEACON_INTERVAL(1000));
#endif
