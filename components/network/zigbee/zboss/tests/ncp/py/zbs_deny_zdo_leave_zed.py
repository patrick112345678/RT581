...
# * DSR.
#
# PURPOSE: Host-side test implements ZED which allows/denies leaving the network (ZDO allow/deny)
#
...
# to fail. Then, ZED sets leave_allowed back to 1 and waits for second leave
...
log_file_name = "zbs_deny_zdo_leave_zed.log"
...
class Test(BaseTest):
    ...
    def __init__(self, channel_mask):
        ...
        self.update_response_switch({
            ...
            ncp_hl_call_code_e.NCP_HL_SET_ZDO_LEAVE_ALLOWED: self.set_leave_allowed_rsp,
            ncp_hl_call_code_e.NCP_HL_GET_ZDO_LEAVE_ALLOWED: self.get_leave_allowed_rsp,
        })
        ...
        self.required_packets = [[ncp_hl_call_code_e.NCP_HL_NCP_RESET_IND,              NCP_HL_STATUS.RET_OK],
                                 ...
                                 [ncp_hl_call_code_e.NCP_HL_GET_ZDO_LEAVE_ALLOWED,       NCP_HL_STATUS.RET_OK],
    ...
    def set_leave_allowed_rsp(self, rsp, rsp_len):
        self.rsp_log(rsp)
        self.host.ncp_req_get_zdo_leave_allowed()
        self.leave_iteration = self.leave_iteration + 1

    def get_leave_allowed_rsp(self, rsp, rsp_len):
        self.rsp_log(rsp)
    ...
    def get_authenticated_rsp(self, rsp, rsp_len):
        ...
        # self.leave_iteration = self.leave_iteration + 1
        self.host.ncp_req_set_zdo_leave_allowed(1)
