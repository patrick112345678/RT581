...
log_file_name = "zbs_se_key_est_zed_cs1.log"
...
class Test(BaseTest):
    ...
    def secur_sbke_rsp(self, rsp, rsp_len):
        ...
        self.host.ncp_req_zdo_nwk_addr(short_addr, ncp_hl_ieee_addr_t(ihd_dev_addr_cs1), ncl_hl_zdo_addr_req_type_e.NCP_HL_ZDO_SINGLE_DEV_REQ, 0)
    ...
    def partner_lk_ind(self, ind, ind_len):
        ...
        self.host.ncp_req_secur_get_key_idx(ihd_dev_addr_cs1)
