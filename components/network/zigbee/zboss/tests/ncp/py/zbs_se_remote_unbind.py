...
# After Second Partner LK establishment remote device does a unbind req to test NCP_HL_REMOTE_UNBIND_IND
...
log_file_name = "zbs_se_remote_unbind.log"
...
class Test(BaseTest):
    ...
    def __init__(self, channel_mask):
        ...
        self.update_indication_switch({
            ...
            ncp_hl_call_code_e.NCP_HL_APSME_REMOTE_UNBIND_IND: self.remote_unbind_ind
        })
        ...
        self.required_packets = [[ncp_hl_call_code_e.NCP_HL_NCP_RESET_IND,                  NCP_HL_STATUS.RET_OK],
                                 ...
                                 [ncp_hl_call_code_e.NCP_HL_APSME_REMOTE_UNBIND_IND,          NCP_HL_STATUS.RET_OK],
                                 ]
    ...
    def remote_unbind_ind(self, ind, ind_len):
        self.ind_log(ind,ncp_hl_bind_entry_t)
