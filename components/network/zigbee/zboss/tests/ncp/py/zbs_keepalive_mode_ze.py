...
# * DSR.
#
# Host-side test implements ZE part of keepalive mode test
...
log_file_name = "zbs_keepalive_mode_ze.log"
...
class Test(BaseTest):
    ...
    def __init__(self, channel_mask):
        ...
        self.required_packets = [[ncp_hl_call_code_e.NCP_HL_NCP_RESET_IND,              NCP_HL_STATUS.RET_OK],
                                 ...
                                 [ncp_hl_call_code_e.NCP_HL_SET_ED_TIMEOUT,             NCP_HL_STATUS.RET_INVALID_PARAMETER],
                                 [ncp_hl_call_code_e.NCP_HL_SET_ED_TIMEOUT,             NCP_HL_STATUS.RET_OK],
    ...
    def set_rx_on_when_idle_rsp(self, rsp, rsp_len):
        self.rsp_log(rsp)
        self.host.ncp_req_set_ed_timeout(11) # default = 8

    def set_ed_timeout_rsp(self, rsp, rsp_len):
        self.rsp_log(rsp)
        if self.ed_timeout_stage == 0:
            self.ed_timeout_stage = 1
            self.host.ncp_req_set_ed_timeout(0) # every 10 sec
        else:
