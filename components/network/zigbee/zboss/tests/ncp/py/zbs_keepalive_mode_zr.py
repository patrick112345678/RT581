...
# * DSR.
#
# PURPOSE: Host-side test implements ZR part of keepalive mode test
#
...
log_file_name = "zbs_keepalive_mode_zr.log"
...
class Test(BaseTest):
    ...
    def __init__(self, channel_mask):
        ...
        self.update_response_switch({
            ...
            ncp_hl_call_code_e.NCP_HL_SET_KEEPALIVE_MODE: self.keepalive_mode_set,
        ...
        self.required_packets = [[ncp_hl_call_code_e.NCP_HL_NCP_RESET_IND,              NCP_HL_STATUS.RET_OK],
                                 ...
                                 [ncp_hl_call_code_e.NCP_HL_SET_KEEPALIVE_MODE,         NCP_HL_STATUS.RET_OK],
    ...
    def begin(self):
        self.host.ncp_req_set_keepalive_mode(ncl_hl_keepalive_mode_e.NCP_HL_ED_TIMEOUT_REQUEST_KEEPALIVE)

    def keepalive_mode_set(self, rsp, rsp_len):
