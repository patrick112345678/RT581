...
# * DSR.
#
# PURPOSE: Host-side test implements ZR mesh route discovery feature.
#
# NWK route request feature - ZR role. Keys & IC in samples/se
...
log_file_name = "zbs_force_mesh_route_discovery.log"
...
class Test(BaseTest):
    ...
    def send_data(self):
        ...
        params.tx_options = ncp_hl_tx_options_e.NCP_HL_TX_OPT_ACK_TX | ncp_hl_tx_options_e.NCP_HL_TX_OPT_SECURITY_ENABLED | ncp_hl_tx_options_e.NCP_HL_TX_OPT_FORCE_MESH_ROUTE_DISC
        params.radius = 2
        length = 10
