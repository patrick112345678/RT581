...
# * DSR.
#
# PURPOSE: Host-side test implements ZR role of CBKE initiated by TC
#
# TC initiates CBKE procedure after ZR had joined.
...
log_file_name = "zbs_se_cbke_from_tc_zr.log"
