...
# * DSR.
#
# PURPOSE: Host-side test implements secure rejoining
#
# ZED joins to ZC and rejoin (with Secure rejoin flag) one time after 3 seconds
#
...
log_file_name = "zbs_rejoin_zed_secure_rejoin.log"
...
class Test(BaseTest):
    ...
    def nwk_join_complete_local(self, rsp, rsp_len):
        ...
        if rsp.hdr.status_code == 0:
            ...
            sleep(3)
            self.host.ncp_req_zdo_rejoin(self.extpanid, self.mask, 1)
