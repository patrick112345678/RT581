...
# * DSR.
#
# PURPOSE: Keys from SE specification. Can use it for testing freely.
# Got from samples/se/common/se_cert_spec.h
#
# To switch SE tests to certificates from SE spec, run cert_ic_spec.sh in samples/se, then recompile SE samples.
#
...
esi_dev_addr_cs1 = bytes([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00])

esi_certificate_cs1 = bytes([0x03,0x04,0x5F,0xDF,0xC8,0xD8,0x5F,0xFB,
...
esi_private_key_cs1 = bytes([0x00,0xB8,0xA9,0x00,0xFC,0xAD,0xEB,0xAB,
                             0xBF,0xA3,0x83,0xB5,0x40,0xFC,0xE9,0xED,
                             0x43,0x83,0x95,0xEA,0xA7])

esi_dev_addr_cs2 = bytes([0x11, 0x10, 0x0f, 0x0e, 0x0d, 0x0c, 0x0b, 0x0a])

esi_certificate_cs2 = bytes([0x00,0x26,0x22,0xA5,0x05,0xE8,0x93,0x8F,
...
esi_private_key_cs2 = bytes([0x01,0x51,0xCD,0x0D,0xBC,0xB8,0x04,0x74,
                             0xBF,0x7A,0xC9,0xFE,0xEB,0xE3,0x9C,0x7A,
                             0x32,0xA6,0x35,0x18,0x93,0x8F,0xCA,0x97,
                             0x54,0xAA,0xE1,0x32,0xBC,0x9C,0x73,0xBE,
                             0x94,0xA7,0xE1,0xBE])

ihd_dev_addr_cs1 = bytes([0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00])

ihd_certificate_cs1 = bytes([0x02,0x06,0x15,0xE0,0x7D,0x30,0xEC,0xA2,
...
ihd_private_key_cs1 = bytes([0x01,0xE9,0xDD,0xB5,0x58,0x0C,0xF7,0x2E,
                             0xCE,0x7F,0x21,0x5F,0x0A,0xE5,0x94,0xE4,
                             0x8D,0xF3,0xE7,0xFE,0xE8])

ihd_dev_addr_cs2 = bytes([0x12, 0x10, 0x0f, 0x0e, 0x0d, 0x0c, 0x0b, 0x0a])

ihd_certificate_cs2 = bytes([0x00,0x84,0xA9,0x33,0xB3,0x7F,0x01,0x8D,
...
ihd_private_key_cs2 = bytes([0x00,0xF2,0x56,0x1A,0xDB,0x39,0xEF,0x49,
