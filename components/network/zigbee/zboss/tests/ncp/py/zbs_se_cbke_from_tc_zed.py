...
# * DSR.
#
# PURPOSE: Host-side test implements ZED role of CBKE initiated by TC
#
# SE join and key establishment - ZED role. TC initiates CBKE procedure after ZED had joined.
...
log_file_name = "zbs_se_cbke_from_tc_zed.log"
