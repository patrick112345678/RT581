...
# * DSR.
#
# PURPOSE: Host-side test implements ZED part of time reading.
#
# SE join, key establishment and reading time - ZED role. Keys & IC for IHD in samples/se
...
log_file_name = "zbs_se_zed_cs2_read_time.log"
...
# ZED is IHD from se_cert_spec.h.
#
