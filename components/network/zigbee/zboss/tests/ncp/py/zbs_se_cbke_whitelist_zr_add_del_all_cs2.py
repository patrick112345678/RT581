...
# * DSR.
#
# PURPOSE: Host-side test implements ZR role of CBKE initiated by nonTC and whitelist feature. Remote device isn't allowed to do CBKE.
#
# nonTC initiates CBKE procedure after ZR had joined to ZC, got CBKE and PLKE with nonTC
...
log_file_name = "zbs_se_cbke_whitelist_zr_add_del_all_cs2.log"
...
el_metering_dev_addr_cs2 = bytes ([0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11])
...
class Test(BaseTest):
    ...
    def __init__(self, channel_mask):
        ...
        self.update_response_switch({
            ...
            ncp_hl_call_code_e.NCP_HL_SECUR_KE_WHITELIST_DEL_ALL: self.whitelist_del_all_rsp
        })
        ...
        self.required_packets = [[ncp_hl_call_code_e.NCP_HL_NCP_RESET_IND,                  NCP_HL_STATUS.RET_OK],
                                 ...
                                 [ncp_hl_call_code_e.NCP_HL_SECUR_KE_WHITELIST_DEL_ALL,     NCP_HL_STATUS.RET_OK],
    ...
    def begin(self):
        self.host.ncp_req_secur_ke_whitelist_add(el_metering_dev_addr_cs2)
    ...
    def whitelist_add_rsp(self, rsp, rsp_len):
        self.rsp_log(rsp)
        self.host.ncp_req_secur_ke_whitelist_del_all()

    def whitelist_del_all_rsp(self, rsp, rsp_len):
        self.rsp_log(rsp)
