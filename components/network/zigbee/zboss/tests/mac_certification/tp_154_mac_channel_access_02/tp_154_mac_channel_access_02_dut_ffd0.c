 ...
 * DSR.
 */
/* PURPOSE: P/154/MAC/CHANNEL-ACCESS-02 DUT FFD0
MAC-only build
*/

#define ZB_TEST_NAME TP_154_MAC_CHANNEL_ACCESS_02_DUT_FFD0
#define ZB_TRACE_FILE_ID 57422
#include "zb_common.h"
#include "zb_scheduler.h"
#include "zb_bufpool.h"
#include "../common/zb_cert_test_globals.h"
#include "tp_154_mac_channel_access_02_common.h"
...
static zb_uint8_t gs_packet_cntr;
...
MAIN()
{
    ...
    ZB_INIT("tp_154_mac_channel_access_02_dut_ffd0");
...
static void test_mlme_mcps_data_request(zb_uint8_t param)
{
    ...
    data_req->msdu_handle = gs_packet_cntr++;
...
ZB_MCPS_DATA_CONFIRM(zb_uint8_t param)
{
    ...
    if (gs_packet_cntr < TEST_PACKETS_COUNT)
    {
        ZB_SCHEDULE_CALLBACK(test_mlme_mcps_data_request, param);
    }
    else
    {
        ...
        TRACE_MSG(TRACE_APP1, "Check the random backoff of CCA.", (FMT__0));
        zb_buf_free(param);
    }
}
