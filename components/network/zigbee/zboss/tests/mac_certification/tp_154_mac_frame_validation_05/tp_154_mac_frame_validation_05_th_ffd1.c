 ...
 * DSR.
 */
/* PURPOSE: TP/154/MAC/FRAME-VALIDATION-05 FFD1
MAC-only build
*/

#define ZB_TEST_NAME TP_154_MAC_FRAME_VALIDATION_05_TH_FFD1
#define ZB_TRACE_FILE_ID 57528
#include "zb_common.h"
...
MAIN()
{
    ...
    ZB_INIT("tp_154_mac_frame_validation_05_th_ffd1");
...
static void test_mcps_data_request(zb_uint8_t param)
{
    ...
    data_req->dst_addr.addr_short = TEST_INVALID_SHORT_ADDRESS;
