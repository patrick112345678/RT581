 ...
 * DSR.
 */
/* PURPOSE: TP/154/MAC/SCANNING-08 FFD1
MAC-only build
*/

#define ZB_TEST_NAME TP_154_MAC_SCANNING_08_TH_RFD1
#define ZB_TRACE_FILE_ID 57214
#include "zb_common.h"
...
MAIN()
{
  ...
  ZB_INIT("tp_154_mac_scanning_08_th_rfd1");
