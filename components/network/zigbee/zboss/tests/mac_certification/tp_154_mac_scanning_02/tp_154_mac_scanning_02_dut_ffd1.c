 ...
 * DSR.
 */
/* PURPOSE: 5.2. P/154/MAC/SCANNING-02 FFD1
MAC-only build
*/

#define ZB_TEST_NAME TP_154_MAC_SCANNING_02_DUT_FFD1
#define ZB_TRACE_FILE_ID 57204
#include "zb_common.h"
#include "zb_scheduler.h"
#include "zb_bufpool.h"
#include "../common/zb_cert_test_globals.h"
#include "tp_154_mac_scanning_02_common.h"
#include "zb_osif.h"
