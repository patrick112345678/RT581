 ...
 * DSR.
 */
/* PURPOSE: TP/154/MAC/FRAME-VALIDATION-02 DUT FFD0
MAC-only build
*/

#define ZB_TEST_NAME TP_154_MAC_FRAME_VALIDATION_02_DUT_FFD0
#define ZB_TRACE_FILE_ID 57474
#include "zb_common.h"
...
MAIN()
{
    ...
    ZB_INIT("tp_154_mac_frame_validation_02_dut_ffd0");
...
ZB_MLME_COMM_STATUS_INDICATION(zb_uint8_t param)
{
    ...
    TRACE_MSG(TRACE_APP1, "If no MCPS-DATA.indication(), Frame_validation02 success", (FMT__0));
    zb_buf_free(param);
}
...
ZB_MCPS_DATA_INDICATION(zb_uint8_t param)
{
    ...
    TRACE_MSG(TRACE_APP1, "Frame_validation02 failed", (FMT__0));
    zb_buf_free(param);
}
/*! @} */
