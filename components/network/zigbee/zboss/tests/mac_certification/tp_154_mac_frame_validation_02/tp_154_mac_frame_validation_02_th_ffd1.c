 ...
 * DSR.
 */
/* PURPOSE: TP/154/MAC/FRAME-VALIDATION-02 TH FFD1
MAC-only build
*/

#define ZB_TEST_NAME TP_154_MAC_FRAME_VALIDATION_02_TH_FFD1
#define ZB_TRACE_FILE_ID 57473
#include "zb_common.h"
#include "zb_scheduler.h"
#include "zb_bufpool.h"
#include "../common/zb_cert_test_globals.h"
#include "tp_154_mac_frame_validation_02_common.h"
...
MAIN()
{
  ...
  ZB_INIT("tp_154_mac_frame_validation_02_th_ffd1");
...
static void test_mcps_data_request(zb_uint8_t param)
{
  ...
  /* Transmit this MAC Data frame with an Reserved Frame Type subfield */
  MAC_CTX().cert_hacks.reserved_frame_type = 1;
...
ZB_MLME_ASSOCIATE_CONFIRM(zb_uint8_t param)
{
  ...
  //ZB_SCHEDULE_CALLBACK(test_mcps_data_request, param);
	ZB_SCHEDULE_ALARM(test_mcps_data_request, param, ZB_TIME_ONE_SECOND * 5);
}
...
ZB_MCPS_DATA_CONFIRM(zb_uint8_t param)
{
  ...
  MAC_CTX().cert_hacks.reserved_frame_type = 0;
