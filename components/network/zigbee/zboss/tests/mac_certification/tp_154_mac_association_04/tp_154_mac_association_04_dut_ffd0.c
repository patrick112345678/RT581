 ...
 * DSR.
 */
/* PURPOSE: TP/154/MAC/ASSOCIATION-04 FFD0
MAC-only build
*/

#define ZB_TEST_NAME TP_154_MAC_ASSOCIATION_04_DUT_FFD0
#define ZB_TRACE_FILE_ID 57315
#include "zb_common.h"
#include "zb_scheduler.h"
#include "zb_bufpool.h"
#include "../common/zb_cert_test_globals.h"
#include "tp_154_mac_association_04_common.h"
#include "zb_osif.h"
...
MAIN()
{
    ...
    ZB_INIT("tp_154_mac_association_04_dut_ffd0");
...
ZB_MLME_ASSOCIATE_INDICATION(zb_uint8_t param)
{
    ...
    TRACE_MSG(TRACE_APP1, "MLME-ASSOCIATE.request()", (FMT__0));
