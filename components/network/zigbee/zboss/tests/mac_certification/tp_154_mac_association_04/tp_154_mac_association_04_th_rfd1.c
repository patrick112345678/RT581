 ...
 * DSR.
 */
/* PURPOSE: TP/154/MAC/ASSOCIATION-04 RFD1
MAC-only build
*/

#define ZB_TEST_NAME TP_154_MAC_ASSOCIATION_04_TH_RFD1
#define ZB_TRACE_FILE_ID 57316
#include "zb_common.h"
...
MAIN()
{
    ...
    ZB_INIT("tp_154_mac_association_04_th_rfd1");
