 ...
 * DSR.
 */
/*  PURPOSE: TP/154/MAC/FRAME-VALIDATION-03 test constants
*/
#ifndef TP_154_MAC_FRAME_VALIDATION_03_COMMON_H
#define TP_154_MAC_FRAME_VALIDATION_03_COMMON_H 1

#define TEST_PAN_ID                0x1AAA

#define TEST_DUT_FFD0_MAC_ADDRESS  {0x01, 0x00, 0x00, 0x00, 0x00, 0x48, 0xDE, 0xAC}
#define TEST_TH_FFD1_MAC_ADDRESS   {0x02, 0x00, 0x00, 0x00, 0x00, 0x48, 0xDE, 0xAC}
...
#define TEST_BEACON_PAYLOAD        {0x12, 0x34}

#endif /* TP_154_MAC_FRAME_VALIDATION_03_COMMON_H */
