 ...
 * DSR.
 */
/* PURPOSE: TP/154/MAC/SCANNING-05 DUT FFD1
MAC-only build
*/

#define ZB_TEST_NAME TP_154_MAC_SCANNING_05_DUT_FFD1
#define ZB_TRACE_FILE_ID 57209
#include "zb_common.h"
#include "zb_scheduler.h"
#include "zb_bufpool.h"
#include "../common/zb_cert_test_globals.h"
#include "tp_154_mac_scanning_05_common.h"
#include "zb_osif.h"
...
MAIN()
{
    ...
    ZB_INIT("tp_154_mac_scanning_05_dut_ffd1");
...
zb_bool_t auto_req_result5 = ZB_FALSE;
zb_bool_t no_auto_req_result5 = ZB_FALSE;
...
ZB_MLME_SCAN_CONFIRM(zb_uint8_t param)
{
    ...
    else
    {
        ...
        if (scan_confirm->status == 0x00 &&
                ...
                scan_confirm->unscanned_channels == 0x00000000)
        {
            no_auto_req_result5 = ZB_TRUE;
        }
    }

    if (auto_req_result5 && no_auto_req_result5)
    {
        zb_osif_led_on(0); // blue
        TRACE_MSG(TRACE_APP1, "Scanning05 success", (FMT__0));
    }
