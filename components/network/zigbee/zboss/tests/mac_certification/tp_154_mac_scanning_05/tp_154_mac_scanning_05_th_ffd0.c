 ...
 * DSR.
 */
/* PURPOSE: TP/154/MAC/SCANNING-05 TH FFD0
MAC-only build
*/

#define ZB_TEST_NAME TP_154_MAC_SCANNING_05_TH_FFD0
#define ZB_TRACE_FILE_ID 57210
#include "zb_common.h"
...
MAIN()
{
    ...
    ZB_INIT("tp_154_mac_scanning_05_th_ffd0");
