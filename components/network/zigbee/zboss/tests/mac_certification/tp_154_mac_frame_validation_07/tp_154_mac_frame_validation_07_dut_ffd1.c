 ...
 * DSR.
 */
/* PURPOSE: TP/154/MAC/FRAME-VALIDATION-07 FFD1
MAC-only build
*/

#define ZB_TEST_NAME TP_154_MAC_FRAME_VALIDATION_07_DUT_FFD1
#define ZB_TRACE_FILE_ID 57493
#include "zb_common.h"
...
static zb_ieee_addr_t g_ieee_addr_dut_ffd1 = TEST_DUT_FFD1_IEEE_ADDRESS;
...
MAIN()
{
  ...
  ZB_INIT("tp_154_mac_frame_validation_07_dut_ffd1");
...
ZB_MLME_ASSOCIATE_CONFIRM(zb_uint8_t param)
{
  ...
  TRACE_MSG(TRACE_APP1, "If no MCPS-DATA.indication(), Frame_validation07 success", (FMT__0));
  zb_buf_free(param);
}
...
ZB_MCPS_DATA_INDICATION(zb_uint8_t param)
{
	...
	TRACE_MSG(TRACE_APP1, "Frame_validation07 failed", (FMT__0));
  zb_buf_free(param);
}
/*! @} */
