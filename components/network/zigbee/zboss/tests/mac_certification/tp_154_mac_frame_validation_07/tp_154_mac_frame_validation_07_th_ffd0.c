 ...
 * DSR.
 */
/*  PURPOSE: TP/154/MAC/FRAME-VALIDATION-07 FFD0 implementation
*/

#define ZB_TEST_NAME TP_154_MAC_FRAME_VALIDATION_07_TH_FFD0
#define ZB_TRACE_FILE_ID 57476
#include "zb_common.h"
#include "zb_scheduler.h"
#include "zb_bufpool.h"
#include "../common/zb_cert_test_globals.h"
#include "tp_154_mac_frame_validation_07_common.h"
...
static zb_ieee_addr_t g_ieee_addr = TEST_TH_FFD0_IEEE_ADDRESS;
...
MAIN()
{
  ...
  ZB_INIT("tp_154_mac_frame_validation_07_th_ffd0");
...
static void test_mcps_data_request(zb_uint8_t param)
{
  ...
  data_req->dst_addr_mode = ZB_ADDR_NO_ADDR;
...
ZB_MLME_ASSOCIATE_INDICATION(zb_uint8_t param)
{
  ...
  ZB_MLME_BUILD_ASSOCIATE_RESPONSE(param, device_address, TEST_DUT_FFD1_SHORT_ADDRESS, 0);
