 ...
 * DSR.
 */
/*  PURPOSE: TP/154/MAC/FRAME-VALIDATION-04 FFD0 implementation
*/

#define ZB_TEST_NAME TP_154_MAC_FRAME_VALIDATION_04_DUT_FFD0
#define ZB_TRACE_FILE_ID 57546
#include "zb_common.h"
...
MAIN()
{
  ...
  ZB_INIT("tp_154_mac_frame_validation_04_dut_ffd0");
...
ZB_MLME_COMM_STATUS_INDICATION(zb_uint8_t param)
{
  ...
  TRACE_MSG(TRACE_APP1, "If no MCPS-DATA.indication(), Frame_validation04 success", (FMT__0));
  zb_buf_free(param);
}
...
ZB_MCPS_DATA_INDICATION(zb_uint8_t param)
{
	...
	TRACE_MSG(TRACE_APP1, "Frame_validation04 failed", (FMT__0));
  zb_buf_free(param);
}
/*! @} */
