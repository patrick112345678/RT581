 ...
 * DSR.
 */
/*  PURPOSE: TP/154/MAC/BEACON-MANAGEMENT-06 DUT2 FFD0 implementation
*/


#define ZB_TEST_NAME TP_154_MAC_BEACON_MANAGEMENT_06_DUT2_FFD0
#define ZB_TRACE_FILE_ID 63845
#include "zb_common.h"
