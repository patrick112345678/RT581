...
#define ZB_TEST_NAME TP_154_MAC_ASSOCIATION_02_DUT_FFD0
#define ZB_TRACE_FILE_ID 57197
#include "zb_common.h"
#include "zb_scheduler.h"
#include "zb_bufpool.h"
#include "../common/zb_cert_test_globals.h"
#include "tp_154_mac_association_02_common.h"
#include "zb_osif.h"
...
MAIN()
{
    ...
    ZB_INIT("tp_154_mac_association_02_dut_ffd0");
...
ZB_MLME_ASSOCIATE_INDICATION(zb_uint8_t param)
{
    ...
    TRACE_MSG(TRACE_APP1, "DeviceAddress = " TRACE_FORMAT_64,
              (FMT__A, TRACE_ARG_64(device_address)));
    ...
    ZB_MLME_BUILD_ASSOCIATE_RESPONSE(param, device_address, 0xffff, MAC_PAN_AT_CAPACITY);
...
ZB_MLME_COMM_STATUS_INDICATION(zb_uint8_t param)
{
    ...
    TRACE_MSG(TRACE_APP1, "Check for negative association response. (Status = 0x01, PAN at capacity)", (FMT__0));
    zb_buf_free(param);
}
