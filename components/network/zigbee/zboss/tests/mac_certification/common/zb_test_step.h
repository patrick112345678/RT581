...
typedef struct zb_test_control_ctx_s
{
  ...
  zb_uint16_t steps_num;
  zb_uint16_t step_idx;
 ...
 */
zb_test_step_info_t *test_step_get_info(zb_uint16_t step_no);
...
extern zb_test_control_ctx_t test_control_ctx;
#endif /* _ZB_TEST_STEP */
