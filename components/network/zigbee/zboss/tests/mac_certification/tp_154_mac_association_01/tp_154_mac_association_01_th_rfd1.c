 ...
 * DSR.
 */
/* PURPOSE: P/154/MAC/ASSOCIATION-01 TH RFD0
MAC-only build
*/

#define ZB_TEST_NAME TP_154_MAC_ASSOCIATION_01_TH_RFD1
#define ZB_TRACE_FILE_ID 57196
...
MAIN()
{
    ...
    ZB_INIT("tp_154_mac_association_01_th_rfd1");
