 ...
 * DSR.
 */
/*  PURPOSE: TP/154/MAC/BEACON-MANAGEMENT-04 DUT1 FFD1 implementation
*/


#define ZB_TEST_NAME TP_154_MAC_BEACON_MANAGEMENT_04_DUT1_FFD1
#define ZB_TRACE_FILE_ID 63843
#include "zb_common.h"
...
MAIN()
{
    ...
    ZB_INIT("tp_154_mac_beacon_management_04_dut1_ffd1");
...
static void test_ieee_joining_list_clear(zb_uint8_t param)
{
    ...
    TRACE_MSG(TRACE_APP1, "MLME-SET.request() clear mibJoiningList", (FMT__0));
...
static void test_set_joining_policy(zb_uint8_t param)
{
    ...
    TRACE_MSG(TRACE_APP1, "ffd1 g_test_step %hd", (FMT__H, g_test_step));
...
static void test_ieee_joining_list_add(zb_uint8_t param)
{
    ...
    ZB_MEMCPY(&jl_set_req->param.ieee_value, g_ieee_addr_dut2, sizeof(zb_ieee_addr_t));
...
ZB_MLME_ASSOCIATE_INDICATION(zb_uint8_t param)
{
    ...
    ZB_MLME_BUILD_ASSOCIATE_RESPONSE(param, device_address, TEST_DUT2_FFD0_SHORT_ADDRESS, 0);
