 ...
 * DSR.
 */
/*  PURPOSE: TP/154/MAC/WARM-START-02 DUT FFD1 implementation
*/

#define ZB_TEST_NAME TP_154_MAC_WARM_START_02_DUT_FFD1
#define ZB_TRACE_FILE_ID 57406
#include "zb_common.h"
#include "zb_scheduler.h"
#include "zb_bufpool.h"
#include "../common/zb_cert_test_globals.h"
#include "tp_154_mac_warm_start_02_common.h"
...
static zb_ieee_addr_t g_ieee_addr = TEST_DUT_FFD1_IEEE_ADDR;
...
MAIN()
{
  ...
  ZB_INIT("tp_154_mac_warm_start_02_dut_ffd1");
...
static void test_set_ieee_addr(zb_uint8_t param)
{
  ...
  TRACE_MSG(TRACE_MAC_API1, "MLME-SET.request() mac IEEE addr", (FMT__0));
...
static void test_set_pan_id(zb_uint8_t param)
{
  ...
  TRACE_MSG(TRACE_MAC_API1, "MLME-SET.request() mac pan id", (FMT__0));
...
static void test_get_pan_id(zb_uint8_t param)
{
  ...
  TRACE_MSG(TRACE_MAC_API1, "MLME-GET.request() mac pan id", (FMT__0));
...
static void test_set_short_addr(zb_uint8_t param)
{
  ...
  TRACE_MSG(TRACE_MAC_API1, "MLME-SET.request() mac short addr", (FMT__0));
...
static void test_get_short_addr(zb_uint8_t param)
{
  ...
  TRACE_MSG(TRACE_MAC_API1, "MLME-GET.request() mac short addr", (FMT__0));
...
static void test_set_coord_short_addr(zb_uint8_t param)
{
  ...
  TRACE_MSG(TRACE_MAC_API1, "MLME-SET.request() mac coord short addr", (FMT__0));
...
static void test_get_coord_short_addr(zb_uint8_t param)
{
  ...
  TRACE_MSG(TRACE_MAC_API1, "MLME-GET.request() mac coord short addr", (FMT__0));
...
static void test_set_coord_ieee_addr(zb_uint8_t param)
{
  ...
  TRACE_MSG(TRACE_MAC_API1, "MLME-SET.request() mac coord IEEE addr", (FMT__0));
...
static void test_get_coord_ieee_addr(zb_uint8_t param)
{
  ...
  TRACE_MSG(TRACE_MAC_API1, "MLME-GET.request() mac coord IEEE addr", (FMT__0));
...
ZB_MCPS_DATA_CONFIRM(zb_uint8_t param)
{
	...
	TRACE_MSG(TRACE_MAC_API1, "MCPS-DATA.confirm(): Status = %hx", (FMT__0, confirm->status));
	if (confirm->status == 0x00 &&
		  confirm->msdu_handle == 0x0A)
	{
		zb_osif_led_on(0);
		TRACE_MSG(TRACE_MAC_API1, "Warm_start02 success", (FMT__0));
	}
  zb_buf_free(param);
}
