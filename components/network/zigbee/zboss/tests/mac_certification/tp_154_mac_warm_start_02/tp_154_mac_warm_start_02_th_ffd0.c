 ...
 * DSR.
 */
/*  PURPOSE: TP/154/MAC/WARM-START-02 DUT FFD0 implementation
*/

#define ZB_TEST_NAME TP_154_MAC_WARM_START_02_TH_FFD0
#define ZB_TRACE_FILE_ID 41694
#include "zb_common.h"
...
static zb_ieee_addr_t g_ieee_addr = TEST_TH_FFD0_IEEE_ADDR;
...
MAIN()
{
  ...
  ZB_INIT("tp_154_mac_warm_start_02_th_ffd0");
