 ...
 * DSR.
 */
/* PURPOSE: TP/154/MAC/SCANNING-06 TH FFD4
MAC-only build
*/

#define ZB_TEST_NAME TP_154_MAC_SCANNING_06_TH_FFD4
#define ZB_TRACE_FILE_ID 57242
#include "zb_common.h"
...
MAIN()
{
    ...
    ZB_INIT("tp_154_mac_scanning_06_th_ffd4");
