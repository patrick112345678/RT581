 ...
 * DSR.
 */
/* PURPOSE: TP/154/MAC/SCANNING-06 TH FFD1
MAC-only build
*/

#define ZB_TEST_NAME TP_154_MAC_SCANNING_06_TH_FFD1
#define ZB_TRACE_FILE_ID 57243
#include "zb_common.h"
...
MAIN()
{
  ...
  ZB_INIT("tp_154_mac_scanning_06_th_ffd1");
...
static void test_set_association_permit(zb_uint8_t param)
{
  ...
  req->pib_length = sizeof(zb_uint8_t);
  *((zb_uint8_t *)(req+1)) = association_permit;
