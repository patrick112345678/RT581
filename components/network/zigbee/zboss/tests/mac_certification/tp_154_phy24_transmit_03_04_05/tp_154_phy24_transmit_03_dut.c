...
#define ZB_TEST_NAME TP_154_PHY24_TRANSMIT_03_04_05_DUT
#define ZB_TRACE_FILE_ID 57603
#include "zb_common.h"
#include "zb_scheduler.h"
#include "zb_bufpool.h"
#include "../common/zb_cert_test_globals.h"
#include "tp_154_phy24_transmit_03_common.h"
...
MAIN()
{
  ...
  ZB_INIT("tp_154_phy24_transmit_03_dut");
...
static void test_send_next_packet(zb_uint8_t param)
{
  ...
  else
  {
    if (gs_current_channel < TEST_CHANNEL_MAX)
    {
      ...
      ZB_SCHEDULE_ALARM(test_set_channel, param, TEST_CHANNEL_SWITCH_PERIOD);
    }
    else
    {
