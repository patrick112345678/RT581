 ...
 * DSR.
 */
/*  PURPOSE: TP/154/MAC/FRAME-VALIDATION-06 FFD0 implementation
*/

#define ZB_TEST_NAME TP_154_MAC_FRAME_VALIDATION_06_DUT_FFD0
#define ZB_TRACE_FILE_ID 57511
#include "zb_common.h"
#include "zb_scheduler.h"
#include "zb_bufpool.h"
#include "../common/zb_cert_test_globals.h"
#include "tp_154_mac_frame_validation_06_common.h"
#include "zb_osif.h"
...
MAIN()
{
    ...
    ZB_INIT("tp_154_mac_frame_validation_06_dut_ffd0");
...
ZB_MLME_COMM_STATUS_INDICATION(zb_uint8_t param)
{
    ...
    TRACE_MSG(TRACE_APP1, "If no MCPS-DATA.indication(), Frame_validation06 success", (FMT__0));
    zb_buf_free(param);
}
...
ZB_MCPS_DATA_INDICATION(zb_uint8_t param)
{
    ...
    TRACE_MSG(TRACE_APP1, "Frame_validation06 failed", (FMT__0));
    zb_buf_free(param);
}
/*! @} */
