 ...
 * DSR.
 */
/* PURPOSE: TP/154/MAC/FRAME-VALIDATION-06 FFD1
MAC-only build
*/

#define ZB_TEST_NAME TP_154_MAC_FRAME_VALIDATION_06_TH_FFD1
#define ZB_TRACE_FILE_ID 57510
#include "zb_common.h"
...
MAIN()
{
    ...
    ZB_INIT("tp_154_mac_frame_validation_06_th_ffd1");
...
static void test_mcps_data_request(zb_uint8_t param)
{
    ...
    zb_ieee_addr_t ieee_addr = TEST_INVALID_IEEE_ADDRESS;
    ...
    ZB_IEEE_ADDR_COPY(data_req->dst_addr.addr_long, ieee_addr);
