 ...
 * DSR.
 */
/*  PURPOSE: TP/154/MAC/BEACON-MANAGEMENT-02 DUT FFD0 implementation
*/

#define ZB_TEST_NAME TP_154_MAC_BEACON_MANAGEMENT_02_DUT_FFD0
#define ZB_TRACE_FILE_ID 57279
#include "zb_common.h"
#include "zb_scheduler.h"
#include "zb_bufpool.h"
#include "../common/zb_cert_test_globals.h"
#include "tp_154_mac_beacon_management_02_common.h"
...
MAIN()
{
    ...
    ZB_INIT("tp_154_mac_beacon_management_02_dut_ffd0");
...
ZB_MLME_START_CONFIRM(zb_uint8_t param)
{
    ...
    TRACE_MSG(TRACE_APP1, "Check the beacon - No payload.", (FMT__0));
    zb_buf_free(param);
}
