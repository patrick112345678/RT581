...
#define ZB_TEST_NAME TP_154_PHY24_TURNAROUND_TIME_01_TH
#define ZB_TRACE_FILE_ID 57219
#include "zb_common.h"
...
MAIN()
{
  ...
  ZB_INIT("tp_154_phy24_turnaround_time_01_th");
...
static void test_mcps_data_request(zb_uint8_t param)
{
  ...
  data_req->dst_addr.addr_short = TEST_DUT_SHORT_ADDRESS;
