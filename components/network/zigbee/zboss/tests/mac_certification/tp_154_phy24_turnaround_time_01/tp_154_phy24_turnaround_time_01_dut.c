...
#define ZB_TEST_NAME TP_154_PHY24_TURNAROUND_TIME_01_DUT
#define ZB_TRACE_FILE_ID 57218
#include "zb_common.h"
#include "zb_scheduler.h"
#include "zb_bufpool.h"
#include "../common/zb_cert_test_globals.h"
#include "tp_154_phy24_turnaround_time_01_common.h"
...
extern zb_bool_t tat_test;

MAIN()
{
    ARGV_UNUSED;
    tat_test = 1;
    ZB_INIT("tp_154_phy24_turnaround_time_01_dut");
...
static void test_next_packet_recvd(zb_uint8_t param)
{
    ...
    {
        //ZB_SCHEDULE_ALARM(test_next_channel_caller, 0, TEST_DUT_SWITCH_CHANNEL_TMO);
    }
