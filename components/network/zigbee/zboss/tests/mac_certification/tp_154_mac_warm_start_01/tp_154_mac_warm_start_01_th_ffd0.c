 ...
 * DSR.
 */
/*  PURPOSE: TP/154/MAC/WARM-START-01 DUT FFD0 implementation
*/

#define ZB_TEST_NAME TP_154_MAC_WARM_START_01_TH_FFD0
#define ZB_TRACE_FILE_ID 57387
#include "zb_common.h"
...
MAIN()
{
    ...
    ZB_INIT("tp_154_mac_warm_start_01_th_ffd0");
