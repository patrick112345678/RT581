...
#define ZB_TEST_NAME TP_154_PHY24_TRANSMIT_02_DUT
#define ZB_TRACE_FILE_ID 56312
#include <stdio.h>
#include "zb_common.h"
#include "zb_scheduler.h"
#include "zb_bufpool.h"
#include "../common/zb_cert_test_globals.h"
#include "tp_154_phy24_transmit_02_common.h"
...
static void test_get_command(zb_uint8_t param)
{
    ...
    {
    case STARTING:
        printf("Send u/d to increase/decrease channel number. Send t to transmit continuous wave on the current channel.\n");
...
static void test_mcps_data_request(zb_uint8_t param)
{
    ...
    rfb_comm_single_tone_mode_set(2);
