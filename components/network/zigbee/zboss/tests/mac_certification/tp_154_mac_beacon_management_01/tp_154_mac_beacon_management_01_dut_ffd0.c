 ...
 * DSR.
 */
/*  PURPOSE: TP/154/MAC/BEACON-MANAGEMENT-01 DUT FFD0 implementation
*/

#define ZB_TEST_NAME TP_154_MAC_BEACON_MANAGEMENT_01_DUT_FFD0
#define ZB_TRACE_FILE_ID 57261
#include "zb_common.h"
#include "zb_scheduler.h"
#include "zb_bufpool.h"
#include "../common/zb_cert_test_globals.h"
#include "tp_154_mac_beacon_management_01_common.h"
...
static void test_get_beacon_payload_length(zb_uint8_t param);
static void test_set_beacon_payload(zb_uint8_t param);
static void test_get_beacon_payload(zb_uint8_t param);
...
MAIN()
{
  ...
  ZB_INIT("tp_154_mac_beacon_management_01_dut_ffd0");
...
static void test_set_beacon_payload_length(zb_uint8_t param)
{
  ...
  *((zb_uint8_t *)(req + 1)) = TEST_BEACON_PAYLOAD_LENGTH;
  req->confirm_cb_u.cb = test_get_beacon_payload_length;
  zb_mlme_set_request(param);
}
...
static void test_set_beacon_payload(zb_uint8_t param)
{
  ...
  req->confirm_cb_u.cb = test_get_beacon_payload;
...
ZB_MLME_START_CONFIRM(zb_uint8_t param)
{
  ...
  TRACE_MSG(TRACE_APP1, "Check the beacon - Payload = 1234.", (FMT__0));
  zb_buf_free(param);
}
