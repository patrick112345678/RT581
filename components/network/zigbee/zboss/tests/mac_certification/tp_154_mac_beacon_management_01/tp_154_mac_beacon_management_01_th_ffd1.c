 ...
 * DSR.
 */
/*  PURPOSE: TP/154/MAC/BEACON-MANAGEMENT-01 TH FFD1 implementation
*/

#define ZB_TEST_NAME TP_154_MAC_BEACON_MANAGEMENT_01_TH_FFD1
#define ZB_TRACE_FILE_ID 57262
#include "zb_common.h"
...
MAIN()
{
    ...
    ZB_INIT("tp_154_mac_beacon_management_01_th_ffd1");
