 ...
 * DSR.
 */
/* PURPOSE: 5.3. P/154/MAC/SCANNING-03 TH FFD0
MAC-only build
*/

#define ZB_TEST_NAME TP_154_MAC_SCANNING_03_TH_FFD0
#define ZB_TRACE_FILE_ID 57206
#include "zb_common.h"
...
MAIN()
{
  ...
  ZB_INIT("tp_154_mac_scanning_03_th_ffd0");
