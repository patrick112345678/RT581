...
#define ZB_TEST_NAME TP_154_MAC_SCANNING_03_DUT_FFD1
#define ZB_TRACE_FILE_ID 41702
#include "zb_common.h"
#include "zb_scheduler.h"
#include "zb_bufpool.h"
#include "../common/zb_cert_test_globals.h"
#include "tp_154_mac_scanning_03_common.h"
#include "zb_osif.h"
...
MAIN()
{
  ...
  ZB_INIT("tp_154_mac_scanning_03_dut_ffd1");
...
zb_bool_t auto_req_result3 = ZB_FALSE;
zb_bool_t no_auto_req_result3 = ZB_FALSE;
...
ZB_MLME_SCAN_CONFIRM(zb_uint8_t param)
{
  ...
  {
		TRACE_MSG(TRACE_APP1, "macAutoRequest = True.", (FMT__0));		
    ...
    if (scan_confirm->status == 0x00 &&
	  ...
	  {
      auto_req_result3 = ZB_TRUE;
	  }
  }
  else
  {
		TRACE_MSG(TRACE_APP1, "macAutoRequest = False.", (FMT__0));		
    ...
    if (scan_confirm->status == 0x00 &&
	    ...
	    scan_confirm->unscanned_channels == 0x00000000)
	  {
      no_auto_req_result3 = ZB_TRUE;
	  }
  }
	
	if (auto_req_result3 && no_auto_req_result3)
	{
		zb_osif_led_on(0); // blue 
    TRACE_MSG(TRACE_APP1, "Scanning03 success", (FMT__0));		
	}
