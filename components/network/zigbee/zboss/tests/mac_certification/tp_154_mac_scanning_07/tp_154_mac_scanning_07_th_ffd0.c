 ...
 * DSR.
 */
/* PURPOSE: P/154/MAC/SCANNING-07 TH FFD0
MAC-only build
*/

#define ZB_TEST_NAME TP_154_MAC_SCANNING_07_TH_FFD0
#define ZB_TRACE_FILE_ID 57212
#include "zb_common.h"
...
MAIN()
{
    ...
    ZB_INIT("tp_154_mac_scanning_07_th_ffd0");
...
ZB_MLME_ORPHAN_INDICATION(zb_uint8_t param)
{
    ...
    resp->short_addr = TEST_DUT_FFD1_SHORT_ADDRESS;
