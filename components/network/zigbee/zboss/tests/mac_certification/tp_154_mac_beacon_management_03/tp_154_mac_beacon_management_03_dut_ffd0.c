 ...
 * DSR.
 */
/*  PURPOSE: TP/154/MAC/BEACON-MANAGEMENT-03 DUT FFD0 implementation
*/

#define ZB_TEST_NAME TP_154_MAC_BEACON_MANAGEMENT_03_DUT_FFD0
#define ZB_TRACE_FILE_ID 57298
#include "zb_common.h"
...
MAIN()
{
  ...
  ZB_INIT("tp_154_mac_beacon_management_03_dut_ffd0");
