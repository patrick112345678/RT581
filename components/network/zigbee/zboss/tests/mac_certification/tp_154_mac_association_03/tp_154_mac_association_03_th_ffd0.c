 ...
 * DSR.
 */
/* PURPOSE: P/154/MAC/ASSOCIATION-03 TH FFD0
MAC-only build
*/

#define ZB_TEST_NAME TP_154_MAC_ASSOCIATION_03_TH_FFD0
#define ZB_TRACE_FILE_ID 57200
#include "zb_common.h"
...
MAIN()
{
    ...
    ZB_INIT("tp_154_mac_association_03_th_ffd0");
