...
#endif /* #elif defined NRF52833_XXAA */
...
#if defined ZB_NRF_52 && defined SOFTDEVICE_PRESENT
static void zb_multi_test_init_ble(void)
{
    /* Initialize BLE stack. */
    ble_zigbee_cert_uart_init();
}

static void zb_multi_test_start_ble(void)
{
    /* Start BLE stack */
...
static zb_bool_t command_parameter_handler(char *key, char *value)
{
    ...
    else if (strcmp(key, "mode") == 0)
    {
        ...
        {
            g_cert_test_ctx.mode = used_mode;
        }
    }
#endif
    return ZB_TRUE;
