...
*/
#ifndef __RTP_HA_03_COMMON_
#define __RTP_HA_03_COMMON_
...
#define RTP_HA_03_STEP_1_DELAY_ZR      (5 * ZB_TIME_ONE_SECOND)
#define RTP_HA_03_STEP_1_TIME_ZR       (0)

/* DUT is target, TH is initiator */
#define DUT_ENDPOINT                   123
#define TH_ENDPOINT                    10

#endif /* __RTP_HA_03_COMMON_ */
