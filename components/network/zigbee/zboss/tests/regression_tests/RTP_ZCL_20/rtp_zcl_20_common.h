...
*/
#ifndef __RTP_ZCL_20_COMMON_
#define __RTP_ZCL_20_COMMON_
...
#define RTP_ZCL_20_STEP_1_DELAY_ZC    (3 * ZB_TIME_ONE_SECOND)
#define RTP_ZCL_20_STEP_1_TIME_ZC     (3 * ZB_TIME_ONE_SECOND)
#define RTP_ZCL_20_STEP_2_TIME_ZC     (3 * ZB_TIME_ONE_SECOND)
#define RTP_ZCL_20_STEP_3_TIME_ZC     (3 * ZB_TIME_ONE_SECOND)

#define DUT_ENDPOINT_CLI_1            10
#define DUT_ENDPOINT_CLI_2            11
