...
#ifndef __RTP_BDB_06_
#define __RTP_BDB_06_
...
#define RTP_BDB_06_STEP_1_DELAY_ZR1 (10 * ZB_TIME_ONE_SECOND)
#define RTP_BDB_06_STEP_1_TIME_ZR1  (5  * ZB_TIME_ONE_SECOND)
#define RTP_BDB_06_STEP_2_TIME_ZR1  (5  * ZB_TIME_ONE_SECOND)
