...
#define ZB_TEST_NAME RTP_BDB_10_DUT_ZED

#define ZB_TRACE_FILE_ID 40327
#include "zb_common.h"
...
zb_bool_t g_first_leave = ZB_TRUE;
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    case ZB_BDB_SIGNAL_STEERING:
        ...
        if (status == 0 && !g_first_leave)
        {
            TRACE_MSG(TRACE_APP1, "Successful steering: test OK", (FMT__0));
        }
