...
#ifndef __RTP_BDB_10_
#define __RTP_BDB_10_
...
#define RTP_BDB_10_STEP_1_DELAY_ZC (7 * ZB_TIME_ONE_SECOND)
#define RTP_BDB_10_STEP_1_TIME_ZC  (10  * ZB_TIME_ONE_SECOND)
#define RTP_BDB_10_STEP_2_TIME_ZC  (0)
