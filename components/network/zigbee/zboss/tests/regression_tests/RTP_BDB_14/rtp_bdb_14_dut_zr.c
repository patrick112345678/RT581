...
#define ZB_TEST_NAME RTP_BDB_14_DUT_ZR
#define ZB_TRACE_FILE_ID 40336
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    case ZB_BDB_SIGNAL_DEVICE_REBOOT:
        ...
        if (status == 0)
        {
            ...
            {
                test_step_register(trigger_steering, 0, RTP_BDB_14_STEP_1_TIME_ZR);
                test_control_start(TEST_MODE, RTP_BDB_14_STEP_1_DELAY_ZR);
            }
