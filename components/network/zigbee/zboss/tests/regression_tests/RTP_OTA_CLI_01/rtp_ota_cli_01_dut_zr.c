...
#define ZB_TEST_NAME RTP_OTA_CLI_01_DUT_ZR

#define ZB_TRACE_FILE_ID 40420
//#include "zboss_api.h"
...
#include "rtp_ota_cli_01_dut_zr.h"
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST(rtp_ota_cli_01_dut_zr_basic_attr_list, &g_attr_zcl_version, &g_attr_power_source);
...
ZB_ZCL_DECLARE_OTA_UPGRADE_ATTRIB_LIST(rtp_ota_cli_01_dut_zr_ota_upgrade_attr_list,
...
ZB_HA_DECLARE_OTA_UPGRADE_CLIENT_CLUSTER_LIST(rtp_ota_cli_01_dut_zr_ota_upgrade_client_clusters,
        rtp_ota_cli_01_dut_zr_basic_attr_list, rtp_ota_cli_01_dut_zr_ota_upgrade_attr_list);

ZB_HA_DECLARE_OTA_UPGRADE_CLIENT_EP(rtp_ota_cli_01_dut_zr_ota_upgrade_client_ep, ENDPOINT, rtp_ota_cli_01_dut_zr_ota_upgrade_client_clusters);

ZB_HA_DECLARE_OTA_UPGRADE_CLIENT_CTX(rtp_ota_cli_01_dut_zr_ota_upgrade_client_ctx, rtp_ota_cli_01_dut_zr_ota_upgrade_client_ep);
...
MAIN()
{
    ...
    /****************** Register Device ********************************/
    ZB_AF_REGISTER_DEVICE_CTX(&rtp_ota_cli_01_dut_zr_ota_upgrade_client_ctx);
