...
#define ZB_TEST_NAME RTP_OTA_CLI_01_TH_ZC

#define ZB_TRACE_FILE_ID 40419
//#include "zboss_api.h"
...
#include "rtp_ota_cli_01_th_zc.h"
#include "rtp_ota_cli_01_common.h"
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST(rtp_ota_cli_01_th_zc_basic_attr_list, &g_attr_zcl_version, &g_attr_power_source);
...
ZB_ZCL_DECLARE_OTA_UPGRADE_ATTRIB_LIST_SERVER(rtp_ota_cli_01_th_zc_ota_upgrade_attr_list, &query_jitter, &current_time, 1);

/********************* Declare device **************************/

ZB_HA_DECLARE_OTA_UPGRADE_SERVER_CLUSTER_LIST(rtp_ota_cli_01_th_zc_ota_upgrade_server_clusters,
          rtp_ota_cli_01_th_zc_basic_attr_list, rtp_ota_cli_01_th_zc_ota_upgrade_attr_list);

ZB_HA_DECLARE_OTA_UPGRADE_SERVER_EP(rtp_ota_cli_01_th_zc_ota_upgrade_server_ep, ENDPOINT, rtp_ota_cli_01_th_zc_ota_upgrade_server_clusters);

ZB_HA_DECLARE_OTA_UPGRADE_SERVER_CTX(rtp_ota_cli_01_th_zc_ota_upgrade_server_ctx, rtp_ota_cli_01_th_zc_ota_upgrade_server_ep);
...
MAIN()
{
  ...
  /****************** Register Device ********************************/
  ZB_AF_REGISTER_DEVICE_CTX(&rtp_ota_cli_01_th_zc_ota_upgrade_server_ctx);
  ...
  if (ZB_GET_APP_SIGNAL_STATUS(param) == 0)
  {
    switch(sig)
    {
      ...
      case ZB_ZDO_SIGNAL_DEVICE_ANNCE:
        ...
        test_step_register(insert_ota_file, 0, RTP_OTA_CLI_01_STEP_1_TIME_ZC);
        test_control_start(TEST_MODE, RTP_OTA_CLI_01_STEP_1_DELAY_ZC);
