...
#define ZB_TEST_NAME RTP_MAC_01_DUT_ZR

#define ZB_TRACE_FILE_ID 40437
#include "zb_common.h"
  ...
  switch (sig)
  {
    case ZB_BDB_SIGNAL_DEVICE_FIRST_START:
      ...
      if (status == 0)
      {
        ...
        test_step_register(test_zboss_main_loop_stop, 0, RTP_MAC_01_STEP_1_TIME_ZR);

        test_control_start(TEST_MODE, RTP_MAC_01_STEP_1_DELAY_ZR);
      }
...
static void test_zboss_main_loop_stop(zb_uint8_t unused)
{
  ...
  osif_sleep_using_transc_timer(DUT_SLEEP_TIME);
