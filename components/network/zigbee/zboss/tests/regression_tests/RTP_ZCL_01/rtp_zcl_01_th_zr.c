...
#define ZB_TEST_NAME RTP_ZCL_01_TH_ZR

#define ZB_TRACE_FILE_ID 40285
#include "zb_common.h"
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST(rtp_zcl_01_th_zr_basic_attr_list, &attr_zcl_version, &attr_power_source);

/* Identify cluster attributes data */
static zb_uint16_t attr_identify_time = 0;

ZB_ZCL_DECLARE_IDENTIFY_ATTRIB_LIST(rtp_zcl_01_th_zr_identify_attr_list, &attr_identify_time);

/********************* Declare device **************************/
DECLARE_TH_CLUSTER_LIST(rtp_zcl_01_th_zr_device_clusters,
                        rtp_zcl_01_th_zr_basic_attr_list,
                        rtp_zcl_01_th_zr_identify_attr_list);

DECLARE_TH_EP(rtp_zcl_01_th_zr_device_ep,
              THR1_ENDPOINT,
              rtp_zcl_01_th_zr_device_clusters);

DECLARE_TH_CTX(rtp_zcl_01_th_zr_device_ctx, rtp_zcl_01_th_zr_device_ep);

static zb_uint16_t g_test_cluster_id = ZB_ZCL_ATTR_GLOBAL_CLUSTER_REVISION_ID;
