...
#define DUT_DEVICE_IN_CLUSTER_NUM 2 /*!< IN (server) clusters number */
#define DUT_DEVICE_OUT_CLUSTER_NUM 2 /*!<  OUT (client) clusters number */

#define DUT_DEVICE_REPORT_ATTR_COUNT 1 /*!< Reportable attributes count */
...
/*!
  ...
  @param occupancy_sensing_attr_list - attribute list for Occupancy Sensing cluster
 */
