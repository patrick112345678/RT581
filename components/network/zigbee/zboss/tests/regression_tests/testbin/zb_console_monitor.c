...
#if defined ZB_USE_NVRAM && defined ZB_NSNG
#ifdef ZB_ED_ROLE
    zb_char_t *nvram_name = "multitest_zed";
#else
    zb_char_t *nvram_name = "multitest_zczr";
#endif

    zb_osif_nvram_init(nvram_name);
#endif
