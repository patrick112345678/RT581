...
*/
#ifndef __RTP_ZCL_10_COMMON_
#define __RTP_ZCL_10_COMMON_
...
#define RTP_ZCL_10_STEP_1_DELAY_ZC    (1 * ZB_TIME_ONE_SECOND)
#define RTP_ZCL_10_STEP_1_TIME_ZC     (3 * ZB_TIME_ONE_SECOND)
#define RTP_ZCL_10_STEP_2_TIME_ZC     (3 * ZB_TIME_ONE_SECOND)
