...
#define ZB_TEST_NAME RTP_ZCL_10_TH_ZR

#define ZB_TRACE_FILE_ID 40414
#include "zb_common.h"
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST(rtp_zcl_10_th_zr_basic_attr_list, &attr_zcl_version, &attr_power_source);

/* Identify cluster attributes data */
static zb_uint16_t attr_identify_time = ZB_ZCL_IDENTIFY_IDENTIFY_TIME_DEFAULT_VALUE;

ZB_ZCL_DECLARE_IDENTIFY_ATTRIB_LIST(rtp_zcl_10_th_zr_identify_attr_list, &attr_identify_time);
...
ZB_ZCL_DECLARE_ON_OFF_ATTRIB_LIST_EXT(rtp_zcl_10_th_zr_on_off_attr_list,
                                      &attr_on_off,
                                      &global_scene_ctrl,
                                      &on_time,
                                      &off_wait_time);
...
/********************* Declare device **************************/
DECLARE_TH_CLUSTER_LIST(rtp_zcl_10_th_zr_device_clusters,
                        rtp_zcl_10_th_zr_basic_attr_list,
                        rtp_zcl_10_th_zr_identify_attr_list,
                        custom_attr_list);

DECLARE_TH_EP(rtp_zcl_10_th_zr_device_ep,
              TH_ENDPOINT,
              rtp_zcl_10_th_zr_device_clusters);

DECLARE_TH_CTX(rtp_zcl_10_th_zr_device_ctx, rtp_zcl_10_th_zr_device_ep);
...
MAIN()
{
  ...
  ZB_AF_REGISTER_DEVICE_CTX(&rtp_zcl_10_th_zr_device_ctx);
