...
#define ZB_TEST_NAME RTP_ZCL_03_DUT_ZC

#define ZB_TRACE_FILE_ID 40381
#include "zb_common.h"
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST(rtp_zcl_03_dut_zc_basic_attr_list, &attr_zcl_version, &attr_power_source);
...
ZB_ZCL_DECLARE_ON_OFF_ATTRIB_LIST_EXT(rtp_zcl_03_dut_zc_on_off_attr_list,
                                      &attr_on_off,
                                      &global_scene_ctrl,
                                      &on_time,
                                      &off_wait_time);
...
/********************* Declare device **************************/
DECLARE_DUT_CLUSTER_LIST(rtp_zcl_03_dut_zc_device_clusters,
                         rtp_zcl_03_dut_zc_basic_attr_list,
                         rtp_zcl_03_dut_zc_on_off_attr_list);

DECLARE_DUT_EP(rtp_zcl_03_dut_zc_device_ep,
               DUT_ENDPOINT,
               rtp_zcl_03_dut_zc_device_clusters);

DECLARE_DUT_CTX(rtp_zcl_03_dut_zc_device_ctx, rtp_zcl_03_dut_zc_device_ep);
/*************************************************************************/
...
MAIN()
{
  ...
  ZB_AF_REGISTER_DEVICE_CTX(&rtp_zcl_03_dut_zc_device_ctx);
