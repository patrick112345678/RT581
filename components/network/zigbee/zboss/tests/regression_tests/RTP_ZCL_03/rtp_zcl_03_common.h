...
*/
#ifndef __RTP_ZCL_03_COMMON_
#define __RTP_ZCL_03_COMMON_
...
#define RTP_ZCL_03_STEP_1_DELAY_ZR (1 * ZB_TIME_ONE_SECOND)
#define RTP_ZCL_03_STEP_1_TIME_ZR  (2 * ZB_TIME_ONE_SECOND)

#define DUT_BUFFER_TEST_REQ_LEN    5

/* DUT is target, TH is initiator */
#define DUT_ENDPOINT               143
#define THR1_ENDPOINT              10

#endif /* __RTP_ZCL_03_COMMON_ */
