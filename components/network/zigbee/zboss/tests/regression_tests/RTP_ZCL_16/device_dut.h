...
#define DUT_DEVICE_ID   0xaa02
#define DUT_DEVICE_VER  0  /*!< device version */

#define DUT_DEVICE_IN_CLUSTER_NUM 1 /*!< IN (server) clusters number */
#define DUT_DEVICE_OUT_CLUSTER_NUM 3 /*!<  OUT (client) clusters number */

#define DUT_DEVICE_CLUSTER_NUM (DUT_DEVICE_IN_CLUSTER_NUM + \
                               DUT_DEVICE_OUT_CLUSTER_NUM)
...
/* ZCL ON/OFF request without APS ack and without delay */
#define ZB_ZCL_ON_OFF_SEND_TOGGLE_REQ_WITHOUT_ACK(                                             \
    buffer, addr, dst_addr_mode, dst_ep, ep, prof_id, dis_default_resp, cb, delay)             \
{                                                                                              \
  ...
  ZB_ZCL_SEND_COMMAND_SHORT_WITHOUT_ACK(buffer, ptr, addr, dst_addr_mode, dst_ep, ep, prof_id, \
                                  ZB_ZCL_CLUSTER_ID_ON_OFF, cb, delay);  \
}
