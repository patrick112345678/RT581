...
#define ZB_TEST_NAME RTP_MAC_06_TH_ZR2
#define ZB_TRACE_FILE_ID 40346
...
MAIN()
{
    ...
    /* Allow to initialize device with zero IEEE address */
    ZB_REGRESSION_TESTS_API().allow_zero_ieee_addr = ZB_TRUE;
