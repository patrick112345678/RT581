...
*/
#ifndef __RTP_APS_08_COMMON_
#define __RTP_APS_08_COMMON_
...
#define RTP_APS_08_STEP_1_DELAY_ZED (10 * ZB_TIME_ONE_SECOND)
#define RTP_APS_08_STEP_1_TIME_ZED  (15 * ZB_TIME_ONE_SECOND)
#define RTP_APS_08_STEP_2_TIME_ZED  (10 * ZB_TIME_ONE_SECOND)

/* DUT is target, TH is initiator */
#define DUT_ENDPOINT               143
#define TH_ENDPOINT                10

#define TEST_TIME_UNTIL_LOCK_COUNT_PRINTING (4 * ZB_TIME_ONE_SECOND)
#define TEST_TIME_UNTIL_SECOND_ACK_SENDING (2 * ZB_TIME_ONE_SECOND)

#endif /* __RTP_APS_08_COMMON_ */
