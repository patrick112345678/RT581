...
RTP_HA_02 - ZCL Version attribute of Basic Cluster

Objective:

	To confirm that the read attribute handler correctly handles ZCL Version attribute for basic cluster if COMBINED_INTERFACE_CLUSTER_LIST is used.
