...
/* PURPOSE: DUT ZR
*/
#define ZB_TEST_NAME RTP_NWK_02_DUT_ZR

#define ZB_TRACE_FILE_ID 40277
#include "zb_common.h"
...
static zb_uint16_t addr_assignment_cb(zb_ieee_addr_t ieee_addr);
...
MAIN()
{
    ...
    zb_nwk_set_address_assignment_cb(addr_assignment_cb);
