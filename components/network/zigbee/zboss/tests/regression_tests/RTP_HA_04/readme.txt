...
RTP_HA_04 - ZCL Version attribute of Basic Cluster

Objective:

	To confirm that the read attribute handler correctly handles ZCL Version attribute for basic cluster if DOOR_LOCK_CLUSTER_LIST is used.
...
Expected outcome:
	...
	3. DUT ZC responds for the read attribute from TH ZR with Read Attribute Response
