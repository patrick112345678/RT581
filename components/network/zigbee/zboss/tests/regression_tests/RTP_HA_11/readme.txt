...
RTP_HA_11 - ZCL Version attribute of Basic Cluster

Objective:

	To confirm that the read attribute handler correctly handles ZCL Version attribute for basic cluster if TEST_DEVICE_CLUSTER_LIST is used.
