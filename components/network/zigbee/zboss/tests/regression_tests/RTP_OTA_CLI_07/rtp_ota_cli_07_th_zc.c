...
#define ZB_TEST_NAME RTP_OTA_CLI_07_TH_ZC
#define ZB_TRACE_FILE_ID 40301
...
#include "rtp_ota_cli_07_th_zc.h"
...
static zb_uint8_t g_key[16] = { 0xab, 0xcd, 0xef, 0x01, 0x23, 0x45, 0x67, 0x89, 0, 0, 0, 0, 0, 0, 0, 0};
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST(rtp_ota_cli_07_th_zc_basic_attr_list, &g_attr_zcl_version, &g_attr_power_source);
...
ZB_ZCL_DECLARE_TIME_ATTRIB_LIST(rtp_ota_cli_07_th_zc_time_attr_list, &g_time, &g_time_status, &g_time_zone,
...
ZB_ZCL_DECLARE_OTA_UPGRADE_ATTRIB_LIST_SERVER(rtp_ota_cli_07_th_zc_ota_upgrade_attr_list, &query_jitter, &g_time, 1);

/********************* Declare device **************************/

ZB_HA_DECLARE_OTA_UPGRADE_SERVER_CLUSTER_LIST(rtp_ota_cli_07_th_zc_ota_upgrade_server_clusters,
          rtp_ota_cli_07_th_zc_basic_attr_list,
          rtp_ota_cli_07_th_zc_time_attr_list,
          rtp_ota_cli_07_th_zc_ota_upgrade_attr_list);

ZB_HA_DECLARE_OTA_UPGRADE_SERVER_EP(rtp_ota_cli_07_th_zc_ota_upgrade_server_ep, ENDPOINT, rtp_ota_cli_07_th_zc_ota_upgrade_server_clusters);

ZB_HA_DECLARE_OTA_UPGRADE_SERVER_CTX(rtp_ota_cli_07_th_zc_ota_upgrade_server_ctx, rtp_ota_cli_07_th_zc_ota_upgrade_server_ep);
...
MAIN()
{
  ...
  /****************** Register Device ********************************/
  ZB_AF_REGISTER_DEVICE_CTX(&rtp_ota_cli_07_th_zc_ota_upgrade_server_ctx);
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
  ...
  switch(sig)
  {
    ...
    case ZB_ZDO_SIGNAL_DEVICE_ANNCE:
      if (status == 0)
      {
        test_step_register(insert_ota_file, 0, RTP_OTA_CLI_07_STEP_1_TIME_ZC);

        test_control_start(TEST_MODE, RTP_OTA_CLI_07_STEP_1_DELAY_ZC);
      }
...
static void insert_ota_file(zb_uint8_t param)
{
  ...
  else
  {
    ...
    g_time += OTA_UPGRADE_SERVER_TIME_DELTA;
