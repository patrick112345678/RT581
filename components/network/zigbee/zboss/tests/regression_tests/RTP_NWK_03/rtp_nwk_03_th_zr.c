...
#define ZB_TEST_NAME RTP_NWK_03_TH_ZR
#define ZB_TRACE_FILE_ID 40314
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST(rtp_nwk_03_th_zr_basic_attr_list, &attr_zcl_version, &attr_power_source);

/* Identify cluster attributes data */
static zb_uint16_t attr_identify_time = 0;

ZB_ZCL_DECLARE_IDENTIFY_ATTRIB_LIST(rtp_nwk_03_th_zr_identify_attr_list, &attr_identify_time);
...
ZB_ZCL_DECLARE_ON_OFF_ATTRIB_LIST_EXT(rtp_nwk_03_th_zr_on_off_attr_list,
                                      &attr_on_off,
                                      &global_scene_ctrl,
                                      &on_time,
                                      &off_wait_time);
...
/********************* Declare device **************************/
DECLARE_TH_CLUSTER_LIST(rtp_nwk_03_th_zr_device_clusters,
                        rtp_nwk_03_th_zr_basic_attr_list,
                        rtp_nwk_03_th_zr_identify_attr_list,
                        rtp_nwk_03_th_zr_on_off_attr_list);

DECLARE_TH_EP(rtp_nwk_03_th_zr_device_ep,
              THR1_ENDPOINT,
              rtp_nwk_03_th_zr_device_clusters);

DECLARE_TH_CTX(rtp_nwk_03_th_zr_device_ctx, rtp_nwk_03_th_zr_device_ep);
...
MAIN()
{
  ...
  ZB_AF_REGISTER_DEVICE_CTX(&rtp_nwk_03_th_zr_device_ctx);
  ZB_REGRESSION_TESTS_API().disable_extended_nwk_src = ZB_TRUE;
