...
*/
#ifndef __RTP_NWK_03_COMMON_
#define __RTP_NWK_03_COMMON_
...
#define RTP_NWK_03_STEP_1_DELAY_ZED (1 * ZB_TIME_ONE_SECOND)
#define RTP_NWK_03_STEP_1_TIME_ZED  (0)

/* DUT is target, TH is initiator */
#define DUT_ENDPOINT                    143
#define THR1_ENDPOINT                   10

#endif /* __RTP_NWK_03_COMMON_ */
