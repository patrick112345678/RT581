...
#define ZB_TEST_NAME RTP_APS_06_DUT_ZED
#define ZB_TRACE_FILE_ID 40399
...
#define ZB_LONG_POLL_INTERVAL_MS 7000
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST(rtp_aps_06_dut_zed_basic_attr_list, &attr_zcl_version, &attr_power_source);

/********************* Declare device **************************/
DECLARE_DUT_CLUSTER_LIST(rtp_aps_06_dut_zed_device_clusters,
                         rtp_aps_06_dut_zed_basic_attr_list);

DECLARE_DUT_EP(rtp_aps_06_dut_zed_device_ep,
               DUT_ENDPOINT,
               rtp_aps_06_dut_zed_device_clusters);

DECLARE_DUT_CTX(rtp_aps_06_dut_zed_device_ctx, rtp_aps_06_dut_zed_device_ep);
...
static void test_perform_unjoin(zb_uint8_t param);
...
static zb_uint8_t g_bulb_commands_to_send_count;
...
MAIN()
{
    ...
    ZB_SET_TRACE_MASK(TRACE_SUBSYSTEM_APP | TRACE_SUBSYSTEM_APS);
    ...
    ZB_AF_REGISTER_DEVICE_CTX(&rtp_aps_06_dut_zed_device_ctx);
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    case ZB_BDB_SIGNAL_STEERING:
        ...
        if (status == 0)
        {
            ...
            test_step_register(find_light_bulb_delayed, 0, RTP_APS_06_STEP_1_TIME_ZED);
            test_step_register(start_send_commands_with_next_interval, 0, RTP_APS_06_STEP_2_TIME_ZED);

            test_control_start(TEST_MODE, RTP_APS_06_STEP_1_DELAY_ZED);
        }
...
static void light_control_send_on_off(zb_uint8_t param, zb_bool_t on_off)
{
    ...
    ZB_SCHEDULE_CALLBACK(test_perform_unjoin, 0);
}
