...
RTP_BDB_19 - A device will be able to perform commissioning after leaving with active Finding & Binding initiator process

Objective:

    To confirm that it is possible to join to network after leaving with active Finding & Binding initiator process
...
Test procedure:
    ...
    4. Wait for DUT ZED start Finding & Binding initiator procedure
...
Expected outcome:
    ...
    3. DUT ZED starts Finding & Binding initiator procedure and sends Identify Query
       The trace should contain the string "Trigger F&B initiator"
