...
#define ZB_TEST_NAME RTP_APS_09_DUT_ZED
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST(rtp_aps_09_dut_zed_basic_attr_list, &attr_zcl_version, &attr_power_source);

/********************* Declare device **************************/
DECLARE_DUT_CLUSTER_LIST(rtp_aps_09_dut_zed_device_clusters,
                        rtp_aps_09_dut_zed_basic_attr_list);

DECLARE_DUT_EP(rtp_aps_09_dut_zed_device_ep,
              DUT_ENDPOINT,
              rtp_aps_09_dut_zed_device_clusters);

DECLARE_DUT_CTX(rtp_aps_09_dut_zed_device_ctx, rtp_aps_09_dut_zed_device_ep);
...
MAIN()
{
  ...
  ZB_AF_REGISTER_DEVICE_CTX(&rtp_aps_09_dut_zed_device_ctx);
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
  ...
  switch (sig)
  {
    ...
    case ZB_BDB_SIGNAL_STEERING:
      ...
      if (status == 0)
      {
        test_step_register(find_light_bulb_delayed, 0, RTP_APS_09_STEP_1_TIME_ZED);
        test_step_register(light_control_send_on_off_delayed, 0, RTP_APS_09_STEP_2_TIME_ZED);
        test_step_register(light_control_send_on_off_delayed, 0, RTP_APS_09_STEP_3_TIME_ZED);

        test_control_start(TEST_MODE, RTP_APS_09_STEP_1_DELAY_ZED);
      }
