...
/* PURPOSE: TH ZC1
*/
#define ZB_TEST_NAME RTP_SEC_07_TH_ZC1
#define ZB_TRACE_FILE_ID 40458
...
static zb_ieee_addr_t g_ieee_addr_th_zc1 = IEEE_ADDR_TH_ZC1;
...
MAIN()
{
  ...
  zb_set_long_address(g_ieee_addr_th_zc1);
