...
/* PURPOSE: TH ZC2
*/
#define ZB_TEST_NAME RTP_SEC_07_TH_ZC2
#define ZB_TRACE_FILE_ID 40460
...
static zb_ieee_addr_t g_ieee_addr_th_zc2 = IEEE_ADDR_TH_ZC2;
...
MAIN()
{
    ...
    zb_set_long_address(g_ieee_addr_th_zc2);
