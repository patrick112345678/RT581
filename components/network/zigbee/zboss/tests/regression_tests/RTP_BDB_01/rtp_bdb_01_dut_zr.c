...
#define ZB_TEST_NAME RTP_BDB_01_DUT_ZR

#define ZB_TRACE_FILE_ID 40340
#include "zb_common.h"
  ...
  switch (sig)
  {
    case ZB_BDB_SIGNAL_DEVICE_FIRST_START:
      ...
      if (status == 0)
      {
        ...
        test_step_register(test_bdb_reset, 0, RTP_BDB_01_STEP_1_TIME_ZR);
        test_step_register(test_bdb_reset, 0, RTP_BDB_01_STEP_2_TIME_ZR);

        test_control_start(TEST_MODE, RTP_BDB_01_STEP_1_DELAY_ZR);
      }
