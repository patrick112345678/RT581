...
#define ZB_TEST_NAME RTP_APS_12_TH_ZR1

#define ZB_TRACE_FILE_ID 40269
#include "zb_common.h"
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST(rtp_aps_12_th_zr1_basic_attr_list, &attr_zcl_version, &attr_power_source);

/* Identify cluster attributes data */
static zb_uint16_t attr_identify_time = ZB_ZCL_IDENTIFY_IDENTIFY_TIME_DEFAULT_VALUE;

ZB_ZCL_DECLARE_IDENTIFY_ATTRIB_LIST(rtp_aps_12_th_zr1_identify_attr_list, &attr_identify_time);
...
ZB_ZCL_DECLARE_ON_OFF_ATTRIB_LIST_EXT(rtp_aps_12_th_zr1_on_off_attr_list,
                                      &attr_on_off,
                                      &global_scene_ctrl,
                                      &on_time,
                                      &off_wait_time);
...
ZB_ZCL_DECLARE_LEVEL_CONTROL_ATTRIB_LIST(rtp_aps_12_th_zr1_level_control_attr_list,
        &attr_current_level, &attr_remaining_time);

/********************* Declare device **************************/
DECLARE_TH_CLUSTER_LIST(rtp_aps_12_th_zr1_device_clusters,
                        rtp_aps_12_th_zr1_basic_attr_list,
                        rtp_aps_12_th_zr1_identify_attr_list,
                        rtp_aps_12_th_zr1_on_off_attr_list,
                        rtp_aps_12_th_zr1_level_control_attr_list);

DECLARE_TH_EP(rtp_aps_12_th_zr1_device_ep,
              TH_ENDPOINT,
              rtp_aps_12_th_zr1_device_clusters);

DECLARE_TH_CTX(rtp_aps_12_th_zr1_device_ctx, rtp_aps_12_th_zr1_device_ep);
/*************************************************************************/
...
MAIN()
{
    ...
    ZB_AF_REGISTER_DEVICE_CTX(&rtp_aps_12_th_zr1_device_ctx);
