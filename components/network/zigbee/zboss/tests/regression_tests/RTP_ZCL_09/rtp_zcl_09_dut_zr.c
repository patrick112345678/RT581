...
#define ZB_TEST_NAME RTP_ZCL_09_DUT_ZR

#define ZB_TRACE_FILE_ID 40267
#include "zb_common.h"
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST_EXT(rtp_zcl_09_dut_zr_basic_attr_list,
...
ZB_ZCL_DECLARE_IDENTIFY_ATTRIB_LIST(rtp_zcl_09_dut_zr_identify_attr_list, &attr_identify_time);

/********************* Declare device **************************/
DECLARE_DUT_CLUSTER_LIST(rtp_zcl_09_dut_zr_device_clusters,
                         rtp_zcl_09_dut_zr_basic_attr_list,
                         rtp_zcl_09_dut_zr_identify_attr_list);

DECLARE_DUT_EP(rtp_zcl_09_dut_zr_device_ep,
               DUT_ZR_ENDPOINT,
               rtp_zcl_09_dut_zr_device_clusters);

DECLARE_DUT_CTX(rtp_zcl_09_dut_zr_device_ctx, rtp_zcl_09_dut_zr_device_ep);
...
MAIN()
{
  ...
  ZB_AF_REGISTER_DEVICE_CTX(&rtp_zcl_09_dut_zr_device_ctx);
