...
#define ZB_TEST_NAME RTP_ZCL_09_TH_ZR

#define ZB_TRACE_FILE_ID 40268
#include "zb_common.h"
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST(rtp_zcl_09_th_zr_basic_attr_list, &attr_zcl_version, &attr_power_source);

/********************* Declare device **************************/
DECLARE_TH_CLUSTER_LIST(rtp_zcl_09_th_zr_device_clusters,
                        rtp_zcl_09_th_zr_basic_attr_list);

DECLARE_TH_EP(rtp_zcl_09_th_zr_device_ep,
              TH_ZR_ENDPOINT,
              rtp_zcl_09_th_zr_device_clusters);

DECLARE_TH_CTX(rtp_zcl_09_th_zr_device_ctx, rtp_zcl_09_th_zr_device_ep);

static zb_uint16_t g_write_attr_count = 0;
