...
#define ZB_TEST_NAME RTP_INT_02_DUT_ZR

#define ZB_TRACE_FILE_ID 40418
#include "zb_common.h"
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
  ...
  switch (sig)
  {
    case ZB_BDB_SIGNAL_DEVICE_FIRST_START:
      ...
      if (status == 0)
      {
        TRACE_MSG(TRACE_APP1, "OSIF interrupts enable/disable balance %hd", (FMT__D, ZB_REGRESSION_TESTS_API().osif_interrupts_balance));
