...
#ifndef __RTP_OTA_CLI_07_CLIENT_DUT_ZR_
#define __RTP_OTA_CLI_07_CLIENT_DUT_ZR_
...
#define ZB_HA_OTA_UPGRADE_CLIENT_IN_CLUSTER_NUM    2 /**< OTA Upgrade client test input clusters number. */
...
#endif /* __RTP_OTA_CLI_07_CLIENT_DUT_ZR_ */
