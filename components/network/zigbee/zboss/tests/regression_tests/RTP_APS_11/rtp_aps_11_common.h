...
*/
#ifndef __RTP_APS_11_COMMON_
#define __RTP_APS_11_COMMON_
...
#define RTP_APS_11_STEP_1_DELAY_ZED (10 * ZB_TIME_ONE_SECOND)
#define RTP_APS_11_STEP_1_TIME_ZED  (60 * ZB_TIME_ONE_SECOND)

/* DUT is target, TH is initiator */
#define DUT_ENDPOINT               143
#define TH_ENDPOINT                10

#define BOUND_BULBS_COUNT 2

#define TEST_DELAY_AFTER_BIND (7 * ZB_TIME_ONE_SECOND)
#define TEST_DELAY_AFTER_REJOIN (5 * ZB_TIME_ONE_SECOND)

#endif /* __RTP_APS_11_COMMON_ */
