...
/* PURPOSE: TH ZR
*/
#define ZB_TEST_NAME RTP_NVRAM_01_TH_ZR
#define ZB_TRACE_FILE_ID 40281
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    case ZB_BDB_SIGNAL_DEVICE_FIRST_START:
        ...
        if (status == 0)
        {
            ...
            test_step_register(test_send_buffer_test_request_delayed, 0, RTP_NVRAM_01_STEP_1_TIME_ZR);

            test_control_start(TEST_MODE, RTP_NVRAM_01_STEP_1_DELAY_ZR);
        }
