...
RTP_HA_06 - ZCL Version attribute of Basic Cluster

Objective:

	To confirm that the read attribute handler correctly handles ZCL Version attribute for basic cluster if IAS_ANCILLARY_CONTROL_EQUIPMENT_CLUSTER_LIST is used.
