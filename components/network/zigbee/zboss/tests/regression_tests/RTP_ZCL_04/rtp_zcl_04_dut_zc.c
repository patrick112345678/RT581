...
#define ZB_TEST_NAME RTP_ZCL_04_DUT_ZC

#define ZB_TRACE_FILE_ID 40467
#include "zb_common.h"
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST(rtp_zcl_04_dut_zc_basic_attr_list, &attr_zcl_version, &attr_power_source);

/* Identify cluster attributes data */
static zb_uint16_t attr_identify_time = ZB_ZCL_IDENTIFY_IDENTIFY_TIME_DEFAULT_VALUE;

ZB_ZCL_DECLARE_IDENTIFY_ATTRIB_LIST(rtp_zcl_04_dut_zc_identify_attr_list, &attr_identify_time);


/********************* Declare device **************************/
DECLARE_DUT_CLUSTER_LIST(rtp_zcl_04_dut_zc_device_clusters,
                         rtp_zcl_04_dut_zc_basic_attr_list,
                         rtp_zcl_04_dut_zc_identify_attr_list);

DECLARE_DUT_EP(rtp_zcl_04_dut_zc_device_ep,
               DUT_ENDPOINT,
               rtp_zcl_04_dut_zc_device_clusters);

DECLARE_DUT_CTX(rtp_zcl_04_dut_zc_device_ctx, rtp_zcl_04_dut_zc_device_ep);
/*************************************************************************/
...
MAIN()
{
  ...
  ZB_AF_REGISTER_DEVICE_CTX(&rtp_zcl_04_dut_zc_device_ctx);
