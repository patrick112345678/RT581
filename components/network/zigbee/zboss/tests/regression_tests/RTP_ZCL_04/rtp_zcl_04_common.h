...
*/
#ifndef __RTP_ZCL_04_COMMON_
#define __RTP_ZCL_04_COMMON_
...
#define RTP_ZCL_04_STEP_1_DELAY_ZR (1 * ZB_TIME_ONE_SECOND)
#define RTP_ZCL_04_STEP_1_TIME_ZR  (5 * ZB_TIME_ONE_SECOND)
