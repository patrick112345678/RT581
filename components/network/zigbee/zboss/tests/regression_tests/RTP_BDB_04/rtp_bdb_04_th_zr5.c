...
#define ZB_TEST_NAME RTP_BDB_04_TH_ZR5

#define ZB_TRACE_FILE_ID 40423
#include "zb_common.h"
...
static zb_ieee_addr_t g_ieee_addr_th_zr5 = IEEE_ADDR_TH_ZR5;
...
MAIN()
{
    ...
    zb_set_long_address(g_ieee_addr_th_zr5);
