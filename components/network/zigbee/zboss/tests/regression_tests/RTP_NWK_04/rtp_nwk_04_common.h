...
*/
#ifndef __RTP_NWK_04_COMMON_
#define __RTP_NWK_04_COMMON_
...
#define THR1_FB_DURATION           (30)

#define RTP_NWK_04_STEP_1_DELAY_ZED (195 * ZB_TIME_ONE_SECOND)
#define RTP_NWK_04_STEP_1_TIME_ZED  (5)

/* DUT is target, TH is initiator */
#define DUT_ENDPOINT                    143
#define THR1_ENDPOINT                   10

#endif /* __RTP_NWK_04_COMMON_ */
