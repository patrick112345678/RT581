...
*/
#ifndef __RTP_ZCL_05_COMMON_
#define __RTP_ZCL_05_COMMON_
...
#define TH_FB_INITIATOR_DELAY     (7 * ZB_TIME_ONE_SECOND)
#define DUT_FB_INITIATOR_DELAY     (7 * ZB_TIME_ONE_SECOND)
