...
*/
#ifndef __RTP_ZDO_01_COMMON_
#define __RTP_ZDO_01_COMMON_
...
#define RTP_ZDO_01_STEP_1_DELAY_ZR (1 * ZB_TIME_ONE_SECOND)
#define RTP_ZDO_01_STEP_1_TIME_ZR  (3 * ZB_TIME_ONE_SECOND)
#define RTP_ZDO_01_STEP_2_TIME_ZR  (3 * ZB_TIME_ONE_SECOND)

/* DUT is target, TH is initiator */
#define DUT_ENDPOINT                    143
#define THR1_ENDPOINT                   10

#endif /* __RTP_ZDO_01_COMMON_ */
