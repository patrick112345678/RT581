...
#define ZB_TEST_NAME RTP_BDB_07_DUT_ZR

#define ZB_TRACE_FILE_ID 40450
#include "zb_common.h"
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    case ZB_NWK_SIGNAL_NO_ACTIVE_LINKS_LEFT:
        TRACE_MSG(TRACE_APP1, "signal: ZB_NWK_SIGNAL_NO_ACTIVE_LINKS_LEFT, status %d", (FMT__D, status));
