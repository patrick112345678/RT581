...
#ifndef __RTP_OTA_SRV_04_COMMON_
#define __RTP_OTA_SRV_04_COMMON_
...
#define RTP_OTA_SRV_04_STEP_1_DELAY_ZC (7 * ZB_TIME_ONE_SECOND)
#define RTP_OTA_SRV_04_STEP_1_TIME_ZC  (1  * ZB_TIME_ONE_SECOND)

#endif /* __RTP_OTA_SRV_04_COMMON_ */
