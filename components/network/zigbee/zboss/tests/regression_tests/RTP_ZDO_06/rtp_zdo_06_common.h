...
*/
#ifndef __RTP_ZDO_06_COMMON_
#define __RTP_ZDO_06_COMMON_
...
#define RTP_ZDO_06_STEP_1_DELAY_ZC (4 * ZB_TIME_ONE_SECOND)
#define RTP_ZDO_06_STEP_1_TIME_ZC  (15 * ZB_TIME_ONE_SECOND)
#define RTP_ZDO_06_STEP_2_TIME_ZC  (10 * ZB_TIME_ONE_SECOND)

/* DUT is target, TH is initiator */
#define DUT_ENDPOINT                    143
#define THR1_ENDPOINT                   10

#endif /* __RTP_ZDO_06_COMMON_ */
