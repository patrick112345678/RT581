...
#define ZB_TEST_NAME RTP_ZCL_12_TH_ZC

#define ZB_TRACE_FILE_ID 40430
#include "zb_common.h"
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST(rtp_zcl_12_th_zc_basic_attr_list, &attr_zcl_version, &attr_power_source);

/********************* Declare device **************************/
DECLARE_TH_CLUSTER_LIST(rtp_zcl_12_th_zc_device_clusters,
                         rtp_zcl_12_th_zc_basic_attr_list);

DECLARE_TH_EP(rtp_zcl_12_th_zc_device_ep,
               TH_ENDPOINT,
               rtp_zcl_12_th_zc_device_clusters);

DECLARE_TH_CTX(rtp_zcl_12_th_zc_device_ctx, rtp_zcl_12_th_zc_device_ep);
/*************************************************************************/
...
static zb_uint8_t g_transition_time = 0;
...
MAIN()
{
  ...
  ZB_AF_REGISTER_DEVICE_CTX(&rtp_zcl_12_th_zc_device_ctx);
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
  ...
  switch (sig)
  {
    ...
    case ZB_BDB_SIGNAL_FINDING_AND_BINDING_INITIATOR_FINISHED:
      ...
      if (status == 0)
      {
        test_step_register(send_add_group_req_delayed, 0, RTP_ZCL_12_STEP_1_TIME_ZC);
        test_step_register(send_move_to_hue_saturation_req_delayed, 0, RTP_ZCL_12_STEP_2_TIME_ZC);
        test_step_register(send_toggle_on_off_req_delayed, 0, RTP_ZCL_12_STEP_3_TIME_ZC);

        test_control_start(TEST_MODE, RTP_ZCL_12_STEP_1_DELAY_ZC);
      }
