...
#define ZB_TEST_NAME RTP_ZCL_07_TH_ZC

#define ZB_TRACE_FILE_ID 40264
#include "zb_common.h"
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST(rtp_zcl_07_th_zc_basic_attr_list, &attr_zcl_version, &attr_power_source);
