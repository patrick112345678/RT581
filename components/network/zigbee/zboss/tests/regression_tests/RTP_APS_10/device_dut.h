...
#define DUT_IN_CLUSTER_NUM 1 /*!< IN (server) clusters number */
...
#define TEST_CUSTOM_CLUSTER_SEND_TEST_PAYLOAD_REQ(                      \
...
{                                                                       \
  ...
  ZB_ZCL_CONSTRUCT_COMMAND_HEADER_REQ(                                  \
    ptr, ZB_ZCL_GET_SEQ_NUM(), TEST_CUSTOM_CLUSTER_TEST_PAYLOAD_CMD_ID);\
  ZB_ZCL_PACKET_PUT_DATA_N(ptr, (data), (data_len));                    \
  ZB_ZCL_FINISH_PACKET((buffer), ptr)                                   \
  ZB_ZCL_SEND_COMMAND_SHORT(                                            \
    (buffer), (dst_addr), (dst_addr_mode), (dst_ep), (src_ep),          \
    profile, ZB_ZCL_CLUSTER_ID_CUSTOM, (cb));                           \
}
