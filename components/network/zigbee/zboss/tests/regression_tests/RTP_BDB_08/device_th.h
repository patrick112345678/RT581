...
#define TH_DEVICE_OUT_CLUSTER_NUM 1 /*!<  OUT (client) clusters number */
...
#define DECLARE_TH_CTX(device_ctx, ep1_name) ZBOSS_DECLARE_DEVICE_CTX_1_EP(device_ctx, ep1_name)
