...
#ifndef __RTP_PRODCONF_CORNER_01_
#define __RTP_PRODCONF_CORNER_01_

#define IEEE_ADDR_TH_ZC {0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa}
#define IEEE_ADDR_DUT_ZED {0xee, 0xff, 0xc0, 0x50, 0xef, 0xbe, 0xfe, 0xca}

#define RTP_PRODCONF_CORNER_01_STEP_1_TIME_ZED  (ZB_TIME_ONE_SECOND)
#define RTP_PRODCONF_CORNER_01_STEP_1_DELAY_ZED (ZB_TIME_ONE_SECOND)
...
#endif /* __RTP_PRODCONF_CORNER_01_ */
