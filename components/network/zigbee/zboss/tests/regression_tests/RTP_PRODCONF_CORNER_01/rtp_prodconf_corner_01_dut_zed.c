...
#define ZB_TEST_NAME RTP_PRODCONF_CORNER_01_DUT_ZED

#define ZB_TRACE_FILE_ID 40393
#include "zb_common.h"
...
#include "rtp_prodconf_corner_01_common.h"
...
#define MANUFACTURER_NAME "The_Manufacture"
#define MODEL_ID          "Pretty_ID_16cha"
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    {
        test_step_register(test_production_config_read_correct, param, RTP_PRODCONF_CORNER_01_STEP_1_TIME_ZED);

        test_control_start(TEST_MODE, RTP_PRODCONF_CORNER_01_STEP_1_DELAY_ZED);
    }
    break;
