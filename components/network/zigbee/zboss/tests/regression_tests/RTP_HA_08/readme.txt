...
RTP_HA_08 - ZCL Version attribute of Basic Cluster

Objective:

	To confirm that the read attribute handler correctly handles ZCL Version attribute for basic cluster if ON_OFF_SWITCH_CLUSTER_LIST is used.
