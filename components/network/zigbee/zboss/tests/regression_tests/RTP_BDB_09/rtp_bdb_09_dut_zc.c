...
#define ZB_TEST_NAME RTP_BDB_09_DUT_ZC

#define ZB_TRACE_FILE_ID 40485
#include "zb_common.h"
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST(rtp_bdb_09_dut_zc_basic_attr_list, &attr_zcl_version, &attr_power_source);

/********************* Declare device **************************/
DECLARE_DUT_CLUSTER_LIST(rtp_bdb_09_dut_zc_device_clusters,
                         rtp_bdb_09_dut_zc_basic_attr_list);

DECLARE_DUT_EP(rtp_bdb_09_dut_zc_device_ep,
               DUT_ENDPOINT,
               rtp_bdb_09_dut_zc_device_clusters);

DECLARE_DUT_CTX(rtp_bdb_09_dut_zc_device_ctx, rtp_bdb_09_dut_zc_device_ep);
/*************************************************************************/
...
MAIN()
{
    ...
    ZB_AF_REGISTER_DEVICE_CTX(&rtp_bdb_09_dut_zc_device_ctx);
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    case ZB_ZDO_SIGNAL_DEVICE_ANNCE:
        ...
        if (status == 0)
        {
            test_step_register(trigger_fb_initiator, 0, RTP_BDB_09_STEP_1_TIME_ZC);

            test_control_start(TEST_MODE, RTP_BDB_09_STEP_1_DELAY_ZC);
        }
