...
#define ZB_TEST_NAME RTP_OTA_CLI_05_DUT_ZR
#define ZB_TRACE_FILE_ID 40479
...
#include "rtp_ota_cli_05_dut_zr.h"
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST(rtp_ota_cli_05_dut_zr_basic_attr_list, &g_attr_zcl_version, &g_attr_power_source);
...
ZB_ZCL_DECLARE_OTA_UPGRADE_ATTRIB_LIST(rtp_ota_cli_05_dut_zr_ota_upgrade_attr_list,
    ...
    &server_addr, &server_ep, OTA_UPGRADE_TEST_CLIENT_HW_VERSION, OTA_UPGRADE_TEST_DATA_SIZE, ZB_ZCL_OTA_UPGRADE_QUERY_TIMER_COUNT_DEF);

/********************* Declare device **************************/

ZB_HA_DECLARE_OTA_UPGRADE_CLIENT_CLUSTER_LIST(rtp_ota_cli_05_dut_zr_ota_upgrade_client_clusters,
          rtp_ota_cli_05_dut_zr_basic_attr_list, rtp_ota_cli_05_dut_zr_ota_upgrade_attr_list);

ZB_HA_DECLARE_OTA_UPGRADE_CLIENT_EP(rtp_ota_cli_05_dut_zr_ota_upgrade_client_ep, TEST_ENDPOINT_DUT, rtp_ota_cli_05_dut_zr_ota_upgrade_client_clusters);

ZB_HA_DECLARE_OTA_UPGRADE_CLIENT_CTX(rtp_ota_cli_05_dut_zr_ota_upgrade_client_ctx, rtp_ota_cli_05_dut_zr_ota_upgrade_client_ep);
...
MAIN()
{
  ...
  /****************** Register Device ********************************/
  ZB_AF_REGISTER_DEVICE_CTX(&rtp_ota_cli_05_dut_zr_ota_upgrade_client_ctx);
