...
#define ZB_TEST_NAME RTP_OTA_CLI_06_DUT_ZR
#define ZB_TRACE_FILE_ID 40299
...
#include "rtp_ota_cli_06_dut_zr.h"
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST(rtp_ota_cli_06_dut_zr_basic_attr_list, &g_attr_zcl_version, &g_attr_power_source);
...
ZB_ZCL_DECLARE_OTA_UPGRADE_ATTRIB_LIST(rtp_ota_cli_06_dut_zr_ota_upgrade_attr_list,
...
ZB_HA_DECLARE_OTA_UPGRADE_CLIENT_CLUSTER_LIST(rtp_ota_cli_06_dut_zr_ota_upgrade_client_clusters,
          rtp_ota_cli_06_dut_zr_basic_attr_list, rtp_ota_cli_06_dut_zr_ota_upgrade_attr_list);

ZB_HA_DECLARE_OTA_UPGRADE_CLIENT_EP(rtp_ota_cli_06_dut_zr_ota_upgrade_client_ep, ENDPOINT, rtp_ota_cli_06_dut_zr_ota_upgrade_client_clusters);

ZB_HA_DECLARE_OTA_UPGRADE_CLIENT_CTX(rtp_ota_cli_06_dut_zr_ota_upgrade_client_ctx, rtp_ota_cli_06_dut_zr_ota_upgrade_client_ep);
...
MAIN()
{
  ...
  /****************** Register Device ********************************/
  ZB_AF_REGISTER_DEVICE_CTX(&rtp_ota_cli_06_dut_zr_ota_upgrade_client_ctx);
    ...
    case ZB_ZCL_OTA_UPGRADE_VALUE_CB_ID:
    {
      ...
      switch (ota_upgrade_value->upgrade_status)
      {
        ...
        case ZB_ZCL_OTA_UPGRADE_STATUS_APPLY:
          ...
          ZB_SCHEDULE_ALARM(test_device_upgrade_status, 0, (OTA_UPGRADE_TEST_UPGRADE_TIME_DELTA - 1) * ZB_TIME_ONE_SECOND);
          ZB_SCHEDULE_ALARM(test_device_upgrade_status, 0, (OTA_UPGRADE_TEST_UPGRADE_TIME_DELTA + 1) * ZB_TIME_ONE_SECOND);
