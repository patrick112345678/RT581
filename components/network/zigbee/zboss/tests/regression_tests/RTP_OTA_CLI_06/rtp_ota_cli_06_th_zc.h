...
#ifndef __RTP_OTA_CLI_06_SERVER_TH_ZC_
#define __RTP_OTA_CLI_06_SERVER_TH_ZC_
...
#define ZB_HA_OTA_UPGRADE_SERVER_IN_CLUSTER_NUM    3 /**< OTA Upgrade server test input clusters number. */
 ...
 *  @param time_attr_list [IN] - attribute list for Time cluster.
 *  @param ota_upgrade_attr_list [IN] - attribute list for OTA Upgrade server cluster.
 */
...
/************************* Sample OTA File, see test spec 9.1.4.3 *****************/
...
#endif /* __RTP_OTA_CLI_06_SERVER_TH_ZC_ */
