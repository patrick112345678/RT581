...
#define ZB_TEST_NAME RTP_ZCL_02_DUT_ZC

#define ZB_TRACE_FILE_ID 40464
#include "zb_common.h"
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST(rtp_zcl_02_dut_zc_basic_attr_list, &attr_zcl_version, &attr_power_source);
...
ZB_ZCL_DECLARE_ON_OFF_ATTRIB_LIST_EXT(rtp_zcl_02_dut_zc_on_off_attr_list,
                                      &attr_on_off,
                                      &global_scene_ctrl,
                                      &on_time,
                                      &off_wait_time);
...
/********************* Declare device **************************/
DECLARE_DUT_CLUSTER_LIST(rtp_zcl_02_dut_zc_device_clusters,
                         rtp_zcl_02_dut_zc_basic_attr_list,
                         rtp_zcl_02_dut_zc_on_off_attr_list);

DECLARE_DUT_EP(rtp_zcl_02_dut_zc_device_ep,
               DUT_ENDPOINT,
               rtp_zcl_02_dut_zc_device_clusters);

DECLARE_DUT_CTX(rtp_zcl_02_dut_zc_device_ctx, rtp_zcl_02_dut_zc_device_ep);
/*************************************************************************/
...
static zb_ret_t test_check_value_on_off_srv(zb_uint16_t attr_id, zb_uint8_t endpoint, zb_uint8_t *value);
static void test_attr_hook_on_off_srv(zb_uint8_t endpoint, zb_uint16_t attr_id, zb_uint8_t *new_value);

static zb_ret_t test_check_value_on_off_cli(zb_uint16_t attr_id, zb_uint8_t endpoint, zb_uint8_t *value);
