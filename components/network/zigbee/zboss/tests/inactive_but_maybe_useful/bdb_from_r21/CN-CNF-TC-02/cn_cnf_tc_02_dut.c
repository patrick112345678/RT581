...
#define ZB_TEST_NAME CN_CNF_TC_02_DUT
#define ZB_TRACE_FILE_ID 41140
#include "zb_common.h"
...
static void trigger_formation_on_network(zb_uint8_t param);
  ...
  if (ZB_GET_APP_SIGNAL_STATUS(param) == 0)
  {
    switch(sig)
    {
      case ZB_BDB_SIGNAL_DEVICE_FIRST_START:
        ...
        ZB_SCHEDULE_ALARM(trigger_formation_on_network, 0,
                          TEST_DUT_TRIGGERS_FORMATION_DELAY);
        break;
      default:
