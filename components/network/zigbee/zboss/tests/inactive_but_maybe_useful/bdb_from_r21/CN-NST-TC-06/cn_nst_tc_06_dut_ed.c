...
#define ZB_TEST_NAME CN_NST_TC_06_DUT_ED
#define ZB_TRACE_FILE_ID 41208
#include "zb_common.h"
...
MAIN()
{
    ...
    ZB_IEEE_ADDR_COPY(ZB_PIBCACHE_EXTENDED_ADDRESS(), &g_ieee_addr_dut_ed);
