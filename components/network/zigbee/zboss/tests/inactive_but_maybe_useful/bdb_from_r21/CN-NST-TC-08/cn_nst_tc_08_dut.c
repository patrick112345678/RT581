...
#define ZB_TEST_NAME CN_NST_TC_08_DUT
#define ZB_TRACE_FILE_ID 41078
#include "zb_common.h"
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    {
        TRACE_MSG(TRACE_APS1, "Device STARTED OK - strange situation for this test", (FMT__0));
    }
