 ...
 * DSR.
 */
/* PURPOSE: DUT ZED (joining to networks - looping behavior)
*/


#define ZB_TEST_NAME CN_NSA_TC_02_DUT_ED
#define ZB_TRACE_FILE_ID 41113
#include "zb_common.h"
...
MAIN()
{
  ...
  ZB_BDB().bdb_primary_channel_set = TEST_BDB_DUT_PRIMARY_CHANNEL_SET;
  ZB_BDB().bdb_secondary_channel_set = TEST_BDB_DUT_SECONDARY_CHANNEL_SET;
  ZB_BDB().bdb_mode = 1;
