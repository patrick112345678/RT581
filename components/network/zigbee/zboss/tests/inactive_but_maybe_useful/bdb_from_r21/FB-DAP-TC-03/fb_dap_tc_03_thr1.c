...
#define ZB_TEST_NAME FB_DAP_TC_03_THZR1
#define ZB_TRACE_FILE_ID 41045
#include "zb_common.h"
...
#define TH1_ENDPOINT 4
#define HA_DOOR_LOCK_ENDPOINT TH1_ENDPOINT
  ...
  if (ZB_GET_APP_SIGNAL_STATUS(param) == 0)
  {
    switch(sig)
    {
      ...
      case ZB_BDB_SIGNAL_STEERING:
        ...
        zb_bdb_finding_binding_target(TH1_ENDPOINT);
        break;
