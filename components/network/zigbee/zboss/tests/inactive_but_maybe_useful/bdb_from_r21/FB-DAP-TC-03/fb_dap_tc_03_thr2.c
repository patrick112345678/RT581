...
#define ZB_TEST_NAME FB_DAP_TC_03_THZR2
#define ZB_TRACE_FILE_ID 41046
#include "zb_common.h"
...
#define TH2_ENDPOINT 5
#define HA_DOOR_LOCK_ENDPOINT TH2_ENDPOINT
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    if (ZB_GET_APP_SIGNAL_STATUS(param) == 0)
    {
        ...
        case ZB_BDB_SIGNAL_STEERING:
            ...
            zb_bdb_finding_binding_target(TH2_ENDPOINT);
            break;
