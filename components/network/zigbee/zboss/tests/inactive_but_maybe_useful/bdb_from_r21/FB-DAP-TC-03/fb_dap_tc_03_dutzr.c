...
#define ZB_TEST_NAME FB_DAP_TC_03_DUTZR
#define ZB_TRACE_FILE_ID 41047
#include "zb_common.h"
...
#define HA_DOOR_LOCK_CONTROLLER_ENDPOINT DUT_ENDPOINT
                ...
                case ZB_ZCL_CMD_GROUPS_ADD_GROUP_RES:
                {
                    ...
                    else
                    {
                        ...
                        ZB_ZCL_GROUPS_SEND_GET_GROUP_MEMBERSHIP_REQ(zcl_cmd_buf, cmd_ptr, dest_addr, ZB_APS_ADDR_MODE_16_ENDP_PRESENT, dest_endpoint,
                                DUT_ENDPOINT, ZB_AF_HA_PROFILE_ID, NULL);
                    }
    ...
    if (ZB_GET_APP_SIGNAL_STATUS(param) == 0)
    {
        ...
        case ZB_BDB_SIGNAL_FINDING_AND_BINDING_INITIATOR_FINISHED:
            TRACE_MSG(TRACE_APS1, "Successfull F&B", (FMT__0));
            {
                zb_uint8_t *cmd_ptr;
                \
                ZB_ZCL_GENERAL_INIT_READ_ATTR_REQ(ZB_BUF_FROM_REF(param), cmd_ptr, ZB_ZCL_ENABLE_DEFAULT_RESPONSE);
                ZB_ZCL_GENERAL_ADD_ID_READ_ATTR_REQ(cmd_ptr, ZB_ZCL_ATTR_DOOR_LOCK_LOCK_STATE_ID);
                ZB_ZCL_GENERAL_SEND_READ_ATTR_REQ(ZB_BUF_FROM_REF(param),
                                                  cmd_ptr,
