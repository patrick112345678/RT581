...
#define ZB_TEST_NAME CN_NFS_TC_01_DUT
#define ZB_TRACE_FILE_ID 40971
#include "zb_common.h"
...
static void trigger_network_steering(zb_uint8_t param);
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    if (ZB_GET_APP_SIGNAL_STATUS(param) == 0)
    {
        ...
        case ZB_BDB_SIGNAL_DEVICE_FIRST_START:
            ...
            ZB_SCHEDULE_ALARM(trigger_network_steering, 0,
