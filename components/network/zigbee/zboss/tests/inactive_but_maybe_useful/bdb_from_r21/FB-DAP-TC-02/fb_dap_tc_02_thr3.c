...
#define ZB_TEST_NAME FB_DAP_TC_02_THZR3
#define ZB_TRACE_FILE_ID 41044
#include "zb_common.h"
...
static zb_ieee_addr_t g_ieee_addr = {0x03, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00};
...
static void fb_initiation(zb_uint8_t param)
{
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    if (ZB_GET_APP_SIGNAL_STATUS(param) == 0)
    {
        ...
        case ZB_BDB_SIGNAL_STEERING:
            ...
            ZB_SCHEDULE_ALARM(fb_initiation, 0, ZB_MILLISECONDS_TO_BEACON_INTERVAL(10));
            break;
