...
/* PURPOSE:
*/
#ifndef __DR_TAR_TC_04A_
#define __DR_TAR_TC_04A_
...
static zb_ieee_addr_t g_ieee_addr_thr2 = {0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc};
...
#define THR1_MUTE_THC1_PACKETS_DELAY  (30 * ZB_TIME_ONE_SECOND)
#define THR2_START_TEST_DELAY         (20 * ZB_TIME_ONE_SECOND)
...
#define DUT_LEAVES_NETWORK_DELAY      (75 * ZB_TIME_ONE_SECOND)
