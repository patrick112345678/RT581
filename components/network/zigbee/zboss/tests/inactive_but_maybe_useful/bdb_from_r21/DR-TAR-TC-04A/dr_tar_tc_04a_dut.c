...
#define ZB_TEST_NAME DR_TAR_TC_04A_DUT
#define ZB_TRACE_FILE_ID 41167
#include "zb_common.h"
...
#include "dr_tar_tc_04a_common.h"
...
static void trigger_local_leave_delayed(zb_uint8_t unused);
static void trigger_local_leave(zb_uint8_t param);
...
MAIN()
{
    ...
    //zb_zdo_register_leave_cb(dut_leave_cb);
...
{
    ZVUNUSED(unused);
    ZB_GET_OUT_BUF_DELAYED(trigger_local_leave);
}
...
static void trigger_local_leave(zb_uint8_t param)
{
    ...
    TRACE_MSG(TRACE_ZDO1, ">>trigger_local_leave: buf_param = %d", (FMT__D, param));
    ...
    TRACE_MSG(TRACE_ZDO1, "<<trigger_local_leave", (FMT__0));
}
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    if (ZB_GET_APP_SIGNAL_STATUS(param) == 0)
    {
        ...
        case ZB_BDB_SIGNAL_DEVICE_FIRST_START:
            ...
            ZB_SCHEDULE_ALARM(trigger_local_leave_delayed, 0, DUT_LEAVES_NETWORK_DELAY);
            break;
