...
#define ZB_TEST_NAME DR_TAR_TC_04A_THR1
#define ZB_TRACE_FILE_ID 41168
#include "zb_common.h"
...
static void mute_thzc_packets(zb_uint8_t unused);
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    if (ZB_GET_APP_SIGNAL_STATUS(param) == 0)
    {
        ...
        case ZB_BDB_SIGNAL_DEVICE_FIRST_START:
            ...
            ZB_SCHEDULE_ALARM(mute_thzc_packets, 0, THR1_MUTE_THC1_PACKETS_DELAY);
            break;
        ...
        case ZB_BDB_SIGNAL_FINDING_AND_BINDING_TARGET_FINISHED:
            ...
            {
                ZB_SCHEDULE_ALARM(trigger_rejoin_delayed, 0, THR1_REJOIN_TO_NETWORK_DELAY);
            }
            break;
