...
/* PURPOSE:
*/
#ifndef __CN_NST_TC_04_
#define __CN_NST_TC_04_
...
zb_ieee_addr_t g_ieee_addr_dut_ed  = {0x01, 0x00, 0x00, 0x00, 0x00, 0xaa, 0xaa, 0xaa};
zb_ieee_addr_t g_ieee_addr_dut_r   = {0x02, 0x00, 0x00, 0x00, 0x02, 0xaa, 0xaa, 0xaa};
