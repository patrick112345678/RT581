...
#define ZB_TEST_NAME CN_NSA_TC_01C_DUT_C
#define ZB_TRACE_FILE_ID 41123
#include "zb_common.h"
...
static void close_network_delayed(zb_uint8_t param);
...
MAIN()
{
  ...
  ZB_TCPOL().allow_remote_policy_change = ZB_TRUE; /* accept remote MgmtPermitJoin req */
  ...
  if (ZB_GET_APP_SIGNAL_STATUS(param) == 0)
  {
    switch(sig)
    {
      case ZB_BDB_SIGNAL_DEVICE_FIRST_START:
        ...
        ZB_SCHEDULE_ALARM(close_network_delayed, 0, TEST_CLOSE_NETWORK_DELAY);
        break;
      default:
