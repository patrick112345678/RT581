...
#define ZB_TEST_NAME FB_INI_TC_05_DUT_ED
#define ZB_TRACE_FILE_ID 41181
#include "zb_common.h"
...
MAIN()
{
    ...
    ZB_BDB().bdb_mode = 1;
    ZB_BDB().bdb_commissioning_mode = 0;
...
{
    ZVUNUSED(unused);
    if (BDB_COMM_CTX().ep == DUT_ENDPOINT)
    {
        TRACE_MSG(TRACE_ERROR, "TEST ERROR: target f&b is running", (FMT__0));
