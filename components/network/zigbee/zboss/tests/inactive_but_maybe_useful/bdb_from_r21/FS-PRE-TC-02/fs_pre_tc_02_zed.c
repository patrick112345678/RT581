...
#define ZB_TEST_NAME FS_PRE_TC_02_ZED1
#define ZB_TRACE_FILE_ID 40988
#include "zb_common.h"
...
MAIN()
{
    ...
    ZB_BDB().bdb_primary_channel_set = (1 << 21) | (1 << 22);
    ZB_BDB().bdb_secondary_channel_set = (1 << 13) | (1 << 13) | (1 << 14);
    ZB_BDB().bdb_mode = 1;
