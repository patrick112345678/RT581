...
/* PURPOSE:
*/
#ifndef __CN_CNF_TC_03_
#define __CN_CNF_TC_03_
...
#define TEST_CLOSE_NETWORK_DELAY (20 * ZB_TIME_ONE_SECOND)
#define TEST_DUT_NETWORK_FORMATION_DELAY (40 * ZB_TIME_ONE_SECOND)

#endif /* __CN_CNF_TC_03_ */
