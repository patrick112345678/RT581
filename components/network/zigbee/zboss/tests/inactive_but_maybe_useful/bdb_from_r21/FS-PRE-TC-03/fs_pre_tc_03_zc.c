...
#define ZB_TEST_NAME FS_PRE_TC_03_ZC
#define ZB_TRACE_FILE_ID 41220
#include "zb_common.h"
...
MAIN()
{
  ...
  ZB_BDB().bdb_primary_channel_set = (1 << 11) | (1 << 13);
//  unclmment next line to test successful join to ZC
