 ...
 * DSR.
 */
/* PURPOSE: DUT ZED (joining to centralized nad distributed networks)
*/


#define ZB_TEST_NAME CN_NSA_TC_04_DUT_ED
#define ZB_TRACE_FILE_ID 41242
#include "zb_common.h"
