...
*/
#ifndef __CS_ICK_TC_03_
#define __CS_ICK_TC_03_
...
zb_uint8_t g_ic2[16+2] = {0xE8, 0x77, 0xD4, 0x40, 0x7A, 0x93, 0x97, 0x23,
...
/* Delay between device annce fron dut and removing dut from neighbors */
#define THC1_REMOVE_DUT_DELAY (15 * ZB_TIME_ONE_SECOND)
/* Define between transporting link key and reverting kypir set */
#define THC1_REVERT_KEY_DELAY (1 * ZB_TIME_ONE_SECOND)


#endif /* __CS_ICK_TC_03_ */
