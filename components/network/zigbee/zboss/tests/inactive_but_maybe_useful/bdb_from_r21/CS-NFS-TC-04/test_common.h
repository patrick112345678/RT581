...
*/
#ifndef __CS_NFS_TC_04_
#define __CS_NFS_TC_04_
...
#define THRX_SEND_COMMAND_SKEW  (6 * ZB_TIME_ONE_SECOND)
#define MIN_COMMISSIONINIG_TIME_DELAY (180 * ZB_TIME_ONE_SECOND)

/* Increase if needed */
#define MAX_RETRY_JOIN_ATTEMPTS 50
/* Change if needed */
#define DO_RETRY_JOIN_DELAY (ZB_MILLISECONDS_TO_BEACON_INTERVAL(500))

#endif /* __CS_NFS_TC_04_ */
