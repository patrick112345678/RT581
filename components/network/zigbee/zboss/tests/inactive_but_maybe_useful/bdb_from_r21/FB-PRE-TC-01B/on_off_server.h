...
/*!
  @brief Declare simple descriptor for On/Off Server
  @param ep_name - endpoint variable name
  @param ep_id - endpoint ID
  @param in_clust_num - number of supported input clusters
  @param out_clust_num - number of supported output clusters
*/
#define DECLARE_ON_OFF_SERVER_SIMPLE_DESC(ep_name, ep_id, in_clust_num, out_clust_num) \
...
/*!
  @brief Declare endpoint for On/Off server
  @param ep_name - endpoint variable name
  @param ep_id - endpoint ID
...
#define DECLARE_ON_OFF_SERVER_EP(ep_name, ep_id, cluster_list)              \
  DECLARE_ON_OFF_SERVER_SIMPLE_DESC(                                        \
    ep_name,                                                                \
    ep_id,                                                                  \
    ON_OFF_SERVER_IN_CLUSTER_NUM,                                           \
    ON_OFF_SERVER_OUT_CLUSTER_NUM);                                         \
...
#define DECLARE_ON_OFF_SERVER_CTX(device_ctx, ep_name)                      \
