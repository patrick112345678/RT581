...
#define ZB_TEST_NAME DN_DNF_TC_03_DUTZR
#define ZB_TRACE_FILE_ID 41163
#include "zb_common.h"
...
static void trigger_formation(zb_uint8_t param)
{
    (void)param;
    TRACE_MSG(TRACE_ZCL1, "Starting second formation", (FMT__0));
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    if (ZB_GET_APP_SIGNAL_STATUS(param) == 0)
    {
        ...
        case ZB_BDB_SIGNAL_DEVICE_FIRST_START:
            ...
            ZB_SCHEDULE_ALARM(trigger_formation, 0, 220 * ZB_TIME_ONE_SECOND);
            break;

        case ZB_BDB_SIGNAL_FORMATION:
            TRACE_MSG(TRACE_ZCL1, "Formation completed", (FMT__0));
            break;
