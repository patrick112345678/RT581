...
#define ZB_TEST_NAME CN_NST_TC_07_THC1
#define ZB_TRACE_FILE_ID 41051
#include "zb_common.h"
  ...
  if (ZB_GET_APP_SIGNAL_STATUS(param) == 0)
  {
    switch(sig)
    {
      case ZB_BDB_SIGNAL_DEVICE_FIRST_START:
        ...
        ZB_SCHEDULE_ALARM(close_network, 0, TEST_THC1_CLOSES_NETWORK_DELAY);
        break;
      default:
