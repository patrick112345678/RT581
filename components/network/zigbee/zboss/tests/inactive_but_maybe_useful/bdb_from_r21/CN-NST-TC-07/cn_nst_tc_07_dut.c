...
#define ZB_TEST_NAME CN_NST_TC_07_DUT
#define ZB_TRACE_FILE_ID 41052
#include "zb_common.h"
...
static void trigger_steering_on_network(zb_uint8_t param);
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    if (ZB_GET_APP_SIGNAL_STATUS(param) == 0)
    {
        ...
        case ZB_BDB_SIGNAL_DEVICE_FIRST_START:
            ...
            ZB_SCHEDULE_ALARM(trigger_steering_on_network, 0,
                              TEST_DUT_TRIGGERS_NETWORK_STEERING_DELAY);
            break;
        default:
