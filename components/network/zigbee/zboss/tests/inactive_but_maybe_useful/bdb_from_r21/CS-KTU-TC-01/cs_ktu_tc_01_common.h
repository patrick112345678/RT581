...
*/
#ifndef __CS_KTU_TC_01_
#define __CS_KTU_TC_01_
...
static zb_uint8_t g_tllk[16+2] = {0xC0, 0xC1, 0xC2, 0xC3, 0xC4, 0xC5, 0xC6, 0xC7,
                           0xC8, 0xC9, 0xCA, 0xCB, 0xCC, 0xCD, 0xCE, 0xCF};
/* Touch link Link key - add it to Wireshark */

#define TEST_BDB_PRIMARY_CHANNEL_SET (1 << 11)
#define TEST_BDB_SECONDARY_CHANNEL_SET 0
#define TEST_BDB_DUT_SECONDARY_CHANNEL_SET ( (1l << 12) | (1l << 13)  )


#endif /* __CS_KTU_TC_01_ */
