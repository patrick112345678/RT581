 ...
 * DSR.
 */
/* PURPOSE: TH ZC1 - send Transport Key with nwk key protected with TL LK
*/

#define ZB_TEST_NAME CS_KTU_TC_01_THC1
#define ZB_TRACE_FILE_ID 41161
#include "zb_common.h"
...
MAIN()
{
  ...
  ZB_MEMCPY(ZB_AIB().tc_standard_key, g_tllk, ZB_CCM_KEY_SIZE);
