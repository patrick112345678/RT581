...
#define ZB_TEST_NAME CN_NST_TC_05_THC1
#define ZB_TRACE_FILE_ID 41079
#include "zb_common.h"
...
MAIN()
{
    ...
    ZB_IEEE_ADDR_COPY(ZB_PIBCACHE_EXTENDED_ADDRESS(), &g_ieee_addr_thc);
...
static void dev_annce_cb(zb_zdo_device_annce_t *da)
{
    ...
    if (ZB_IEEE_ADDR_CMP(g_ieee_addr_thr, da->ieee_addr) == ZB_TRUE)
    {
