...
#define ZB_TEST_NAME CN_NST_TC_05_DUT
#define ZB_TRACE_FILE_ID 41080
#include "zb_common.h"
...
static void test_start_nwk_steering(zb_uint8_t param)
{
  ZVUNUSED(param);
  ...
  if (ZB_GET_APP_SIGNAL_STATUS(param) == 0)
  {
    switch(sig)
    {
      case ZB_BDB_SIGNAL_DEVICE_FIRST_START:
        ...
        ZB_SCHEDULE_ALARM(test_start_nwk_steering, 0, ZB_TIME_ONE_SECOND * 10);
        break;
      default:
