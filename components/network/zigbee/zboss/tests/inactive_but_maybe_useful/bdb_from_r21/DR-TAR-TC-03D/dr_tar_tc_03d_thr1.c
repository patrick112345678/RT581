...
#define ZB_TEST_NAME DR_TAR_TC_03D_THR1
#define ZB_TRACE_FILE_ID 40978
#include "zb_common.h"
...
static void device_annce_cb(zb_zdo_device_annce_t *da)
{
    ...
    if (ZB_IEEE_ADDR_CMP(da->ieee_addr, g_ieee_addr_dut))
    {
        ...
        {
            /* if DUT is ed */
            ZB_SCHEDULE_ALARM(buffer_manager, 2, THR1_SEND_LEAVE_DELAY_START + 2 * THR1_SEND_LEAVE_DELAY_NEXT);
        }
    }
...
static void buffer_manager(zb_uint8_t idx)
{
    ...
    case 2:
        ZB_GET_OUT_BUF_DELAYED2(construct_and_send_leave, TEST_HAS_DST_IEEE_ADDR);
        /* BREAK */
        break;
