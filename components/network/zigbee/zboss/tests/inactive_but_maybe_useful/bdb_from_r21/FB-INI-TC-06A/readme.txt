5.3.6 B-INI-TC-06A:  Finding and binding follows automatically on network formation&steering: FN device
This test verifies the behavior of a factory-new device, on which a sequence of network formation, automatically followed by network steering automatically followed by finding and binding is triggered. 
