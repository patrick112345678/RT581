...
*/
#ifndef __FB_PRE_TC_05_
#define __FB_PRE_TC_05_
...
#define THR1_FB_TARGET_DELAY    (5 * ZB_TIME_ONE_SECOND)
#define DUT_SHORT_DELAY         (5 * ZB_TIME_ONE_SECOND)
#define DUT_FB_DURATION         (20)
#define THR1_FB_DURATION        (20)

/* DUT is initiator, TH is target */
#define DUT_ENDPOINT 143
#define DUT_COMMISSIONINIG_GROUP_ID 0xAF40
#define THR1_ENDPOINT 55


#endif /* __FB_PRE_TC_05_ */
