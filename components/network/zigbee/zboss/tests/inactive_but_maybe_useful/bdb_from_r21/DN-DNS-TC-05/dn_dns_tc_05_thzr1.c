 ...
 * DSR.
 */
/* PURPOSE: Th ZR1 - forming Distributed Network
*/


#define ZB_TEST_NAME DN_DNS_TC_05_THZR1
#define ZB_TRACE_FILE_ID 40995
#include "zb_common.h"
...
MAIN()
{
    ...
    ZB_IEEE_ADDR_COPY(ZB_PIBCACHE_EXTENDED_ADDRESS(), &g_ieee_addr_thzr1);
