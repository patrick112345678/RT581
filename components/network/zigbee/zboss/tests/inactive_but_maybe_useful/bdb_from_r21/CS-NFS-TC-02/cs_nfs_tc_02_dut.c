 ...
 * DSR.
 */
/* PURPOSE: DUT ZC requiring TCLK update
*/

#define ZB_TEST_NAME CS_NFS_TC_02_DUT
#define ZB_TRACE_FILE_ID 40960
#include "zb_common.h"
...
static void retrigger_steering(zb_uint8_t unused);
  ...
  if (ZB_GET_APP_SIGNAL_STATUS(param) == 0)
  {
    switch(sig)
    {
      ...
      case ZB_BDB_SIGNAL_STEERING:
        ...
        ZB_SCHEDULE_ALARM(retrigger_steering, 0, DUT_RETRIGGER_NETWORK_STEERING_DELAY);
        break;
