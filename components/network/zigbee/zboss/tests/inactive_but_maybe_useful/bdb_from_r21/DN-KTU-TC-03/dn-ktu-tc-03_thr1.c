...
#define ZB_TEST_NAME DN_KTU_TC_03_THR1
#define ZB_TRACE_FILE_ID 41228
#include "zb_common.h"
...
MAIN()
{
...

    {
        ...
        ZB_MEMCPY(ZB_AIB().tc_standard_distributed_key, tmp, ZB_CCM_KEY_SIZE);
    }
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    if (ZB_GET_APP_SIGNAL_STATUS(param) == 0)
    {
        ...
        case ZB_BDB_SIGNAL_STEERING:
            TRACE_MSG(TRACE_APS1, "STEERING", (FMT__0));
            break;
