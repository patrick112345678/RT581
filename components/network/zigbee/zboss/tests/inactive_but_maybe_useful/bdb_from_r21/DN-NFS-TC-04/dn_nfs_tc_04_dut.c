...
#define ZB_TEST_NAME DN_NFS_TC_04_DUT
#define ZB_TRACE_FILE_ID 41028
#include "zb_common.h"
...
#include "dn_nfs_tc_04_common.h"


static void trigger_formation_and_steering(zb_uint8_t param);
  ...
  if (ZB_GET_APP_SIGNAL_STATUS(param) == 0)
  {
    switch(sig)
    {
      case ZB_BDB_SIGNAL_DEVICE_FIRST_START:
        ...
        ZB_SCHEDULE_ALARM(trigger_formation_and_steering, 0,
                          TEST_TRIGGER_SECOND_FORMATION_DELAY);
        break;
      default:
