...
#define ZB_TEST_NAME DR_TAR_TC_03A_THR2
#define ZB_TRACE_FILE_ID 41236
#include "zb_common.h"
...
static void mute_thr1_packets(zb_uint8_t unused);
...
{
    ZVUNUSED(unused);
    MAC_ADD_INVISIBLE_SHORT(zb_address_short_by_ieee(g_ieee_addr_thr1));
}
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    if (ZB_GET_APP_SIGNAL_STATUS(param) == 0)
    {
        ...
        case ZB_BDB_SIGNAL_DEVICE_FIRST_START:
            ...
            ZB_SCHEDULE_ALARM(mute_thr1_packets, 0, THR2_MUTE_THR1_PACKETS_DELAY);
            break;
