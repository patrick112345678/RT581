...
/* PURPOSE:
*/
#ifndef __DR_TAR_TC_03A_
#define __DR_TAR_TC_03A_
...
static zb_ieee_addr_t g_ieee_addr_thr1   = {0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc};
...
#define THE1_FB_START_DELAY (7 * ZB_TIME_ONE_SECOND)
...
#define THR2_MUTE_THR1_PACKETS_DELAY (10 * ZB_TIME_ONE_SECOND)
#define THR1_START_TEST_DELAY        (20 * ZB_TIME_ONE_SECOND)
#define THR1_SEND_MGMT_LEAVET_DELAY  (35 * ZB_TIME_ONE_SECOND)
/* Delay after DUT joins for thc1 and the1 */
...
#define THC1_SEND_NWK_LEAVE_DELAY    (40 * ZB_TIME_ONE_SECOND)
/* Delay after THC1_SEND_NWK_LEAVE_DELAY */
