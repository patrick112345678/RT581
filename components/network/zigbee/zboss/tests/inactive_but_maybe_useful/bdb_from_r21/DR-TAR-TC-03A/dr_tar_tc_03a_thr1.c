 ...
 * DSR.
 */
/* PURPOSE: TH ZR1 (test driver, target)
*/


#define ZB_TEST_NAME DR_TAR_TC_03A_THR1
#define ZB_TRACE_FILE_ID 41235
#include "zb_common.h"
    ...
    case TOP_LEVEL_MGMT_LQI:
      {
        TRACE_MSG(TRACE_APP1, "top_level_forward_test: go to next step", (FMT__0));
        ++s_test_desc.top_level_state;
        ZB_SCHEDULE_ALARM(top_level_fsm, 0, THR1_SEND_MGMT_LEAVET_DELAY);
      }
      break;
