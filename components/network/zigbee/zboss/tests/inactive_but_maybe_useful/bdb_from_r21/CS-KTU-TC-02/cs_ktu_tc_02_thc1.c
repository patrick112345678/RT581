 ...
 * DSR.
 */
/* PURPOSE: TH ZC1 - send Transport Key with nwk key protected with distributed TCLK
*/

#define ZB_TEST_NAME CS_KTU_TC_02_THC1
#define ZB_TRACE_FILE_ID 41094
#include "zb_common.h"
...
MAIN()
{
  ...
  ZB_MEMCPY(ZB_AIB().tc_standard_key, ZB_AIB().tc_standard_distributed_key,
            ZB_CCM_KEY_SIZE);
