 ...
 * DSR.
 */
/* PURPOSE: DUT ZC: join devices using dTCLK
*/

#define ZB_TEST_NAME CS_ICK_TC_02_DUT_WO_IC
#define ZB_TRACE_FILE_ID 41020
#include "zb_common.h"
...
MAIN()
{
    ...
    ZB_IEEE_ADDR_COPY(ZB_PIBCACHE_EXTENDED_ADDRESS(), &g_ieee_addr_dut1);
    ...
    ZB_BDB().bdb_mode = 1;
    ZB_BDB().bdb_join_uses_install_code_key = 0;
