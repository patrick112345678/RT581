...
#define ZB_TEST_NAME CN_RES_TC_02_ZC
#define ZB_TRACE_FILE_ID 41026
#include "zb_common.h"
...
MAIN()
{
  ...
  ZB_IEEE_ADDR_COPY(ZB_PIBCACHE_EXTENDED_ADDRESS(), &g_ieee_addr_c);
