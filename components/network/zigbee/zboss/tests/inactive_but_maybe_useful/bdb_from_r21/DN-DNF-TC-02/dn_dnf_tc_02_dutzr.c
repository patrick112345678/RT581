...
#define ZB_TEST_NAME DN_DNF_TC_02_DUTZR
#define ZB_TRACE_FILE_ID 41049
#include "zb_common.h"
...
static void second_formation(zb_uint8_t param)
{
    (void)param;
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    if (ZB_GET_APP_SIGNAL_STATUS(param) == 0)
    {
        ...
        case ZB_BDB_SIGNAL_DEVICE_FIRST_START:
            ...
            ZB_SCHEDULE_ALARM(second_formation, 0, 25 * ZB_TIME_ONE_SECOND);
            break;

        case ZB_BDB_SIGNAL_STEERING:
            TRACE_MSG(TRACE_ZCL1, "Successfull steering", (FMT__0));
            break;
