...
#define ZB_TEST_NAME TP_BCAST_CHAIN_ZR4
...
{
  zb_uint16_t addr = (zb_uint16_t)0x2222;
  (void)ieee_addr;
...
void bcast_chain_zr4_ping_tc(zb_uint8_t param)
{
  ...
  if (0 == status)
  {
    switch(sig)
    {
      ...
      case ZB_BDB_SIGNAL_DEVICE_REBOOT:
        ...
        zb_buf_get_out_delayed(bcast_chain_zr4_ping_tc);
