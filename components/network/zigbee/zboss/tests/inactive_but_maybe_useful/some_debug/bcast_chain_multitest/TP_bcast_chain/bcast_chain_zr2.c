...
#define ZB_TEST_NAME TP_BCAST_CHAIN_ZR2
...
void bcast_chain_zr2_ping_tc(zb_uint8_t param)
{
  ...
  if (0 == status)
  {
    switch(sig)
    {
      ...
      case ZB_BDB_SIGNAL_DEVICE_REBOOT:
        ...
        zb_buf_get_out_delayed(bcast_chain_zr2_ping_tc);
