...
#define ZB_TEST_NAME TP_BCAST_CHAIN_ZED1
...
static void send_msg_loop(zb_uint8_t param)
{
    ...
    ZB_SCHEDULE_ALARM(trigger_send_msg, 0, 30 * ZB_TIME_ONE_SECOND);
}
...
static void trigger_send_msg(zb_uint8_t param)
{
    ...
    zb_buf_get_out_delayed(send_msg_loop);
}
