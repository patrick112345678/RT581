...
enum test_step_e
{
    ...
    TEST_STEP_1A,           /**< ZED send Color loop set command: action = 0x02 (start from enhanced current hue) */
    TEST_STEP_1B,           /**< ZED send Color loop set command: update flag = 0x01 (update action), action = 0x00 (deactivate),
                               direction = 0x00, time = 0x0000, start hue  = 0x0000. */
    TEST_STEP_2A,           /**< ZED send Color loop set command: update flag = 0x01 (update action), action = 0x01
                              (start from ColorLoopStartEnhancedHue) */
    TEST_STEP_2B,           /**< ZED send Color loop set command: update flag = 0x01 (update action), action = 0x00 (deactivate),
                               direction = 0x00, time = 0x0000, start hue  = 0x0000. */
    TEST_STEP_3A,           /**< ZED send Color loop set command: update flag = 0x01 (update action), action = 0x02
                              (start from enhanced current hue) */
    TEST_STEP_3B,           /**< ZED send Color loop set command: update flag = 0x02 (update direction), action = 0x00,
                               direction = 0x00, time = 0x0000, start hue = 0x0000. */
    TEST_STEP_3C,           /**< ZED send Color loop set command: update flag = 0x01 (update action), action = 0x00 (deactivate),
                               direction = 0x00, time = 0x0000, start hue  = 0x0000. */
    TEST_STEP_4A,           /**< ZED send Color loop set command: update flag = 0x01 (update action), action = 0x02
                              (start from enhanced current hue) */
    TEST_STEP_4B,           /**< ZED send Color loop set command: update flag = 0x04 (update time), action  = 0x00,
                              direction = 0x00, time = 0x0064, start hue = 0x0000. */
    TEST_STEP_4C,           /**< ZED send Color loop set command: update flag = 0x01 (update action), action = 0x00 (deactivate),
                               direction = 0x00, time = 0x0000, start hue  = 0x0000. */
...
void test_next_step(zb_uint8_t param)
{
    ...
    case TEST_STEP_1A:
        TRACE_MSG(TRACE_ZLL3, "TEST_STEP_1A", (FMT__0));
    ...
    case TEST_STEP_1B:
        TRACE_MSG(TRACE_ZLL3, "TEST_STEP_1B", (FMT__0));
        ZB_ZCL_COLOR_CONTROL_SEND_COLOR_LOOP_SET_REQ(buffer, DST_ADDR, DST_ADDR_MODE, DST_ENDPOINT,
                ENDPOINT, ZB_AF_ZLL_PROFILE_ID, ZB_FALSE, NULL,
                ZB_ZCL_CMD_COLOR_CONTROL_LOOP_UPDATE_ACTION,
    ...
    case TEST_STEP_2A:
        TRACE_MSG(TRACE_ZLL3, "TEST_STEP_2A", (FMT__0));
        ZB_ZCL_COLOR_CONTROL_SEND_COLOR_LOOP_SET_REQ(buffer, DST_ADDR, DST_ADDR_MODE, DST_ENDPOINT,
                ENDPOINT, ZB_AF_ZLL_PROFILE_ID, ZB_FALSE, NULL,
                ZB_ZCL_CMD_COLOR_CONTROL_LOOP_UPDATE_ACTION,
    ...
    case TEST_STEP_2B:
        TRACE_MSG(TRACE_ZLL3, "TEST_STEP_2B", (FMT__0));
        ZB_ZCL_COLOR_CONTROL_SEND_COLOR_LOOP_SET_REQ(buffer, DST_ADDR, DST_ADDR_MODE, DST_ENDPOINT,
                ENDPOINT, ZB_AF_ZLL_PROFILE_ID, ZB_FALSE, NULL,
                ZB_ZCL_CMD_COLOR_CONTROL_LOOP_UPDATE_ACTION,
                ZB_ZCL_CMD_COLOR_CONTROL_LOOP_ACTION_DEACTIVATE, 0x00, 0x0000, 0x0000);
    ...
    case TEST_STEP_3A:
        TRACE_MSG(TRACE_ZLL3, "TEST_STEP_3A", (FMT__0));
        ZB_ZCL_COLOR_CONTROL_SEND_COLOR_LOOP_SET_REQ(buffer, DST_ADDR, DST_ADDR_MODE, DST_ENDPOINT,
                ENDPOINT, ZB_AF_ZLL_PROFILE_ID, ZB_FALSE, NULL,
                ZB_ZCL_CMD_COLOR_CONTROL_LOOP_UPDATE_ACTION,
    ...
    case TEST_STEP_3B:
        TRACE_MSG(TRACE_ZLL3, "TEST_STEP_3B", (FMT__0));
        ZB_ZCL_COLOR_CONTROL_SEND_COLOR_LOOP_SET_REQ(buffer, DST_ADDR, DST_ADDR_MODE, DST_ENDPOINT,
                ENDPOINT, ZB_AF_ZLL_PROFILE_ID, ZB_FALSE, NULL,
                ZB_ZCL_CMD_COLOR_CONTROL_LOOP_UPDATE_DIRECTION,
                ZB_ZCL_CMD_COLOR_CONTROL_LOOP_DIRECTION_DECREMENT, 0x00, 0x0000, 0x0000);
        break;

    case TEST_STEP_3C:
        TRACE_MSG(TRACE_ZLL3, "TEST_STEP_3C", (FMT__0));
        ZB_ZCL_COLOR_CONTROL_SEND_COLOR_LOOP_SET_REQ(buffer, DST_ADDR, DST_ADDR_MODE, DST_ENDPOINT,
                ENDPOINT, ZB_AF_ZLL_PROFILE_ID, ZB_FALSE, NULL,
                ZB_ZCL_CMD_COLOR_CONTROL_LOOP_UPDATE_ACTION,
                ZB_ZCL_CMD_COLOR_CONTROL_LOOP_ACTION_DEACTIVATE, 0x00, 0x0000, 0x0000);
    ...
    case TEST_STEP_4A:
        TRACE_MSG(TRACE_ZLL3, "TEST_STEP_4A", (FMT__0));
        ZB_ZCL_COLOR_CONTROL_SEND_COLOR_LOOP_SET_REQ(buffer, DST_ADDR, DST_ADDR_MODE, DST_ENDPOINT,
                ENDPOINT, ZB_AF_ZLL_PROFILE_ID, ZB_FALSE, NULL,
                ZB_ZCL_CMD_COLOR_CONTROL_LOOP_UPDATE_ACTION,
                ZB_ZCL_CMD_COLOR_CONTROL_LOOP_ACTION_CURRENT_HUE, 0x00, 0x0000, 0x0000);
    ...
    case TEST_STEP_4B:
        TRACE_MSG(TRACE_ZLL3, "TEST_STEP_4B", (FMT__0));
        ZB_ZCL_COLOR_CONTROL_SEND_COLOR_LOOP_SET_REQ(buffer, DST_ADDR, DST_ADDR_MODE, DST_ENDPOINT,
                ENDPOINT, ZB_AF_ZLL_PROFILE_ID, ZB_FALSE, NULL,
                ZB_ZCL_CMD_COLOR_CONTROL_LOOP_UPDATE_TIME,
                ZB_ZCL_CMD_COLOR_CONTROL_LOOP_ACTION_DEACTIVATE, 0x00, 0x0064, 0x0000);
        break;

    case TEST_STEP_4C:
        TRACE_MSG(TRACE_ZLL3, "TEST_STEP_4C", (FMT__0));
        ZB_ZCL_COLOR_CONTROL_SEND_COLOR_LOOP_SET_REQ(buffer, DST_ADDR, DST_ADDR_MODE, DST_ENDPOINT,
                ENDPOINT, ZB_AF_ZLL_PROFILE_ID, ZB_FALSE, NULL,
                ZB_ZCL_CMD_COLOR_CONTROL_LOOP_UPDATE_ACTION,
                ZB_ZCL_CMD_COLOR_CONTROL_LOOP_ACTION_DEACTIVATE, 0x00, 0x0000, 0x0000);
