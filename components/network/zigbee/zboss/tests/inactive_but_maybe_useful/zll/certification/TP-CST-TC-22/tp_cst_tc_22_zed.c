...
enum test_step_e
{
    ...
    TEST_STEP_1_MOVE_TO_COLOR_TEMP,  /**< ZED send move to color temperature command with color temperature and
                                   transition time = appropriate values. */
    TEST_STEP_2A_MOVE_COLOR_TEMP, /**< ZED send move color temperature command with move mode = 0x01 (move up),
                                   all other fields = appropriate values. */
    TEST_STEP_2B_MOVE_COLOR_TEMP, /**< After 10s ZED send move color temperature command with move mode = 0x00 (stop),
                                   rate = 0x0000, color temperature minimum = 0x0000, color temperature maximum = 0x0000. */
    TEST_STEP_3A_MOVE_COLOR_TEMP, /**< ZED send move color temperature command with move mode = 0x03 (move down),
                                   all other fields = appropriate values. */
    TEST_STEP_3B_MOVE_COLOR_TEMP, /**< After 10s ZED send move color temperature command with move mode = 0x00 (stop),
                                   rate = 0x0000, color temperature minimum = 0x0000, color temperature maximum = 0x0000. */
    TEST_STEP_4A_STEP_COLOR_TEMP, /**< ZED send step color temperature command with step mode = 0x01 (step up),
                                   all other fields = appropriate values. */
    TEST_STEP_4B_STOP_MOVE_STEP, /**< After 10s ZED send stop move step command. */
    TEST_STEP_5A_STEP_COLOR_TEMP, /**< ZED send step color temperature command with step mode = 0x03 (step down),
                                   all other fields = appropriate values. */
    TEST_STEP_5B_STOP_MOVE_STEP, /**< After 10s ZED send stop move step command. */
...
zb_uint8_t zcl_specific_cluster_cmd_handler(zb_uint8_t param)
{
    ...
    if ( g_test_step != TEST_STEP_2A_MOVE_COLOR_TEMP &&
            g_test_step != TEST_STEP_3A_MOVE_COLOR_TEMP &&
            g_test_step != TEST_STEP_4A_STEP_COLOR_TEMP &&
            g_test_step != TEST_STEP_5A_STEP_COLOR_TEMP )
    {
...
void test_next_step(zb_uint8_t param)
{
    ...
    case TEST_STEP_1_MOVE_TO_COLOR_TEMP:
        TRACE_MSG(TRACE_ZLL3, "TEST_STEP_1_MOVE_TO_COLOR_TEMP", (FMT__0));
        ZB_ZCL_COLOR_CONTROL_SEND_MOVE_TO_COLOR_TEMPERATURE_REQ(buffer, DST_ADDR, DST_ADDR_MODE, DST_ENDPOINT,
                ENDPOINT, ZB_AF_ZLL_PROFILE_ID, ZB_FALSE, NULL,
                0x03e8, 0x0032);
        break;

    case TEST_STEP_2A_MOVE_COLOR_TEMP:
        TRACE_MSG(TRACE_ZLL3, "TEST_STEP_2A_MOVE_COLOR_TEMP", (FMT__0));
    ...
    case TEST_STEP_2B_MOVE_COLOR_TEMP:
        TRACE_MSG(TRACE_ZLL3, "TEST_STEP_2B_MOVE_COLOR_TEMP", (FMT__0));
        ZB_ZCL_COLOR_CONTROL_SEND_MOVE_COLOR_TEMP_REQ(buffer, DST_ADDR, DST_ADDR_MODE, DST_ENDPOINT,
                ENDPOINT, ZB_AF_ZLL_PROFILE_ID, ZB_FALSE, NULL,
                ZB_ZCL_CMD_COLOR_CONTROL_MOVE_STOP, 0x0000, 0x0000, 0x0000);
        break;

    case TEST_STEP_3A_MOVE_COLOR_TEMP:
        TRACE_MSG(TRACE_ZLL3, "TEST_STEP_3A_MOVE_COLOR_TEMP", (FMT__0));
        ZB_ZCL_COLOR_CONTROL_SEND_MOVE_COLOR_TEMP_REQ(buffer, DST_ADDR, DST_ADDR_MODE, DST_ENDPOINT,
                ENDPOINT, ZB_AF_ZLL_PROFILE_ID, ZB_FALSE, NULL,
                ZB_ZCL_CMD_COLOR_CONTROL_MOVE_DOWN, 0x03e8, 0x0000, 0x7530);
        ZB_SCHEDULE_ALARM(test_timer_next_step, 0, 10 * ZB_TIME_ONE_SECOND);
        break;

    case TEST_STEP_3B_MOVE_COLOR_TEMP:
        TRACE_MSG(TRACE_ZLL3, "TEST_STEP_3B_MOVE_COLOR_TEMP", (FMT__0));
        ZB_ZCL_COLOR_CONTROL_SEND_MOVE_COLOR_TEMP_REQ(buffer, DST_ADDR, DST_ADDR_MODE, DST_ENDPOINT,
                ENDPOINT, ZB_AF_ZLL_PROFILE_ID, ZB_FALSE, NULL,
                ZB_ZCL_CMD_COLOR_CONTROL_MOVE_STOP, 0x0000, 0x0000, 0x0000);
        break;

    case TEST_STEP_4A_STEP_COLOR_TEMP:
        TRACE_MSG(TRACE_ZLL3, "TEST_STEP_4A_STEP_COLOR_TEMP", (FMT__0));
        ZB_ZCL_COLOR_CONTROL_SEND_STEP_COLOR_TEMP_REQ(buffer, DST_ADDR, DST_ADDR_MODE, DST_ENDPOINT,
                ENDPOINT, ZB_AF_ZLL_PROFILE_ID, ZB_FALSE, NULL,
                ZB_ZCL_CMD_COLOR_CONTROL_STEP_UP, 0x1388, 0x0032, 0x0000, 0x0000);
        ZB_SCHEDULE_ALARM(test_timer_next_step, 0, 10 * ZB_TIME_ONE_SECOND);
        break;

    case TEST_STEP_4B_STOP_MOVE_STEP:
        TRACE_MSG(TRACE_ZLL3, "TEST_STEP_4B_STOP_MOVE_STEP", (FMT__0));
        ZB_ZCL_COLOR_CONTROL_SEND_STOP_MOVE_STEP_REQ(buffer, DST_ADDR, DST_ADDR_MODE, DST_ENDPOINT,
                ENDPOINT, ZB_AF_ZLL_PROFILE_ID, ZB_FALSE, NULL);
        break;

    case TEST_STEP_5A_STEP_COLOR_TEMP:
        TRACE_MSG(TRACE_ZLL3, "TEST_STEP_5A_STEP_COLOR_TEMP", (FMT__0));
        ZB_ZCL_COLOR_CONTROL_SEND_STEP_COLOR_TEMP_REQ(buffer, DST_ADDR, DST_ADDR_MODE, DST_ENDPOINT,
                ENDPOINT, ZB_AF_ZLL_PROFILE_ID, ZB_FALSE, NULL,
                ZB_ZCL_CMD_COLOR_CONTROL_STEP_DOWN, 0x1388, 0x0032, 0x0000, 0x0000);
        ZB_SCHEDULE_ALARM(test_timer_next_step, 0, 10 * ZB_TIME_ONE_SECOND);
        break;

    case TEST_STEP_5B_STOP_MOVE_STEP:
        TRACE_MSG(TRACE_ZLL3, "TEST_STEP_5B_STOP_MOVE_STEP", (FMT__0));
        ZB_ZCL_COLOR_CONTROL_SEND_STOP_MOVE_STEP_REQ(buffer, DST_ADDR, DST_ADDR_MODE, DST_ENDPOINT,
                ENDPOINT, ZB_AF_ZLL_PROFILE_ID, ZB_FALSE, NULL);
        break;
