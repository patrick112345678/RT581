...
void zb_zdo_startup_complete(zb_uint8_t param)
{
    ...
    case ZB_ZDO_SIGNAL_SKIP_STARTUP:
        ...
        bdb_touchlink_target_start(param);
        param = 0;
        break;
...
zb_ret_t level_control_set_level(zb_uint8_t new_level)
{
    ...
    g_level_control_current_level = new_level;
...
void test_device_cb(zb_uint8_t  param)
{
    ...
    case ZB_ZCL_LEVEL_CONTROL_SET_VALUE_CB_ID:
        cb_param->status =
            level_control_set_level(cb_param->cb_param.level_control_set_value_param.new_value);
        break;
