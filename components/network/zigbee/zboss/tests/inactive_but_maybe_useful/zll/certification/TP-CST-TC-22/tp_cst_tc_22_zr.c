 ...
 * DSR.
 */
/* PURPOSE: Server for TP-CST-TC-15 test
*/

#define ZB_TRACE_FILE_ID 41630
#include "zll/zb_zll_common.h"
#include "test_defs.h"
#include "zll/zb_zcl_on_off_zll_adds.h"

#if defined ZB_ENABLE_ZLL && defined ZB_ZLL_DEFINE_DEVICE_COLOR_LIGHT
...
zb_uint16_t g_color_control_color_capabilities = ZB_ZCL_COLOR_CONTROL_COLOR_CAPABILITIES_MAX_VALUE;
zb_uint16_t g_color_control_color_temp_physical_min = ZB_ZCL_COLOR_CONTROL_TEMP_PHYSICAL_MIN_DEF_VALUE + 0x0010;
zb_uint16_t g_color_control_color_temp_physical_max = ZB_ZCL_COLOR_CONTROL_TEMP_PHYSICAL_MAX_DEF_VALUE - 0x0010;
...
/********************* Declare device **************************/
ZB_ZLL_DECLARE_COLOR_LIGHT_CLUSTER_LIST(
    color_light_clusters,
...
ZB_ZLL_DECLARE_COLOR_LIGHT_EP(color_light_ep, ENDPOINT, color_light_clusters);

ZB_ZLL_DECLARE_COLOR_LIGHT_CTX(color_light_ctx, color_light_ep);
...
MAIN()
{
    ...
    /* Mark all scene table entries as free */
    ZB_ZCL_SCENES_CLEAR_SCENE_TABLE(g_zb_zll_color_light_scene_table_color_light_ep);
...
#else /* defined ZB_ENABLE_ZLL && defined ZB_ZLL_DEFINE_DEVICE_COLOR_LIGHT */
...
#endif /* defined ZB_ENABLE_ZLL && defined ZB_ZLL_DEFINE_DEVICE_COLOR_LIGHT */
