 ...
 * DSR.
 */
/* PURPOSE: On/Off plugin unitfor ZLL profile, spec 5.2.2
*/

#define ZB_TRACE_FILE_ID 41664
#include "zll/zb_zll_common.h"

#define MY_CHANNEL 11

#if defined ZB_ENABLE_ZLL && defined ZB_ZLL_DEFINE_DEVICE_ON_OFF_PLUGIN_UNIT
...
/********************* Declare device **************************/
ZB_ZLL_DECLARE_ON_OFF_PLUGIN_UNIT_CLUSTER_LIST(
    on_off_plugin_unit_clusters,
    basic_attr_list, identify_attr_list, groups_attr_list,
    scenes_attr_list, on_off_attr_list, ZB_FALSE);

ZB_ZLL_DECLARE_ON_OFF_PLUGIN_UNIT_EP(on_off_plugin_unit_ep, ENDPOINT, on_off_plugin_unit_clusters);

ZB_ZLL_DECLARE_ON_OFF_PLUGIN_UNIT_CTX(on_off_plugin_unit_ctx, on_off_plugin_unit_ep);
/** [COMMON_DECLARATION] */
...
MAIN()
{
  ...
  ZB_AF_REGISTER_DEVICE_CTX(&on_off_plugin_unit_ctx);
...
#else /* defined ZB_ENABLE_ZLL && defined ZB_ZLL_DEFINE_DEVICE_ON_OFF_PLUGIN_UNIT */
...
#endif /* defined ZB_ENABLE_ZLL && defined ZB_ZLL_DEFINE_DEVICE_ON_OFF_PLUGIN_UNIT */
