 ...
 * DSR.
 */
/* PURPOSE: Dimmable plugin uint for ZLL profile, spec 5.2.4
*/

#define ZB_TRACE_FILE_ID 41652
#include "zll/zb_zll_common.h"

#define MY_CHANNEL 11

#if defined ZB_ENABLE_ZLL && defined ZB_ZLL_DEFINE_DEVICE_DIMMABLE_PLUGIN_UNIT
...
ZB_ZLL_DECLARE_DIMMABLE_PLUGIN_UNIT_EP(dimmable_plugin_unit_ep, ENDPOINT, dimmable_plugin_unit_clusters);

ZB_ZLL_DECLARE_DIMMABLE_PLUGIN_UNIT_CTX(dimmable_plugin_unit_ctx, dimmable_plugin_unit_ep);
/** [COMMON_DECLARATION] */
...
MAIN()
{
  ...
  ZB_AF_REGISTER_DEVICE_CTX(&dimmable_plugin_unit_ctx);
...
#else /* defined ZB_ENABLE_ZLL && defined ZB_ZLL_DEFINE_DEVICE_DIMMABLE_PLUGIN_UNIT */
...
#endif /* defined ZB_ENABLE_ZLL && defined ZB_ZLL_DEFINE_DEVICE_DIMMABLE_PLUGIN_UNIT */
