 ...
 * DSR.
 */
/* PURPOSE: Color temperature light for ZLL profile, spec 5.2.7
*/

#define ZB_TRACE_FILE_ID 41663
#include "zll/zb_zll_common.h"

#define MY_CHANNEL 11

#if defined ZB_ENABLE_ZLL && defined ZB_ZLL_DEFINE_DEVICE_COLOR_TEMPERATURE_LIGHT
...
zb_uint16_t g_color_control_color_capabilities = ZB_ZCL_COLOR_CONTROL_CAPABILITIES_COLOR_TEMP;
...
/********************* Declare device **************************/
ZB_ZLL_DECLARE_COLOR_TEMPERATURE_LIGHT_CLUSTER_LIST(
    color_temperature_light_clusters,
...
ZB_ZLL_DECLARE_COLOR_TEMPERATURE_LIGHT_EP(color_temperature_light_ep, ENDPOINT, color_temperature_light_clusters);

ZB_ZLL_DECLARE_COLOR_TEMPERATURE_LIGHT_CTX(color_temperature_light_ctx, color_temperature_light_ep);
/** [COMMON_DECLARATION] */
...
MAIN()
{
    ...
    ZB_AF_REGISTER_DEVICE_CTX(&color_temperature_light_ctx);
...
#else /* defined ZB_ENABLE_ZLL && defined ZB_ZLL_DEFINE_DEVICE_COLOR_TEMPERATURE_LIGHT */
...
#endif /* defined ZB_ENABLE_ZLL && defined ZB_ZLL_DEFINE_DEVICE_COLOR_TEMPERATURE_LIGHT */
