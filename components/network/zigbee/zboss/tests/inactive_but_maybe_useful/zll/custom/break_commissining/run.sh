...
killch() {
    kill $end3PID $end2PID $endPID $routerPID $PipePID
    rm -f /tmp/zt[0123].*
}
...
../../../../devtools/network_simulator/network_simulator --nNode=5 --pipeName=/tmp/zt >ns.txt 2>&1 &
PipePID=$!
sleep 1
...
#echo -n "run ZED3... "
#./zed3 /tmp/zt4.write /tmp/zt4.read &
#end3PID=$!
#wait_for_start zed3
