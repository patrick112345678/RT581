 ...
 * DSR.
 */
/* PURPOSE: Non-color controller for ZLL profile, spec 5.3.3
*/

#define ZB_TRACE_FILE_ID 41658
#include "zll/zb_zll_common.h"

#define MY_CHANNEL 11

#if defined ZB_ENABLE_ZLL && defined ZB_ZLL_DEFINE_DEVICE_NON_COLOR_CONTROLLER
...
/** [COMMON_DECLARATION] */
/********************* Declare device **************************/
ZB_ZLL_DECLARE_NON_COLOR_CONTROLLER_CLUSTER_LIST(non_color_controller_clusters,
