 ...
 * DSR.
 */
/* PURPOSE: Control bridge for ZLL profile, spec 5.3.5
*/

#define ZB_TRACE_FILE_ID 41661
#include "zll/zb_zll_common.h"

#define MY_CHANNEL 11

#if defined ZB_ENABLE_ZLL && defined ZB_ZLL_DEFINE_DEVICE_CONTROL_BRIDGE
...
/** [COMMON_DECLARATION] */
/********************* Declare device **************************/
ZB_ZLL_DECLARE_CONTROL_BRIDGE_CLUSTER_LIST(control_bridge_clusters,
        ZB_ZCL_CLUSTER_MIXED_ROLE);

ZB_ZLL_DECLARE_CONTROL_BRIDGE_EP(control_bridge_ep, ENDPOINT, control_bridge_clusters);

ZB_ZLL_DECLARE_CONTROL_BRIDGE_CTX(control_bridge_ctx, control_bridge_ep);
/** [COMMON_DECLARATION] */
...
MAIN()
{
    ...
    ZB_AF_REGISTER_DEVICE_CTX(&control_bridge_ctx);
