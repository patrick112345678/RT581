 ...
 * DSR.
 */
/* PURPOSE: On/off sensor ZLL profile, spec 5.3.6
*/

#define ZB_TRACE_FILE_ID 41654
#include "zll/zb_zll_common.h"

#define MY_CHANNEL 11

#if defined ZB_ENABLE_ZLL && defined ZB_ZLL_DEFINE_DEVICE_ON_OFF_SENSOR
...
/** [COMMON_DECLARATION] */
/********************* Declare device **************************/
ZB_ZLL_DECLARE_ON_OFF_SENSOR_CLUSTER_LIST(on_off_sensor_clusters,
        ZB_ZCL_CLUSTER_MIXED_ROLE);

ZB_ZLL_DECLARE_ON_OFF_SENSOR_EP(on_off_sensor_ep, ENDPOINT, on_off_sensor_clusters);

ZB_ZLL_DECLARE_ON_OFF_SENSOR_CTX(on_off_sensor_ctx, on_off_sensor_ep);
/** [COMMON_DECLARATION] */
...
MAIN()
{
    ...
    ZB_AF_REGISTER_DEVICE_CTX(&on_off_sensor_ctx);
