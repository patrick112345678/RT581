...
void zll_task_state_changed(zb_uint8_t param)
{
    ...
    else if (task_status->task == ZB_ZLL_DEVICE_DISCOVERY_TASK)
    {
...
void test_next_step(zb_uint8_t param)
{
    ...
    if (g_test_step == TEST_STEP_INITIAL)
    {
        TRACE_MSG(TRACE_ZLL3, "TEST_STEP_START_DISCOVERY: scheduling request", (FMT__0));
    ...
    else if (g_test_step == TEST_STEP_START_DISCOVERY)
    {
