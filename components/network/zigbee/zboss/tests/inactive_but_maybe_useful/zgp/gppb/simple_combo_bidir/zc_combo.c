...
zb_zcl_on_off_attrs_t g_attr_on_off_attrs;

ZB_ZCL_DECLARE_ON_OFF_ATTR_LIST(on_off_attr_list, g_attr_on_off_attrs);

/********************* Declare device **************************/

ZB_HA_DECLARE_COMBO_CLUSTER_LIST_EXT(sample_clusters,
                                     basic_attr_list,
                                     identify_attr_list,
                                     on_off_attr_list);
