...
TH-GPS is configured with:
    ...
    gpSharedSecurityKeyType = 0b111 (GPD group key derived individual key);
    gpSharedSecurityKey = 0xc0 0xc1 0xc2 0xc3 0xc4 0xc5 0xc6 0xc7 0xc8 0xc9 0xca 0xc 0xcc 0cd 0xce 0xcf
...
Test procedure:
  ...
  TH-GPS starts as ZC and enters commissioning mode with gpsCommissioningExitMode = On First Pairing Success.
	...
	GPDsecurityKeyPresent=0b1; 
        ...
        KeyType = 0b111, 
        GPDsecurityKey field present and carrying the individual GP group key derived from the NWK key, encrypted, 
...
Pass Verdict:
    1) DUT-GPD sends Data GPDF protected, with Extended NWK Frame Control field present 
       and its SecurityKey subfield set to 0b1.
