...
void next_step(zb_buf_t * zcl_cmd_buf)
{
  ...
  if (g_test_state == TEST_STATE_WRITE_GPS_COMMUNICATION_MODE)
  {
    val = 0x02;
  ...
  if (g_test_state == TEST_STATE_READ_COMMISSIONING_EXIT_MODE1 ||
  ...
  if (g_test_state == TEST_STATE_WRITE_COMMISSIONING_EXIT_MODE)
  {
    val = 0x00;
    attr_val = (zb_uint8_t*)&val;
    zgp_cluster_write_attr(ZB_REF_FROM_BUF(zcl_cmd_buf), DUT_GPP_ADDR, DUT_GPP_ADDR_MODE,
  ...
  if (g_test_state == TEST_STATE_READ_COMMISSIONING_WINDOW1 ||
  ...
  if (g_test_state == TEST_STATE_WRITE_COMMISSIONING_WINDOW)
  {
    val = 0x003d;
    attr_val = (zb_uint8_t*)&val;
    zgp_cluster_write_attr(ZB_REF_FROM_BUF(zcl_cmd_buf), DUT_GPP_ADDR, DUT_GPP_ADDR_MODE,
  ...
  if (g_test_state == TEST_STATE_READ_SECURITY_LEVEL1 ||
  ...
  if (g_test_state == TEST_STATE_WRITE_SECURITY_LEVEL)
  {
    val = 0x02;
    attr_val = (zb_uint8_t*)&val;
    zgp_cluster_write_attr(ZB_REF_FROM_BUF(zcl_cmd_buf), DUT_GPP_ADDR, DUT_GPP_ADDR_MODE,
  ...
  if (g_test_state == TEST_STATE_READ_MAX_SINK_TABLE_ENTRIES1 ||
  ...
  if (g_test_state == TEST_STATE_WRITE_MAX_SINK_TABLE_ENTRIES)
  {
    val = 0x0f;
    attr_val = (zb_uint8_t*)&val;
    zgp_cluster_write_attr(ZB_REF_FROM_BUF(zcl_cmd_buf), DUT_GPP_ADDR, DUT_GPP_ADDR_MODE,
  ...
  if (g_test_state == TEST_STATE_READ_SINK_TABLE1 ||
  ...
  if (g_test_state == TEST_STATE_WRITE_SINK_TABLE)
  {
    val = 0x0000;
    attr_val = (zb_uint8_t*)&val;
    zgp_cluster_write_attr(ZB_REF_FROM_BUF(zcl_cmd_buf), DUT_GPP_ADDR, DUT_GPP_ADDR_MODE,
