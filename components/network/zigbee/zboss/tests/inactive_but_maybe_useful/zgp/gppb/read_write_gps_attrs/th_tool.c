...
enum test_states_e
{
    ...
    TEST_STATE_READ_COMMISSIONING_EXIT_MODE1,
    TEST_STATE_WRITE_COMMISSIONING_EXIT_MODE,
    TEST_STATE_READ_COMMISSIONING_EXIT_MODE2,
    TEST_STATE_READ_COMMISSIONING_WINDOW1,
    TEST_STATE_WRITE_COMMISSIONING_WINDOW,
    TEST_STATE_READ_COMMISSIONING_WINDOW2,
    TEST_STATE_READ_SECURITY_LEVEL1,
    TEST_STATE_WRITE_SECURITY_LEVEL,
    TEST_STATE_READ_SECURITY_LEVEL2,
    TEST_STATE_READ_MAX_SINK_TABLE_ENTRIES1,
    TEST_STATE_WRITE_MAX_SINK_TABLE_ENTRIES,
    TEST_STATE_READ_MAX_SINK_TABLE_ENTRIES2,
    TEST_STATE_READ_SINK_TABLE1,
    TEST_STATE_WRITE_SINK_TABLE,
    TEST_STATE_READ_SINK_TABLE2,
...
zb_uint8_t g_test_state = TEST_STATE_READ_GPS_COMMUNICATION_MODE1;
...
void next_step(zb_buf_t *zcl_cmd_buf)
{
    ...
    if (g_test_state == TEST_STATE_READ_GPS_COMMUNICATION_MODE1 ||
            g_test_state == TEST_STATE_READ_GPS_COMMUNICATION_MODE2)
    {
    ...
    else if (g_test_state == TEST_STATE_WRITE_GPS_COMMUNICATION_MODE)
    {
        val = 0x02;
        attr_val = (zb_uint8_t *)&val;
        zgp_cluster_write_attr(ZB_REF_FROM_BUF(zcl_cmd_buf), DUT_GPP_ADDR, DUT_GPP_ADDR_MODE,
                               ZB_ZCL_ATTR_GPS_COMMUNICATION_MODE_ID, ZB_ZCL_ATTR_TYPE_8BITMAP, attr_val,
                               ZB_ZCL_DISABLE_DEFAULT_RESPONSE, NULL);
    }
    else if (g_test_state == TEST_STATE_READ_COMMISSIONING_EXIT_MODE1 ||
             g_test_state == TEST_STATE_READ_COMMISSIONING_EXIT_MODE2)
    {
        zgp_cluster_read_attr(ZB_REF_FROM_BUF(zcl_cmd_buf), DUT_GPP_ADDR, DUT_GPP_ADDR_MODE,
                              ZB_ZCL_ATTR_GPS_COMMISSIONING_EXIT_MODE_ID,
                              ZB_ZCL_ENABLE_DEFAULT_RESPONSE, NULL);
    }
    else if (g_test_state == TEST_STATE_WRITE_COMMISSIONING_EXIT_MODE)
    {
        val = 0x00;
        attr_val = (zb_uint8_t *)&val;
        zgp_cluster_write_attr(ZB_REF_FROM_BUF(zcl_cmd_buf), DUT_GPP_ADDR, DUT_GPP_ADDR_MODE,
    ...
    else if (g_test_state == TEST_STATE_READ_COMMISSIONING_WINDOW1 ||
             g_test_state == TEST_STATE_READ_COMMISSIONING_WINDOW2)
    {
        zgp_cluster_read_attr(ZB_REF_FROM_BUF(zcl_cmd_buf), DUT_GPP_ADDR, DUT_GPP_ADDR_MODE,
                              ZB_ZCL_ATTR_GPS_COMMISSIONING_WINDOW_ID,
                              ZB_ZCL_ENABLE_DEFAULT_RESPONSE, NULL);
    }
    else if (g_test_state == TEST_STATE_WRITE_COMMISSIONING_WINDOW)
    {
        val = 0x003d;
        attr_val = (zb_uint8_t *)&val;
        zgp_cluster_write_attr(ZB_REF_FROM_BUF(zcl_cmd_buf), DUT_GPP_ADDR, DUT_GPP_ADDR_MODE,
                               ZB_ZCL_ATTR_GPS_COMMISSIONING_WINDOW_ID, ZB_ZCL_ATTR_TYPE_U16, attr_val,
                               ZB_ZCL_DISABLE_DEFAULT_RESPONSE, NULL);
    }
    else if (g_test_state == TEST_STATE_READ_SECURITY_LEVEL1 ||
             g_test_state == TEST_STATE_READ_SECURITY_LEVEL2)
    {
        zgp_cluster_read_attr(ZB_REF_FROM_BUF(zcl_cmd_buf), DUT_GPP_ADDR, DUT_GPP_ADDR_MODE,
                              ZB_ZCL_ATTR_GPS_SECURITY_LEVEL_ID,
                              ZB_ZCL_ENABLE_DEFAULT_RESPONSE, NULL);
    }
    else if (g_test_state == TEST_STATE_WRITE_SECURITY_LEVEL)
    {
        val = 0x02;
        attr_val = (zb_uint8_t *)&val;
        zgp_cluster_write_attr(ZB_REF_FROM_BUF(zcl_cmd_buf), DUT_GPP_ADDR, DUT_GPP_ADDR_MODE,
                               ZB_ZCL_ATTR_GPS_SECURITY_LEVEL_ID,
                               ZB_ZCL_ATTR_TYPE_8BITMAP, attr_val,
                               ZB_ZCL_DISABLE_DEFAULT_RESPONSE, NULL);
    }
    else if (g_test_state == TEST_STATE_READ_MAX_SINK_TABLE_ENTRIES1 ||
             g_test_state == TEST_STATE_READ_MAX_SINK_TABLE_ENTRIES2)
    {
        zgp_cluster_read_attr(ZB_REF_FROM_BUF(zcl_cmd_buf), DUT_GPP_ADDR, DUT_GPP_ADDR_MODE,
                              ZB_ZCL_ATTR_GPS_MAX_SINK_TABLE_ENTRIES_ID,
                              ZB_ZCL_ENABLE_DEFAULT_RESPONSE, NULL);
    }
    else if (g_test_state == TEST_STATE_WRITE_MAX_SINK_TABLE_ENTRIES)
    {
        val = 0x0f;
        attr_val = (zb_uint8_t *)&val;
        zgp_cluster_write_attr(ZB_REF_FROM_BUF(zcl_cmd_buf), DUT_GPP_ADDR, DUT_GPP_ADDR_MODE,
                               ZB_ZCL_ATTR_GPS_MAX_SINK_TABLE_ENTRIES_ID,
                               ZB_ZCL_ATTR_TYPE_U8, attr_val,
                               ZB_ZCL_DISABLE_DEFAULT_RESPONSE, NULL);
    }
    else if (g_test_state == TEST_STATE_READ_SINK_TABLE1 ||
             g_test_state == TEST_STATE_READ_SINK_TABLE2)
    {
        zgp_cluster_read_attr(ZB_REF_FROM_BUF(zcl_cmd_buf), DUT_GPP_ADDR, DUT_GPP_ADDR_MODE,
                              ZB_ZCL_ATTR_GPS_SINK_TABLE_ID,
                              ZB_ZCL_ENABLE_DEFAULT_RESPONSE, NULL);
    }
    else if (g_test_state == TEST_STATE_WRITE_SINK_TABLE)
    {
        val = 0x0000;
        attr_val = (zb_uint8_t *)&val;
        zgp_cluster_write_attr(ZB_REF_FROM_BUF(zcl_cmd_buf), DUT_GPP_ADDR, DUT_GPP_ADDR_MODE,
                               ZB_ZCL_ATTR_GPS_SINK_TABLE_ID,
                               ZB_ZCL_ATTR_TYPE_LONG_OCTET_STRING, attr_val,
                               ZB_ZCL_DISABLE_DEFAULT_RESPONSE, NULL);
    }
    else if (g_test_state == TEST_STATE_READ_FUNCTIONALITY1 ||
    ...
    else if (g_test_state == TEST_STATE_WRITE_FUNCTIONALITY)
    {
        val = 0xffff;
        attr_val = (zb_uint8_t *)&val;
        zgp_cluster_write_attr(ZB_REF_FROM_BUF(zcl_cmd_buf), DUT_GPP_ADDR, DUT_GPP_ADDR_MODE,
                               ZB_ZCL_ATTR_GPS_FUNCTIONALITY_ID,
                               ZB_ZCL_ATTR_TYPE_U16, attr_val,
                               ZB_ZCL_DISABLE_DEFAULT_RESPONSE, NULL);
    }
    else if (g_test_state == TEST_STATE_READ_ACTIVE_FUNCTIONALITY1 ||
    ...
    else if (g_test_state == TEST_STATE_WRITE_ACTIVE_FUNCTIONALITY)
    {
        val = 0x0000;
        attr_val = (zb_uint8_t *)&val;
        zgp_cluster_write_attr(ZB_REF_FROM_BUF(zcl_cmd_buf), DUT_GPP_ADDR, DUT_GPP_ADDR_MODE,
                               ZB_ZCL_ATTR_GPS_ACTIVE_FUNCTIONALITY_ID,
                               ZB_ZCL_ATTR_TYPE_24BITMAP, attr_val,
                               ZB_ZCL_DISABLE_DEFAULT_RESPONSE, NULL);
    }
...
void read_attr_handler(zb_buf_t *zcl_cmd_buf)
{
    ...
    case TEST_STATE_READ_COMMISSIONING_EXIT_MODE1:
    case TEST_STATE_READ_COMMISSIONING_EXIT_MODE2:
    case TEST_STATE_READ_COMMISSIONING_WINDOW1:
    case TEST_STATE_READ_COMMISSIONING_WINDOW2:
    case TEST_STATE_READ_SECURITY_LEVEL1:
    case TEST_STATE_READ_SECURITY_LEVEL2:
    case TEST_STATE_READ_MAX_SINK_TABLE_ENTRIES1:
    case TEST_STATE_READ_MAX_SINK_TABLE_ENTRIES2:
    case TEST_STATE_READ_SINK_TABLE1:
    case TEST_STATE_READ_SINK_TABLE2:
...
void write_attr_handler(zb_buf_t *zcl_cmd_buf)
{
    ...
    case TEST_STATE_WRITE_COMMISSIONING_EXIT_MODE:
    case TEST_STATE_WRITE_COMMISSIONING_WINDOW:
    case TEST_STATE_WRITE_SECURITY_LEVEL:
    case TEST_STATE_WRITE_SINK_TABLE:
    {
    ...
    break;
    case TEST_STATE_WRITE_MAX_SINK_TABLE_ENTRIES:
