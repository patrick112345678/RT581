...
#define TH_TOOL_SEND_NEXT_CMD_DELAY1 (5)
#define TH_TOOL_SEND_NEXT_CMD_DELAY2 (10)
#define TH_TOOL_SEND_NEXT_CMD_DELAY3 (10)
#define TH_TOOL_SEND_NEXT_CMD_DELAY4 (5)
#define TH_TOOL_SEND_NEXT_CMD_DELAY5 (10)

#define TH_GPD_SEND_GPDF1_DELAY (10)
#define TH_GPD_SEND_GPDF2_DELAY (25)
