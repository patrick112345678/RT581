...
#define ZB_TEST_NAME GPS_COMMISSIONING_MULTIHOP_APP_000_TH_GPP
#define ZB_TRACE_FILE_ID 41377
...
static void handle_gp_pairing(zb_uint8_t buf_ref)
{
  ...
  if (TEST_DEVICE_CTX.test_state == TEST_STATE_WAIT_FOR_PAIRING)
  {
...
static void perform_next_state(zb_uint8_t param)
{
  ...
  {
#ifdef ZB_NSNG
    case TEST_STATE_WAIT_FOR_PAIRING:
      break;
#endif
