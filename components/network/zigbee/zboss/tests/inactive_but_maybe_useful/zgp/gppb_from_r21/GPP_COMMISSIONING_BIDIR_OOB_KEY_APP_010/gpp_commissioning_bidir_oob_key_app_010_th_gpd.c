...
#define ZB_TEST_NAME GPP_COMMISSIONING_BIDIR_OOB_KEY_APP_010_TH_GPD
#define ZB_TRACE_FILE_ID 41338
...
ZB_ZGPD_DECLARE_SIMPLE_TEST_TEMPLATE(TEST_DEVICE_CTX, 10000)
