...
#define ZB_TEST_NAME GPS_PERSISTENT_STORAGE_DUT_GPS
#define ZB_TRACE_FILE_ID 41272
...
static void perform_next_state(zb_uint8_t param)
{
  ...
  switch (TEST_DEVICE_CTX.test_state)
  {
    case TEST_STATE_READY_TO_COMMISSIONING:
      if (!zb_zgp_sink_table_non_empty_entries_count())
      {
      ...
      {
        ZB_SCHEDULE_CALLBACK(test_send_command, 0);
      }
      break;
