 ...
 * DSR.
 */
/* PURPOSE: TH gps2 (sink 2)
*/

#define ZB_TEST_NAME GPP_DECOMMISSIONING_PRECOMM_GROUPCAST_TH_GPS2
#define ZB_TRACE_FILE_ID 41462
...
enum test_states_e
{
    ...
    /* waiting for TEST_GPS2_TEST_PROCEDURE_START_DELAY */
...
static void send_zcl(zb_uint8_t buf_ref, zb_callback_t cb)
{
    ...
    case TEST_STATE_INIT_CREATE_PAIRING_ON_DUT:
        ...
        ZB_ZGPC_SET_PAUSE(TEST_GPS2_TEST_PROCEDURE_START_DELAY);
        break;
...
static void zgpc_send_pairing(zb_uint8_t param, zb_bool_t add_sink)
{
    ...
    ent.u.sink.sgrp[0].sink_group = SINK_GROUP_MMMM;
