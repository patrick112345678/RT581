 ...
 * DSR.
 */
/* PURPOSE: Simple GPS for GP device
*/

#define ZB_TEST_NAME GPP_PERSISTENT_STORAGE_TH_GPS
#define ZB_TRACE_FILE_ID 41485
#include "zb_common.h"
...
static zb_ieee_addr_t g_zr_addr = TH_GPS_IEEE_ADDR;
...
ZB_ZGPC_DECLARE_ZCL_ON_OFF_TOGGLE_TEST_TEMPLATE(TEST_DEVICE_CTX, ENDPOINT, 2000)
...
static void zgpc_custom_startup()
{
  ...
  ZGP_GPS_SECURITY_LEVEL = ZB_ZGP_FILL_GPS_SECURITY_LEVEL(
                            ...
                            1/*ZB_ZGP_DEFAULT_SEC_LEVEL_PROTECTION_WITH_GP_LINK_KEY*/,
