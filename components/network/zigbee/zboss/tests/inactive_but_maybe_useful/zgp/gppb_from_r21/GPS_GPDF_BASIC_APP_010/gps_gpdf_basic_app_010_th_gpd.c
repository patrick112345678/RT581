...
#define ZB_TEST_NAME GPS_GPDF_BASIC_APP_010_TH_GPD
#define ZB_TRACE_FILE_ID 41394
#include "zb_common.h"
...
static zb_ieee_addr_t g_zgpd_zero_addr = {0, 0, 0, 0, 0, 0, 0, 0};
