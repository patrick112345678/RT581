 ...
 * DSR.
 */
/* PURPOSE: Simple ZGPD for send GPDF as described in 2.4.3.7 test specification.
*/

#define ZB_TEST_NAME GPD_COMMISSIONING_SECURITY_TC_LK_DUT_GPD
#define ZB_TRACE_FILE_ID 41349
