...
#define TH_GPCB_IEEE_ADDR {0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb}
#define DUT_GPS_IEEE_ADDR {0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa}

#define DUT_ENDPOINT 10
#define TH_INVALID_EP 112
...
/* DUT and TH Settings */
#define TEST_PARAM_TH_GPCT_START_DELAY (5)
#define TEST_PARAM_TH_GPCT_SHORT_DELAY (5)

#define TEST_PARAM_DUT_GPS_LONG_DELAY (30)

#define TEST_PARAM_TH_GPCT_SHORT_DELAY (5)

#define TEST_PARAM_TH_GPD_SHORT_DELAY (5)
#define TEST_PARAM_TH_GPD_LONG_DELAY  (20)
