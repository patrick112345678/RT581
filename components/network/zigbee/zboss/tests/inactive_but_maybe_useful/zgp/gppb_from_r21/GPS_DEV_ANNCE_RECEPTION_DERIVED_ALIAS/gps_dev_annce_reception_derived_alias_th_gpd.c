 ...
 * DSR.
 */
/* PURPOSE: Simple ZGPD for send GPDF
*/

#define ZB_TEST_NAME GPS_DEV_ANNCE_RECEPTION_DERIVED_ALIAS_TH_GPD
#define ZB_TRACE_FILE_ID 41282
#include "zb_common.h"
...
static zb_uint8_t     g_zgpd_oob_key[] = TEST_OOB_KEY;
...
/* Init device, load IB values from nvram or set it to default */
  ...
  ZB_ZGPD_SET_OOB_KEY(g_zgpd_oob_key);
