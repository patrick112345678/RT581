...
#define ZB_TEST_NAME GPP_TUNNELING_LIGHTWEIGHT_TH_GPT
#define ZB_TRACE_FILE_ID 41456
...
{
  TEST_STATE_INITIAL,
  TEST_STATE_READ_GPP_PROXY_TABLE_INITIAL,
...
static void send_zcl(zb_uint8_t buf_ref, zb_callback_t cb)
{
  ...
  {
    case TEST_STATE_READ_GPP_PROXY_TABLE_INITIAL:
