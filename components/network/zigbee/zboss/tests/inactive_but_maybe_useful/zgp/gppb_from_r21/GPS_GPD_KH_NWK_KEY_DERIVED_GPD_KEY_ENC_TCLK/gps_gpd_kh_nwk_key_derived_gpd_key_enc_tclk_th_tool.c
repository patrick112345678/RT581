...
#define ZB_TEST_NAME GPS_GPD_KH_NWK_KEY_DERIVED_GPD_KEY_ENC_TCLK_TH_TOOL
#define ZB_TRACE_FILE_ID 41317
...
{
  zb_uint8_t new_shared_key_type = ZB_ZGP_SEC_KEY_TYPE_GROUP_NWK_DERIVED;
