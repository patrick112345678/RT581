...
#define TEST_GROUP_KEY { 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0x88, 0x77, 0x66, 0x55, 0x44, 0x33, 0x22 }
#define TEST_CMD_NUM 3

#define TEST_SEC_LEVEL ZB_ZGP_SEC_LEVEL_FULL_WITH_ENC
#define TEST_KEY_TYPE ZB_ZGP_SEC_KEY_TYPE_GROUP
