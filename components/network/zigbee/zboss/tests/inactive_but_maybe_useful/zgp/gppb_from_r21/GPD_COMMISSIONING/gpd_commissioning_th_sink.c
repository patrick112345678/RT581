 ...
 * DSR.
 */
/* PURPOSE: GPPB pairing with DUT GPD
*/

#define ZB_TEST_NAME GPD_COMMISSIONING_TH_SINK
#define ZB_TRACE_FILE_ID 41538
...
static zb_ieee_addr_t g_zc_addr = {0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xab};
