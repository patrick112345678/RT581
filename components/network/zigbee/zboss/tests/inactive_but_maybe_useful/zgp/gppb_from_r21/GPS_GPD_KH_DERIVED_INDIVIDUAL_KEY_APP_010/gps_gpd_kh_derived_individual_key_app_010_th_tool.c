...
#define ZB_TEST_NAME GPS_GPD_KH_DERIVED_INDIVIDUAL_KEY_APP_010_TH_TOOL
#define ZB_TRACE_FILE_ID 41417
...
{
  zb_uint8_t new_shared_key_type = ZB_ZGP_SEC_KEY_TYPE_DERIVED_INDIVIDUAL;
  zb_uint8_t new_key[16] = TEST_SEC_KEY;
...
static void perform_next_state(zb_uint8_t param)
{
  ...
  TRACE_MSG(TRACE_APP1, "perform_next_state: state = %hd", (FMT__H, TEST_DEVICE_CTX.test_state));
...
/* Init device, load IB values from nvram or set it to default */
  ...
  ZGP_GP_SET_SHARED_SECURITY_KEY_TYPE(ZB_ZGP_SEC_KEY_TYPE_GROUP_NWK_DERIVED);
