Test described in GP test specification, 
	...
	sub-clause 4.3.9.3 SecurityLevel 0b11
...
Initial Conditions:
 ...
 - TH-GPD, TH-GPP and DUT-GPS use SecurityLevel 0b11 and 
...
1: TH-GPD sends Data GPDF, with the Extended NWK Frame Control field present,
   the SecurityLevel sub-field set to 0b11, and the payload authenticated with
...
2: Negative test (incorrect frame counter):
   ...
   SecurityLevel sub-field set to 0b11, KeyType sub-field
...
4: Negative test (incorrect key type): TH-GPP sends GP Notification with GPD command
   supported by DUT-GPS, with the SecurityLevel set to 0b11, incorrect KeyType 0b100,
