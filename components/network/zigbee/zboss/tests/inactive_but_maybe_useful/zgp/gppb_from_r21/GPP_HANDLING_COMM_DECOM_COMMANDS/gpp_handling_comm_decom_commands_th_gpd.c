...
#define ZB_TEST_NAME GPP_HANDLING_COMM_DECOM_COMMANDS_TH_GPD
#define ZB_TRACE_FILE_ID 41351
#include "zb_common.h"
...
#if defined(ZB_CERTIFICATION_HACKS) && defined(ZB_ZGPD_ROLE)
...
#else /* ZB_CERTIFICATION_HACKS and ZB_ZGPD_ROLE */
