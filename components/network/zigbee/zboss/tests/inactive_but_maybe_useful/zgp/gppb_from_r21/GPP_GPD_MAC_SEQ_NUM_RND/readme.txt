Test described in GP test specification,
	...
	sub-clause 5.2.3 Random GPD MAC sequence numbers
...
4: Make TH-GPD send a Data GDPF with Sequence Number 0xC9.
...
Fail verdict:
1: 2: 3: 4:
   For at least one of the four Data GPDFs, DUT-GPP does not send 
