...
#define ZB_TEST_NAME GPS_COMMISSIONING_MULTIHOP_ADD_DUT_GPS
#define ZB_TRACE_FILE_ID 41493
...
static void perform_next_state(zb_uint8_t param)
{
    ...
    case TEST_STATE_COMM_MODE_ENTER_3J:
    case TEST_STATE_COMM_MODE_ENTER_3L:
    case TEST_STATE_COMM_MODE_ENTER_4A:
    case TEST_STATE_COMM_MODE_ENTER_4B:
    case TEST_STATE_COMM_MODE_ENTER_5A:
