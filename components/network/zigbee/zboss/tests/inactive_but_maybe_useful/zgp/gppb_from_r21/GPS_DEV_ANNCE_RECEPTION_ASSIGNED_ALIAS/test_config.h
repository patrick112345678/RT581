...
#define TH_TOOL_IEEE_ADDR {0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00}
...
#define TEST_ZGPD_ASN_ALIAS 0x7ACB
#define TEST_ZGPD_MAC_DSN_VALUE 100
#define TEST_ZGPD_SECUR_CNT_VALUE 0x000000F0
#define TH_TOOL_PAIR_CFG_SEND_DELAY  (10 * ZB_TIME_ONE_SECOND)
#define TH_TOOL_DEV_ANNCE_SEND_DELAY (20 * ZB_TIME_ONE_SECOND)
