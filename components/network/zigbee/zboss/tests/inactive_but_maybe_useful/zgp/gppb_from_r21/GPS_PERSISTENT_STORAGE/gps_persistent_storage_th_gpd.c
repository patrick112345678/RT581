...
#define ZB_TEST_NAME GPS_PERSISTENT_STORAGE_TH_GPD
#define ZB_TRACE_FILE_ID 41271
#include "zb_common.h"
...
enum test_states_e
{
  ...
  TEST_STATE_SEND_GPDF1,
  TEST_STATE_SEND_GPDF2,
  TEST_STATE_FINISHED
};
...
static void perform_next_state(zb_uint8_t param)
{
  ...
  switch (TEST_DEVICE_CTX.test_state)
  {
    case TEST_STATE_COMMISSIONING:
      ...
      ZB_ZGPD_SET_PAUSE(TH_GPD_SEND_GPDF1_DELAY);
      break;
...
static void make_gpdf(zb_buf_t *buf, zb_uint8_t **ptr)
{
  ...
  switch (TEST_DEVICE_CTX.test_state)
  {
    case TEST_STATE_SEND_GPDF1:
      ZB_GPDF_PUT_UINT8(*ptr, ZB_GPDF_CMD_TOGGLE);
      ZB_ZGPD_SET_PAUSE(TH_GPD_SEND_GPDF2_DELAY);
      break;
    case TEST_STATE_SEND_GPDF2:
      ZB_GPDF_PUT_UINT8(*ptr, ZB_GPDF_CMD_TOGGLE);
      break;
  }
}
