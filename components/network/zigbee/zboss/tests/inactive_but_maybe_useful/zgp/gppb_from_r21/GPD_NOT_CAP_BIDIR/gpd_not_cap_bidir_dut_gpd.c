...
#define ZB_TEST_NAME GPD_NOT_CAP_BIDIR_DUT_GPD
#define ZB_TRACE_FILE_ID 41467
#include "zb_common.h"
#include "zb_mac.h"
...
static void perform_next_state(zb_uint8_t param)
{
  ...
  TRACE_MSG(TRACE_APP1,
            "DUT-GPD: perform_next_state: state = %d",
            (FMT__D, TEST_DEVICE_CTX.test_state));

  switch (TEST_DEVICE_CTX.test_state)
  {
    case TEST_STATE_SEND_COMMISSIONING:
      {
