Test described in GP test specification, clause 5.3.3.4 Alias derivation. Subcase: SrcID with 2LSB 0x0000
...
5.3.3.4.3 Expected Outcome

Pass verdict:
-  DUT-GPP sends a GP Commissioning Notification with NWK SrcAddr equal to 0x1234 and NWK sequence number
