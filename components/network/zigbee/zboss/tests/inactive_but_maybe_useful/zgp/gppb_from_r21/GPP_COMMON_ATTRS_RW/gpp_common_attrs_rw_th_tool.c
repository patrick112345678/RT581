...
static void next_step(zb_buf_t *zcl_cmd_buf)
{
    ...
    else if (g_test_state == TEST_STATE_WRITE_SHARED_SECURITY_KEY_TYPE)
    {
        val = 0x07;
    ...
    else if (g_test_state == TEST_STATE_READ_SHARED_SECURITY_KEY1 ||
    ...
    else if (g_test_state == TEST_STATE_WRITE_SHARED_SECURITY_KEY)
    {
    ...
    else if (g_test_state == TEST_STATE_READ_LINK_KEY1 ||
    ...
    else if (g_test_state == TEST_STATE_WRITE_LINK_KEY)
    {
    ...
    else if (g_test_state == TEST_STATE_READ_CLUSTER_REVISION)
    {
        zgp_cluster_read_attr(ZB_REF_FROM_BUF(zcl_cmd_buf), DUT_GPPB_ADDR, DUT_GPPB_ADDR_MODE,
