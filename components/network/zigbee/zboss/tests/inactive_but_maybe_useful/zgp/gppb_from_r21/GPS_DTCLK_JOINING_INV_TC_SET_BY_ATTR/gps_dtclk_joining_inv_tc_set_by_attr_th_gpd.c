...
#define ZB_TEST_NAME GPS_DTCLK_JOINING_INV_TC_SET_BY_ATTR_TH_GPD

#define ZB_TRACE_FILE_ID 63477
#include "zb_common.h"
...
static void perform_next_state(zb_uint8_t param)
{
    ...
    case TEST_STATE_COMMISSIONING1:
    {
        ...
        ZB_ZGPD_SET_PAUSE(TEST_GPD_DELAY_BEFORE_STEP3);
        break;
    }
    case TEST_STATE_COMMISSIONING2:
    {
        zb_zgpd_start_commissioning(comm_cb);
        ZB_ZGPD_SET_PAUSE(TEST_GPD_DELAY_BEFORE_STEP4);
        break;
    }
