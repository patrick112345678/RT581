...
#define ZB_TEST_NAME GPP_DEV_ANNCE_RECEPTION_ASSIGNED_ALIAS_TH_ZR
#define ZB_TRACE_FILE_ID 41427
...
static zb_ieee_addr_t g_th_zr_addr = TH_ZR_IEEE_ADDR;
...
/* Init device, load IB values from nvram or set it to default */
  ...
  ZB_IEEE_ADDR_COPY(ZB_PIBCACHE_EXTENDED_ADDRESS(), &g_th_zr_addr);
