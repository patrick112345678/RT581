...
#define ZB_TEST_NAME GPS_COMMISSIONING_MULTIHOP_UNIDIR_APP_000_TH_GPD
#define ZB_TRACE_FILE_ID 41384
...
static void perform_next_state(zb_uint8_t param)
{
    ...
    case TEST_STATE_COMMISSIONING2:
        ZGPD->id.app_id = ZB_ZGP_APP_ID_0010;
        ...
        g_zgpd_ctx.id.endpoint = TEST_EP_FOR_APP_010;
        ...
        ZGPD->security_frame_counter = MAC_PIB().mac_dsn;
