...
#define ZB_TEST_NAME GPS_GPDF_SECURITY_10_APP_010_TH_TOOL
#define ZB_TRACE_FILE_ID 41294
...
static void perform_next_state(zb_uint8_t param)
{
  ...
  switch (TEST_DEVICE_CTX.test_state)
  {
    ...
    default:
    {
      ...
      ZB_SCHEDULE_ALARM(test_send_command, 0, (zb_time_t)(3 * ZB_TIME_ONE_SECOND));
    }
  }
}
