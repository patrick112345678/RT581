...
#define ZB_TEST_NAME GPD_COMMISSIONING_SECURITY_111_TH_GPS
#define ZB_TRACE_FILE_ID 41436
...
static zb_ieee_addr_t g_zc_addr = TH_GPS_IEEE_ADDR;
static zb_uint8_t g_key_nwk[] = { 0xab, 0xcd, 0xef, 0x01, 0x23, 0x45, 0x67, 0x89, 0, 0, 0, 0, 0, 0, 0, 0};
static zb_uint8_t g_shared_key[] = { 0xc0, 0xc1, 0xc2, 0xc3, 0xc4, 0xc5, 0xc6, 0xc7, 0xc8, 0xc9, 0xca, 0xcb, 0xcc, 0xcd, 0xce, 0xcf };
...
static void zgpc_custom_startup()
{
  ...
  ZGP_GP_SET_SHARED_SECURITY_KEY_TYPE(ZB_ZGP_SEC_KEY_TYPE_DERIVED_INDIVIDUAL);
