...
#define ZB_TEST_NAME GPS_COMMISSIONING_SHARED_KEY_RD_APP_010_TH_TOOL
#define ZB_TRACE_FILE_ID 41296
...
{
    zb_uint8_t new_shared_key_type = ZB_ZGP_SEC_KEY_TYPE_GROUP;
