...
#define DUT_ACTIONS_WINDOW   (25)
#define DUT_COMM_WINDOW      (15)

#define TH_TOOL_SMALL_WINDOW     (8)
#define TH_TOOL_MEDIUM_WINDOW    (16)

#define TH_GPD_START_TEST_SHIFT (3)
#define TH_GPD_SMALL_WINDOW     (10)
#define TH_GPD_MEDIUM_WINDOW    (15)
#define TH_GPD_LARGE_WINDOW     (25)
