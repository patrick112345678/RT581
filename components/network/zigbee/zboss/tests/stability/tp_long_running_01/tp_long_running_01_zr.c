...
#define ZB_TEST_NAME TP_LONG_RUNNING_01_TH_ZR1
...
#include "tp_long_running_01_zr.h"
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST(tp_long_running_01_zr_basic_attr_list, &attr_zcl_version, &attr_power_source);

/* Identify cluster attributes data */
static zb_uint16_t attr_identify_time = ZB_ZCL_IDENTIFY_IDENTIFY_TIME_DEFAULT_VALUE;

ZB_ZCL_DECLARE_IDENTIFY_ATTRIB_LIST(tp_long_running_01_zr_identify_attr_list, &attr_identify_time);

/********************* Declare device **************************/
DECLARE_ZR_CLUSTER_LIST(tp_long_running_01_zr_device_clusters,
                        tp_long_running_01_zr_basic_attr_list,
                        tp_long_running_01_zr_identify_attr_list);

DECLARE_ZR_EP(tp_long_running_01_zr_device_ep,
              ZR_ENDPOINT,
              tp_long_running_01_zr_device_clusters);

DECLARE_ZR_CTX(tp_long_running_01_zr_device_ctx, tp_long_running_01_zr_device_ep);
/*************************************************************************/
