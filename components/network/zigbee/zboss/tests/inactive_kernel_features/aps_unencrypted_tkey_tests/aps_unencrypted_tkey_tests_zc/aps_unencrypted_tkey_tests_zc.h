...
#define APS_UNENCRYPTED_TKEY_TESTS_DEVICES 5
...
typedef struct aps_unencrypted_tkey_tests_zc_ctx_s
{
    ...
    aps_unencrypted_tkey_tests_zc_button_t button_open_net;
    ...
    aps_unencrypted_tkey_tests_zc_button_t button_close_net;
