...
#ifndef ZB_SE_ESI_MOD_H
#define ZB_SE_ESI_MOD_H 1
...
/** @def ZB_SE_ESI_MOD_DEV_IN_CLUSTER_NUM
 *  @brief ESI IN clusters number
 */
#define ZB_SE_ESI_MOD_DEV_IN_CLUSTER_NUM  10

/** @def ZB_SE_ESI_MOD_DEV_OUT_CLUSTER_NUM
 *  @brief ESI OUT clusters number
 */
#define ZB_SE_ESI_MOD_DEV_OUT_CLUSTER_NUM 3

/** @def ZB_SE_ESI_MOD_DEV_CLUSTER_NUM
 *  @brief Number of clusters for ESI SE device
 */
#define ZB_SE_ESI_MOD_DEV_CLUSTER_NUM \
  (ZB_SE_ESI_MOD_DEV_IN_CLUSTER_NUM + ZB_SE_ESI_MOD_DEV_OUT_CLUSTER_NUM)

/** @def ZB_SE_ESI_MOD_DEV_REPORT_ATTR_COUNT
 *  @brief Number of attributes for reporting on ESI device
 */
#define ZB_SE_ESI_MOD_DEV_REPORT_ATTR_COUNT 0
...
#undef ZB_SE_ESI_MOD_DEV_IN_CLUSTER_NUM
#define ZB_SE_ESI_MOD_DEV_IN_CLUSTER_NUM  11
...
/** @def ZB_SE_DECLARE_ESI_MOD_DEV_CLUSTER_LIST
 ...
 */
#define ZB_SE_DECLARE_ESI_MOD_DEV_CLUSTER_LIST(cluster_list_name,    \
                                                                basic_attr_list,      \
                                                                kec_attr_list,        \
                                                                price_attr_list,      \
                                                                time_attr_list,       \
...
/** @def ZB_ZCL_DECLARE_ESI_MOD_DEV_SIMPLE_DESC
 ...
 */
#define ZB_ZCL_DECLARE_ESI_MOD_DEV_SIMPLE_DESC(ep_name,       \
                                                ep_id,                         \
                                                in_clust_num,                  \
...
/** @def ZB_SE_DECLARE_ESI_MOD_DEV_EP
 *  @brief Declare endpoint for ESI device
 *  @param ep_name - endpoint variable name
 *  @param ep_id - endpoint ID
 *  @param cluster_list - endpoint cluster list
 */
#define ZB_SE_DECLARE_ESI_MOD_DEV_EP(ep_name, ep_id, cluster_list)           \
  ZB_ZCL_DECLARE_ESI_MOD_DEV_SIMPLE_DESC(ep_name,                            \
                                          ep_id,                                              \
                                          ZB_SE_ESI_MOD_DEV_IN_CLUSTER_NUM,  \
                                          ZB_SE_ESI_MOD_DEV_OUT_CLUSTER_NUM, \
...
/** @def ZB_SE_DECLARE_ESI_MOD_DEV_CTX
 *  @brief Declare ESI device context.
 *  @param device_ctx_name - device context variable name.
 *  @param ep_name - endpoint variable name.
 */
#define ZB_SE_DECLARE_ESI_MOD_DEV_CTX(device_ctx_name, ep_name) \
