...
/* For MM testing */
#if 0//defined ZB_SUBGHZ_BAND_ENABLED
...
ZB_SE_DECLARE_ESI_MOD_DEV_CLUSTER_LIST(esi_dev_clusters,
                                       basic_attr_list,
                                       kec_attr_list,
                                       price_attr_list,
                                       time_attr_list,
...
ZB_SE_DECLARE_ESI_MOD_DEV_EP(esi_dev_ep, ESI_DEV_ENDPOINT, esi_dev_clusters);

ZB_SE_DECLARE_ESI_MOD_DEV_CTX(esi_dev_zcl_ctx, esi_dev_ep);
...
void esi_schedule_service_discovery(zb_uint8_t param)
{
    ZVUNUSED(param);
...
void zboss_signal_handler(zb_uint8_t param)
{
    ...
    if (ZB_GET_APP_SIGNAL_STATUS(param) == 0)
    {
        ...
        case ZB_SIGNAL_DEVICE_REBOOT:
            ...
            ZB_SCHEDULE_ALARM(esi_schedule_service_discovery, 0, 7 * ZB_TIME_ONE_SECOND);
