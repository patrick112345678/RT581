...
#define ZB_TEST_NAME TP_PRO_BV_43_ZC

#define APS_FRAGMENTATION

#define ZB_TRACE_FILE_ID 63742
#include "zb_common.h"
...
#define TP_PRO_BV_43_STEP_1_DELAY_ZC  (360 * ZB_TIME_ONE_SECOND)
#define TP_PRO_BV_43_STEP_1_TIME_ZC   (5 * ZB_TIME_ONE_SECOND)
...
#endif
            test_step_register(send_frag_data_delayed, 0, TP_PRO_BV_43_STEP_1_TIME_ZC);
            test_control_start(TEST_MODE, TP_PRO_BV_43_STEP_1_DELAY_ZC);
        }
