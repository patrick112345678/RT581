...
//JJ
void zb_console_monitor_rx_handler(zb_uint8_t s1ymbol);
...
//JJ
void zb_console_monitor_init(void)
{
...
//JJ
void zb_console_monitor_deinit(void)
{
#if defined ZB_NSNG
...
//JJ
static void zb_console_monitor_send_invintation(void)
{
    zb_console_monitor_pkt_t monitor_pkt;
    zb_time_t time;
...
zb_uint8_t zb_console_monitor_get_cmd(zb_uint8_t *buffer, zb_uint8_t max_lenght)
{
    ...
    while (!gs_console_ctx.cmd_recvd)
    {
        ...
        //JJ zb_console_monitor_send_invintation();
...
//JJ
void zb_console_monitor_rx_handler(zb_uint8_t symbol)
{
    /* Echo */
