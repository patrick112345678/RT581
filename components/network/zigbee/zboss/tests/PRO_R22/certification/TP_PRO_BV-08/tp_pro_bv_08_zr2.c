...
#define ZB_TEST_NAME TP_PRO_BV_08_ZR2
#define ZB_TRACE_FILE_ID 40613
...
static zb_ieee_addr_t g_ieee_up = {0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00};
static zb_ieee_addr_t g_ieee_down = {0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00};
