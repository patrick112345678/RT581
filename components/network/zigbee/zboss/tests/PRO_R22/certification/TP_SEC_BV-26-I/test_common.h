...
/* PURPOSE:
*/
#ifndef ___SEC____TEST_COMMON_26_
#define ___SEC____TEST_COMMON_26_
...
/* Timeout setup  */
#define TP_SEC_BV_26_I_STEP_1_DELAY_ZC  (20 * ZB_TIME_ONE_SECOND)
#define TP_SEC_BV_26_I_STEP_1_TIME_ZC   (5 * ZB_TIME_ONE_SECOND)
#define TP_SEC_BV_26_I_STEP_3_TIME_ZC   (5 * ZB_TIME_ONE_SECOND)
#define TP_SEC_BV_26_I_STEP_5_TIME_ZC   (5 * ZB_TIME_ONE_SECOND)
#define TP_SEC_BV_26_I_STEP_6_DELAY_ZED  (35 * ZB_TIME_ONE_SECOND)
#define TP_SEC_BV_26_I_STEP_6_TIME_ZED   (5 * ZB_TIME_ONE_SECOND)
