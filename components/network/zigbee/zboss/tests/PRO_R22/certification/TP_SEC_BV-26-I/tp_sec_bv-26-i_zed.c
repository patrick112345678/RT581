...
#define ZB_TEST_NAME TP_SEC_BV_26_I_ZED
#define ZB_TRACE_FILE_ID 40516
#include "zb_common.h"
    ...
    case ZB_ZDO_SIGNAL_DEFAULT_START:
        if (ZB_GET_APP_SIGNAL_STATUS(param) == 0)
        {
            ...
            if (is_first_start)
            {
                ...
                test_step_register(rejoin_me, 0, TP_SEC_BV_26_I_STEP_6_TIME_ZED);

                test_control_start(TEST_MODE, TP_SEC_BV_26_I_STEP_6_DELAY_ZED);
            }
        }
        else
        {
...
static void rejoin_me(zb_uint8_t param)
{
    ...
    if (buf)
    {
        ...
        /* permit turbo poll after rejoin: polling once per 5 sec (default long poll
