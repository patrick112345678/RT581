 ...
 * DSR.
 */
/* PURPOSE: DUT ZED (binding table size)
*/

#define ZB_TEST_NAME TP_BDB_FB_PRE_TC_07_DUT_ED
#define ZB_TRACE_FILE_ID 40797
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST(fb_pre_tc_07_dut_ed_basic_attr_list, &attr_zcl_version, &attr_power_source);

/* Identify cluster attributes data */
static zb_uint16_t attr_identify_time = 0;

ZB_ZCL_DECLARE_IDENTIFY_ATTRIB_LIST(fb_pre_tc_07_dut_ed_identify_attr_list, &attr_identify_time);
...
ZB_ZCL_DECLARE_TEMP_MEASUREMENT_ATTRIB_LIST(fb_pre_tc_07_dut_ed_temp_meas_attr_list,
                                            &attr_temp_value,
                                            &attr_min_temp_value,
                                            &attr_max_temp_value,
                                            &attr_temp_tolerance);
...
ZB_ZCL_DECLARE_ILLUMINANCE_MEASUREMENT_ATTRIB_LIST(fb_pre_tc_07_dut_ed_illum_meas_attr_list,
                                                   &attr_illum_value,
...
ZB_ZCL_DECLARE_REL_HUMIDITY_MEASUREMENT_ATTRIB_LIST(fb_pre_tc_07_dut_ed_rel_humidity_meas_attr_list,
...
/********************* Declare device **************************/
DECLARE_DUT_CLUSTER_LIST(fb_pre_tc_07_dut_ed_device_clusters,
                         fb_pre_tc_07_dut_ed_basic_attr_list,
                         fb_pre_tc_07_dut_ed_identify_attr_list,
                         fb_pre_tc_07_dut_ed_temp_meas_attr_list,
                         fb_pre_tc_07_dut_ed_illum_meas_attr_list,
                         fb_pre_tc_07_dut_ed_rel_humidity_meas_attr_list);

DECLARE_DUT_EP(fb_pre_tc_07_dut_ed_device_ep,
               DUT_ENDPOINT,
               fb_pre_tc_07_dut_ed_device_clusters);

DECLARE_DUT_CTX(fb_pre_tc_07_dut_ed_device_ctx, fb_pre_tc_07_dut_ed_device_ep);
/*************************************************************************/
...
MAIN()
{
  ...
  ZB_AF_REGISTER_DEVICE_CTX(&fb_pre_tc_07_dut_ed_device_ctx);
