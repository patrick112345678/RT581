 ...
 * DSR.
 */
/* PURPOSE: DUT ZR (binding table size)
*/

#define ZB_TEST_NAME TP_BDB_FB_PRE_TC_07_DUT_R
#define ZB_TRACE_FILE_ID 40799
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST(fb_pre_tc_07_dut_r_basic_attr_list, &attr_zcl_version, &attr_power_source);

/* Identify cluster attributes data */
static zb_uint16_t attr_identify_time = 0;

ZB_ZCL_DECLARE_IDENTIFY_ATTRIB_LIST(fb_pre_tc_07_dut_r_identify_attr_list, &attr_identify_time);
...
/********************* Declare device **************************/
DECLARE_DUT_CLUSTER_LIST(fb_pre_tc_07_dut_r_device_clusters,
                         fb_pre_tc_07_dut_r_basic_attr_list,
                         fb_pre_tc_07_dut_r_identify_attr_list,
                         fb_pre_tc_07_dut_r_temp_meas_attr_list,
                         fb_pre_tc_07_dut_r_illum_meas_attr_list,
                         fb_pre_tc_07_dut_r_rel_humidity_meas_attr_list);

DECLARE_DUT_EP(fb_pre_tc_07_dut_r_device_ep,
               DUT_ENDPOINT,
               fb_pre_tc_07_dut_r_device_clusters);

DECLARE_DUT_CTX(fb_pre_tc_07_dut_r_device_ctx, fb_pre_tc_07_dut_r_device_ep);
/*************************************************************************/
