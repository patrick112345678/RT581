 ...
 * DSR.
 */
/* PURPOSE: TP_BDB_CS_TCP_TC_01B_DUTZR ZigBee Router (DUT ZR): forming Distributed Network
*/

#define ZB_TEST_NAME TP_BDB_CS_TCP_TC_01B_DUTZR
#define ZB_TRACE_FILE_ID 40043
...
MAIN()
{
  ...
  /* Set well-known nwk key set in wireshark */
