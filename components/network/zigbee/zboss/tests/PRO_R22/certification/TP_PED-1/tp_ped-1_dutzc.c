 ...
 * DSR.
 */
/* PURPOSE: TP_PED_1 ZigBee Coordinator (DUT)
*/

#define ZB_TEST_NAME TP_PED_1_DUTZC
#define ZB_TRACE_FILE_ID 40903
...
MAIN()
{
  ...
  ZB_CERT_HACKS().disable_addr_req_on_neighbor_move = 1;
