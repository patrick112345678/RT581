TP/PED-13 Child Table Management: Parent Announcement – Current Parent
...
4.	Turn-on gZR1
5.	gZR send Buffer Test Request to gZED
...
10.	gZR1 sends an End Device Timeout Response to DUT ZED, with “Status” as SUCCESS and “Parent information End Device Timeout Keep alive Supported” as TRUE.
11.	gZED sends an End Device Timeout Request to gZR1, atleast once in every End Device Timeout duration.
12.	gZR1 sends an End Device Timeout Response to DUT ZED, with “Status” as SUCCESS and “Parent information End Device Timeout Keep alive Supported” as TRUE.
...
17.	DUT ZC sends an End Device Timeout Response to DUT ZED, with “Status” as SUCCESS and “Parent information - End Device Timeout Keep alive Supported” as TRUE.
18.	gZED sends an End Device Timeout Request to DUT ZC, at least once in every End Device Timeout duration.
19.	DUT ZC sends an End Device Timeout Response to gZED, with “Status” as SUCCESS and “Parent information - End Device Timeout Keep alive Supported” as TRUE.
20.	gZR1 sends Parent_annce with gZED’s age detail.
21.	DUT ZC sends Parent_annce_Resp with gZED’s age detail, to gZR1.
22.	gZR1 compares the gZED’s local age and received age. And deletes the DUT ZED info from Neighbor Table.
23.	DUT ZC deletes the gZED info from Neighbor Table. This is verified by gZR querying DUT ZC’s neighbortable by sending as many mgmt_lqi_req commands as necessary to reveal DUT ZC’s complete neighbour table.
24.	DUT ZC replies for Route Request  on behalf of gZED; and DUT ZC forwards the Buffer Test Request to gZED
25.	gZED sends Buffer Test Response to DUT ZC.
...
7.	DUT ZC does not send an Transport-Key (NWK key) command to gZED, or gZC does not encrypt the Transport-Key (NWK key) at APS level.
...
10.	gZR1 does not send an End Device Timeout Response to DUT ZED; or the “Status” is not SUCCESS; or the “Parent information End Device Timeout Keep alive Supported” as FALSE.
11.	gZED does not send an End Device Timeout Request to gZR1, atleast once in every End Device Timeout duration.
12.	gZR1 does not send an End Device Timeout Response to DUT ZED; or the “Status” is not SUCCESS; or the “Parent information End Device Timeout Keep alive Supported” as FALSE.
13.	gZR1 sends MAC ACK for gZED’s End Device Timeout Request
...
17.	DUT ZC does not send an End Device Timeout Response to DUT ZED; or the “Status” is not SUCCESS; or the “Parent information - End Device Timeout Keep alive Supported” as FALSE.
18.	gZED does not send an End Device Timeout Request to DUT ZC, atleast once in every End Device Timeout duration.
19.	DUT ZC does not send an End Device Timeout Response to gZED; or the “Status” is not SUCCESS; or the “Parent information - End Device Timeout Keep alive Supported” as FALSE.
20.	gZR1 does not send Parent_annce with gtZED details.
...
23.	DUT ZC does not delete gZED info from Neighbor Table.
24.	DUT ZC does not reply for Route Request  on behalf of gZED; DUT ZC does not forward the Buffer Test Request to gZED; or gZR1 replies for Route Request  on behalf of gZED
25.	gZED does not send Buffer Test Response to DUT ZC.
