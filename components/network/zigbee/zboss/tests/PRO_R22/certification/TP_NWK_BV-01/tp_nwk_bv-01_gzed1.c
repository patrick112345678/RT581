...
#define ZB_TEST_NAME TP_NWK_BV_01_GZED1
#define ZB_TRACE_FILE_ID 40845
...
static zb_ieee_addr_t d_ieee_addr = {0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00};
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    if (0 == status)
    {
        ...
        case ZB_BDB_SIGNAL_DEVICE_REBOOT:
            ...
            ZB_SCHEDULE_ALARM(start_get_short_addr, 0, ZB_TIME_ONE_SECOND * 20);
            break;
