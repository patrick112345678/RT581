 ...
 * DSR.
 */
/* PURPOSE: TP_R21_BV-19 gZED2
*/

#define ZB_TEST_NAME TP_PED_7_GZED2
#define ZB_TRACE_FILE_ID 40882
...
static const zb_ieee_addr_t g_ieee_addr_gzed2 = IEEE_ADDR_gZED2;
...
MAIN()
{
    ...
    /* set ieee addr */
    zb_set_long_address(g_ieee_addr_gzed2);
