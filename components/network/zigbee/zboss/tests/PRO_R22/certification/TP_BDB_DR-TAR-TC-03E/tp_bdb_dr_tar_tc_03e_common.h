...
/* PURPOSE:
*/
#ifndef __TP_BDB_DR_TAR_TC_03E_
#define __TP_BDB_DR_TAR_TC_03E_
...
#define THR1_START_TEST_DELAY (5 * ZB_TIME_ONE_SECOND)
#define THR2_SEND_LEAVE_TO_DUT_DELAY (10 * ZB_TIME_ONE_SECOND)

#endif /* __TP_BDB_DR_TAR_TC_03E_ */
