...
#define ZB_TEST_NAME TP_BDB_DR_TAR_TC_03E_THR1
#define ZB_TRACE_FILE_ID 40789
...
static void buffer_manager(zb_uint8_t idx)
{
    ...
    {
    case 0:
        zb_buf_get_out_delayed_ext(construct_and_send_leave,
                                   TEST_OVERRIDE_REQUEST | TEST_HAS_DST_IEEE_ADDR, 0);
        /* BREAK */
        break;
...
static void construct_and_send_leave(zb_uint8_t param, zb_uint16_t options)
{
    ...
    *lp = 0;
    ...
    value = zb_buf_get_tail(param, sizeof(zb_uint8_t));
    *value = ZB_NWK_INTERNAL_LEAVE_CONFIRM_AT_DATA_CONFIRM_HANDLE;
