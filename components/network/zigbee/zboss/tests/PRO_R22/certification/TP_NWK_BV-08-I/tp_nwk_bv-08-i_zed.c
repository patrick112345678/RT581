 ...
 * DSR.
 */
/* PURPOSE: TP/NWK/BV-08-I Network Broadcast to Coordinator
*/

#define ZB_TEST_NAME TP_NWK_BV_08_I_ZED
#define ZB_TRACE_FILE_ID 40731
#include "zb_common.h"
...
MAIN()
{
    ...
    /* Poll once per 3s instead of once per 5s */
