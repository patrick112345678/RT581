 ...
 * DSR.
 */
/* PURPOSE: DUT ZC - not requiring TCLK update
*/

#define ZB_TEST_NAME TP_BDB_CS_NFS_TC_04_DUT
#define ZB_TRACE_FILE_ID 40894
...
static void trigger_steering(zb_uint8_t unused)
{
    ...
    ZB_SCHEDULE_ALARM(trigger_steering, 0, MIN_COMMISSIONINIG_TIME_DELAY);
}
