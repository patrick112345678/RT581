...
/* PURPOSE:
*/
#ifndef __TP_BDB_FB_CDP_TC_01_
#define __TP_BDB_FB_CDP_TC_01_

#define IEEE_ADDR_DUT {0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa}
#define IEEE_ADDR_OTHER {0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb, 0xbb}
...
#define TEST_DUT_START_COMMUNICATION_DELAY  (100 * ZB_TIME_ONE_SECOND)
#define TEST_THR1_WAITS_DUT_DELAY           (60 * ZB_TIME_ONE_SECOND)
#define TEST_STARTUP_DELAY                  (20 * ZB_TIME_ONE_SECOND)
