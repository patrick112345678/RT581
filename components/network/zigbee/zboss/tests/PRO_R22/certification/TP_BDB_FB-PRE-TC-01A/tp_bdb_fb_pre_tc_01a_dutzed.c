...
#define ZB_TEST_NAME TP_BDB_FB_PRE_TC_01A_DUTZED
#define ZB_TRACE_FILE_ID 40638
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST(fb_pre_tc_01a_dut_ed_basic_attr_list, &attr_zcl_version, &attr_power_source);

/* Identify cluster attributes data */
static zb_uint16_t attr_identify_time = 0;

ZB_ZCL_DECLARE_IDENTIFY_ATTRIB_LIST(fb_pre_tc_01a_dut_ed_identify_attr_list, &attr_identify_time);


/********************* Declare device **************************/
DECLARE_SHADE_CONTROLLER_CLUSTER_LIST(fb_pre_tc_01a_dut_ed_shade_controller_clusters,
                                      fb_pre_tc_01a_dut_ed_basic_attr_list,
                                      fb_pre_tc_01a_dut_ed_identify_attr_list);

DECLARE_SHADE_CONTROLLER_EP(fb_pre_tc_01a_dut_ed_shade_controller_ep,
                            DUT_ENDPOINT,
                            fb_pre_tc_01a_dut_ed_shade_controller_clusters);

DECLARE_SHADE_CONTROLLER_CTX(fb_pre_tc_01a_dut_ed_shade_controller_ctx,
                             fb_pre_tc_01a_dut_ed_shade_controller_ep);
...
MAIN()
{
  ...
  /* ZB_AF_REGISTER_DEVICE_CTX(&fb_pre_tc_01a_dut_ed_shade_controller_ctx); */
