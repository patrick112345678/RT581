...
#define ZB_TEST_NAME TP_BDB_FB_PRE_TC_01A_DUTZC
#define ZB_TRACE_FILE_ID 40053
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST(fb_pre_tc_01a_dut_c_basic_attr_list, &attr_zcl_version, &attr_power_source);

/* Identify cluster attributes data */
static zb_uint16_t attr_identify_time = 0;

ZB_ZCL_DECLARE_IDENTIFY_ATTRIB_LIST(fb_pre_tc_01a_dut_c_identify_attr_list, &attr_identify_time);


/********************* Declare device **************************/
DECLARE_SHADE_CONTROLLER_CLUSTER_LIST(fb_pre_tc_01a_dut_c_shade_controller_clusters,
                                      fb_pre_tc_01a_dut_c_basic_attr_list,
                                      fb_pre_tc_01a_dut_c_identify_attr_list);

DECLARE_SHADE_CONTROLLER_EP(fb_pre_tc_01a_dut_c_shade_controller_ep,
                            DUT_ENDPOINT,
                            fb_pre_tc_01a_dut_c_shade_controller_clusters);

DECLARE_SHADE_CONTROLLER_CTX(fb_pre_tc_01a_dut_c_shade_controller_ctx,
                             fb_pre_tc_01a_dut_c_shade_controller_ep);
...
MAIN()
{
    ...
    /* ZB_AF_REGISTER_DEVICE_CTX(&fb_pre_tc_01a_dut_c_shade_controller_ctx); */
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    case ZB_BDB_SIGNAL_DEVICE_REBOOT:
        ...
        if (status == 0)
        {
            /*  do not need to restart dut zc on test step 2A as it breaks the test
             *  next test step called in test_ieee_addr_req_cb()
             */
...
static void test_ieee_addr_req(zb_uint8_t param)
{
    ...
    zb_zdo_ieee_addr_req(param, test_ieee_addr_req_cb);
}
...
static void test_ieee_addr_req_cb(zb_uint8_t param)
{
    ...
    ZB_SCHEDULE_CALLBACK(send_active_ep_req, param);
    //ZB_SCHEDULE_ALARM(test_buffer_manager, 0, DUT_TEST_DELAY);
