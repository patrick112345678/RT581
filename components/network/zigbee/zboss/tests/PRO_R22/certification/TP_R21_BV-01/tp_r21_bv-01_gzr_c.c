 ...
 * DSR.
 */
/* PURPOSE: TP/R21/BV-02 - Router (gZR) for centralized network - join to network started by DUT ZC.
*/


#define ZB_TEST_NAME TP_R21_BV_01_GZR_C
#define ZB_TRACE_FILE_ID 40524
#include "zb_common.h"
