...
#define ZB_TEST_NAME TP_BDB_FB_PRE_TC_03A_DUT_ED
#define ZB_TRACE_FILE_ID 40057
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST(fb_pre_tc_03a_dut_ed_basic_attr_list, &attr_zcl_version, &attr_power_source);

/* Identify cluster attributes data */
static zb_uint16_t attr_identify_time = 0;

ZB_ZCL_DECLARE_IDENTIFY_ATTRIB_LIST(fb_pre_tc_03a_dut_ed_identify_attr_list, &attr_identify_time);

static zb_bool_t attr_on_off = 1;
ZB_ZCL_DECLARE_ON_OFF_ATTRIB_LIST(fb_pre_tc_03a_dut_ed_on_off_attr_list, &attr_on_off);

/********************* Declare device **************************/
DECLARE_ON_OFF_SERVER_CLUSTER_LIST(fb_pre_tc_03a_dut_ed_on_off_device_clusters,
                                   fb_pre_tc_03a_dut_ed_basic_attr_list,
                                   fb_pre_tc_03a_dut_ed_identify_attr_list,
                                   fb_pre_tc_03a_dut_ed_on_off_attr_list);

DECLARE_ON_OFF_SERVER_EP(fb_pre_tc_03a_dut_ed_on_off_device_ep,
                         DUT_ENDPOINT,
                         fb_pre_tc_03a_dut_ed_on_off_device_clusters);

DECLARE_ON_OFF_SERVER_CTX(fb_pre_tc_03a_dut_ed_on_off_device_ctx, fb_pre_tc_03a_dut_ed_on_off_device_ep);
...
MAIN()
{
    ...
    ZB_AF_REGISTER_DEVICE_CTX(&fb_pre_tc_03a_dut_ed_on_off_device_ctx);
