 ...
 * DSR.
 */
/* PURPOSE: FB-PRE-TC-04C: Service discovery - server side tests (DUT ZC)
*/

#define ZB_TEST_NAME TP_BDB_FB_PRE_TC_04C_DUT_C
#define ZB_TRACE_FILE_ID 40744
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST(fb_pre_tc_04c_dut_c_basic_attr_list,
                                 &attr_zcl_version_epx,
                                 &attr_power_source_epx);

ZB_ZCL_DECLARE_IDENTIFY_ATTRIB_LIST(fb_pre_tc_04c_dut_c_identify_attr_list,
                                    &attr_identify_time_epx);

/********************* Declare device **************************/
DECLARE_TARGET_CLUSTER_LIST(fb_pre_tc_04c_dut_c_target_device_clusters,
                            fb_pre_tc_04c_dut_c_basic_attr_list,
                            fb_pre_tc_04c_dut_c_identify_attr_list);

DECLARE_TARGET_EP(fb_pre_tc_04c_dut_c_target_device_ep,
                  DUT_ENDPOINT,
                  fb_pre_tc_04c_dut_c_target_device_clusters);

DECLARE_TARGET_CTX(fb_pre_tc_04c_dut_c_target_device_ctx, fb_pre_tc_04c_dut_c_target_device_ep);
...
MAIN()
{
    ...
    ZB_AF_REGISTER_DEVICE_CTX(&fb_pre_tc_04c_dut_c_target_device_ctx);
