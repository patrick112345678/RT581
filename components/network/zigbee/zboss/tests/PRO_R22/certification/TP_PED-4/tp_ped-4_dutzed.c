 ...
 * DSR.
 */
/* PURPOSE: TP/PED-4 Child Table Management: Timeout agreement DUT ZED
*/

#define ZB_TEST_NAME TP_PED_4_DUTZED
#define ZB_TRACE_FILE_ID 40795
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    if (status == 0)
    {
        ...
        default:
            TRACE_MSG(TRACE_ERROR, "Unknown signal %hd", (FMT__D, sig));
            break;
        }
    }
    else
