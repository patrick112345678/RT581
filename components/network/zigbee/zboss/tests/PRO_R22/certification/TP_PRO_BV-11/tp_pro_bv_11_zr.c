...
#define ZB_TEST_NAME TP_PRO_BV_11_ZR
#define ZB_TRACE_FILE_ID 40585
...
MAIN()
{
    ...
    case 2:
        ...
        MAC_ADD_VISIBLE_LONG((zb_uint8_t *) g_ieee_addr_r4);
        break;
    ...
    /* Unrecognized device number */
    default:
        TRACE_MSG(TRACE_ERROR, "Error: invalid device index. Exit.", (FMT__0));
        MAIN_RETURN(1);
    }
