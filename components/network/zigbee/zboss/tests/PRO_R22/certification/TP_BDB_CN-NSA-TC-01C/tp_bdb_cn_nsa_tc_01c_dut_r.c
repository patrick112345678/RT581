 ...
 * DSR.
 */
/* PURPOSE: CN-NSA-TC-01C: Mgmt_Permit_Joining_req handling (DUT_R)
*/

#define ZB_TEST_NAME TP_BDB_CN_NSA_TC_01C_DUT_R
#define ZB_TRACE_FILE_ID 40705
...
MAIN()
{
  ...
  zb_cert_test_set_network_addr(TEST_DUT_ZR_SHORT_ADDR);
