 ...
 * DSR.
 */
/* PURPOSE: CN-NSA-TC-01C: Mgmt_Permit_Joining_req handling (THR1)
*/

#define ZB_TEST_NAME TP_BDB_CN_NSA_TC_01C_THR1
#define ZB_TRACE_FILE_ID 40704
#include "zb_common.h"
...
#include "tp_bdb_cn_nsa_tc_01c_common.h"
...
void trigger_steering(zb_uint8_t unused);
...
MAIN()
{
    ...
    /* thr1 does not required to associate to dut */
    MAC_ADD_INVISIBLE_SHORT(0x0000);
    MAC_ADD_INVISIBLE_SHORT(TEST_DUT_ZR_SHORT_ADDR);
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    case ZB_BDB_SIGNAL_DEVICE_REBOOT:
        ...
        else
        {
            ...
            */
            ZB_SCHEDULE_ALARM(trigger_steering, 0, TEST_THR1_TRIGGER_STEERING);
        }
