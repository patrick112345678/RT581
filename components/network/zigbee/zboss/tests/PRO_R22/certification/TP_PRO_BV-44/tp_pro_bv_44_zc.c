...
#define ZB_TEST_NAME TP_PRO_BV_44_ZC
#define ZB_TRACE_FILE_ID 63760
...
#define TP_PRO_BV_44_STEP_1_DELAY_ZC  (360 * ZB_TIME_ONE_SECOND)
#define TP_PRO_BV_44_STEP_1_TIME_ZC   (5 * ZB_TIME_ONE_SECOND)
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    case ZB_ZDO_SIGNAL_DEFAULT_START:
        ...
        if (status == 0)
        {
            ...
            ZB_CERT_HACKS().frag_skip_0_and_2nd_block_1st_time = 1;
#else
            ZB_ASSERT(ZB_FALSE && "TODO: use NCP API here");
#endif

            test_step_register(send_frag_data_delayed, 0, TP_PRO_BV_44_STEP_1_TIME_ZC);
            test_control_start(TEST_MODE, TP_PRO_BV_44_STEP_1_DELAY_ZC);
        }
