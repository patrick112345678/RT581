 ...
 * DSR.
 */
/* PURPOSE: TP_R21_BV-26 ZigBee Router (DUT ZR)
*/

#define ZB_TEST_NAME TP_R21_BV_26_DUTZR
#define ZB_TRACE_FILE_ID 40497
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    if (0 == status)
    {
        ...
        case ZB_BDB_SIGNAL_DEVICE_REBOOT:
            ...
            ZB_SCHEDULE_ALARM(zb_association_permit, 1, 30 * ZB_TIME_ONE_SECOND);
            break;
