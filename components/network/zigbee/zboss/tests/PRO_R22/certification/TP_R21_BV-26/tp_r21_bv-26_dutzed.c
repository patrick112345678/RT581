 ...
 * DSR.
 */
/* PURPOSE: TP_R21_BV-26 Zigbee End Device (DUT ZED)
*/

#define ZB_TEST_NAME TP_R21_BV_26_DUTZED
#define ZB_TRACE_FILE_ID 40498
...
MAIN()
{
  ...
  /* Device should not have routers as neighbors, lets set rx-off-when-idle. */
