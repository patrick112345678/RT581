...
#define ZB_TEST_NAME TP_R22_BV_16_ZC
#define ZB_TRACE_FILE_ID 40075
...
static zb_ieee_addr_t g_zr1_ieee_addr =  {0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00};
...
MAIN()
{
  ...
  MAC_ADD_VISIBLE_LONG(g_zr1_ieee_addr);
