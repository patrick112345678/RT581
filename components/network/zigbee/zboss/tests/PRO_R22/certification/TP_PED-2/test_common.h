...
/* PURPOSE:
*/
#ifndef __TP_R21_BV_15_TEST_COMMON
#define __TP_R21_BV_15_TEST_COMMON
...
/* Time delay between ZC start and sending Test Buffer Request to the
 * DUT ED */
#define TEST_SEND1_DELAY                        (90 * ZB_TIME_ONE_SECOND)

/* Time delay between DUT ZED start and sending Test Buffer Request to the
 * gZED */
#define TEST_SEND2_DELAY                        (120 * ZB_TIME_ONE_SECOND)

#endif  /* __TP_R21_BV_15_TEST_COMMON */
