 ...
 * DSR.
 */
/* PURPOSE: DUT ZED (answering on discovery requests)
*/

#define ZB_TEST_NAME TP_BDB_FB_PRE_TC_02_DUT_ED
#define ZB_TRACE_FILE_ID 40546
...
MAIN()
{
  ...
  /* Start as ED */
  zb_address_update((zb_uint8_t*) g_unknown_ieee_addr, 0x0000, ZB_FALSE, &ref_p);
