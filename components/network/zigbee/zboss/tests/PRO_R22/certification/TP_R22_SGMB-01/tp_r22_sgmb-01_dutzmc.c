 ...
 * DSR.
 */
/* PURPOSE: TP_R22_SGMB_01 ZigBee Coordinator (DUT ZMC)
*/

#define ZB_TEST_NAME TP_R22_SGMB_01_DUTZMC
#define ZB_TRACE_FILE_ID 40560
...
static const zb_ieee_addr_t g_ieee_addr_dutzmc = IEEE_ADDR_DUT_ZMC;

MAIN()
{
  ARGV_UNUSED;

  ZB_INIT("zdo_1_dutzmc");
#if UART_CONTROL	
	test_control_init();
  zb_osif_set_uart_byte_received_cb(zb_console_monitor_rx_next_step);
#endif
	
  zb_set_long_address(g_ieee_addr_dutzmc);
