 ...
 * DSR.
 */
/* PURPOSE: TP_R22_SGMB_01 gZMED
*/

#define ZB_TEST_NAME TP_R22_SGMB_01_GZMED
#define ZB_TRACE_FILE_ID 40558
...
static const zb_ieee_addr_t g_ieee_addr_gzmed = IEEE_ADDR_GZMED;
...
MAIN()
{
    ...
    /* set ieee addr */
    zb_set_long_address(g_ieee_addr_gzmed);
