 ...
 * DSR.
 */
/* PURPOSE: TP_R22_SGMB_01 gZSED
*/

#define ZB_TEST_NAME TP_R22_SGMB_01_GZSED
#define ZB_TRACE_FILE_ID 40559
...
static const zb_ieee_addr_t g_ieee_addr_gzsed = IEEE_ADDR_GZSED;
...
MAIN()
{
    ...
    /* set ieee addr */
    zb_set_long_address(g_ieee_addr_gzsed);
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    case ZB_BDB_SIGNAL_DEVICE_REBOOT:
        ...
        if (status == 0)
        {
            zb_zdo_set_lpd_cmd_mode(ZB_NWK_LPD_REQUEST);
            zb_zdo_set_lpd_cmd_timeout(4);
        }
