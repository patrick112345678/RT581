...
#define ZB_TEST_NAME TP_APS_BV_13_ZED2
#define ZB_TRACE_FILE_ID 40936
...
static zb_ieee_addr_t g_ieee_addr = {0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
static zb_ieee_addr_t g_zr_ieee_addr = {0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00};
