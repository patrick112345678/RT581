 ...
 * DSR.
 */
/* PURPOSE: TP/R21/BV-03 - Coordinator on channel #11 (gZC1)
*/

#define ZB_TEST_NAME TP_R21_BV_03_GZC1
#define ZB_TRACE_FILE_ID 40779
...
MAIN()
{
  ...
  zb_set_network_coordinator_role_legacy(1l << ZC1_CHANNEL);
...
static void send_mac_data(zb_uint8_t param)
{
  ...
  *buf_ptr++ = zb_cert_test_get_mac_tsn(); /* Sequence number */
  ...
  ZB_IEEE_ADDR_COPY(buf_ptr, g_ieee_addr_gzc1);
