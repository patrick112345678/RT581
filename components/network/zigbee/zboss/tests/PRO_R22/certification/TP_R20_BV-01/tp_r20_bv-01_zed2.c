...
#define ZB_TEST_NAME TP_R20_BV_01_ZED2
#define ZB_TRACE_FILE_ID 40856
...
MAIN()
{
  ...
  /*
     NOTE:  Security material is not necessary for gZED2.
     It is expected that gZED2 will not successfully join the network.
  */
