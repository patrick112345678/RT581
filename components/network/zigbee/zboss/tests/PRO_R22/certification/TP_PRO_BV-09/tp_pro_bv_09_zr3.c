...
#define ZB_TEST_NAME TP_PRO_BV_09_ZR3
#define ZB_TRACE_FILE_ID 40702
...
static zb_ieee_addr_t g_ieee_addr = {0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00};
static zb_ieee_addr_t g_ieee_up_1 = {0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00};
static zb_ieee_addr_t g_ieee_up_2 = {0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00};
static zb_ieee_addr_t g_ieee_down = {0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00};

static zb_uint16_t g_nwk_up_1 = 0x0001;
static zb_uint16_t g_nwk_up_2 = 0x0002;
...
MAIN()
{
    ...
    MAC_ADD_VISIBLE_LONG(g_ieee_up_1);
    MAC_ADD_VISIBLE_LONG(g_ieee_up_2);
    MAC_ADD_VISIBLE_LONG(g_ieee_down);

    zb_set_max_children(1);

    zb_set_nvram_erase_at_start(ZB_TRUE);

    add_addr_ent(g_nwk_up_1, g_ieee_up_1);
    add_addr_ent(g_nwk_up_2, g_ieee_up_2);
