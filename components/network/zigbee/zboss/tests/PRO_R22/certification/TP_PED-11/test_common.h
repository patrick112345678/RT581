...
#ifndef __TP_PED_11_TEST_COMMON
#define __TP_PED_11_TEST_COMMON
...
#define TEST_CHECK_DUTZR_NBT_DELAY 	(30 * ZB_TIME_ONE_SECOND)
#define TEST_SEND_BUFFER_TEST_REQ_DELAY	(120 * ZB_TIME_ONE_SECOND)
#define TEST_ZED_POLL_TIMEOUT_MS	(7500)

#define DUTZR_CLOSE_PERMIT_JOIN_DELAY 	(15 * ZB_TIME_ONE_SECOND)

#endif  /* __TP_PED_11_TEST_COMMON */
