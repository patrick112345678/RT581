...
#define ZB_TEST_NAME TP_R20_BV_06_ZC
#define ZB_TRACE_FILE_ID 40880
...
MAIN()
{
    ...
    ZB_CERT_HACKS().disable_unencrypted_update_device = 1;
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    if (0 == status)
    {
        ...
        case ZB_BDB_SIGNAL_DEVICE_REBOOT:
            ...
            ZB_SCHEDULE_ALARM(send_device_remove_ed, 0, 40 * ZB_TIME_ONE_SECOND);
            ZB_SCHEDULE_ALARM(alarm1, 0, 50 * ZB_TIME_ONE_SECOND);
            break;
