...
#define ZB_TEST_NAME TP_R21_BV_12_GZC1
#define ZB_TRACE_FILE_ID 40530
...
static const zb_ieee_addr_t g_ieee_addr_gzc1 = IEEE_ADDR_gZC1;
...
MAIN()
{
    ...
    zb_set_long_address(g_ieee_addr_gzc1);
    zb_set_use_extended_pan_id(g_ext_pan_id1);
    zb_set_pan_id(g_pan_id1);

    /* let's always be coordinator */
    zb_cert_test_set_common_channel_settings();
    zb_cert_test_set_zc_role();
    zb_secur_setup_nwk_key((zb_uint8_t *) g_nwk_key_gzc1, 0);
