...
#define ZB_TEST_NAME TP_R21_BV_12_DUTZR
#define ZB_TRACE_FILE_ID 40527
...
MAIN()
{
    zb_ext_pan_id_t extended_pan_id = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
    ...
    zb_set_use_extended_pan_id(extended_pan_id);
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    if (0 == status)
    {
        ...
        case ZB_BDB_SIGNAL_DEVICE_REBOOT:
            ...
            {
                /* close association on router to prevent
                 * unwanted association of end device */
...
static void test_leave_itself(zb_uint8_t param)
{
    ...
    TRACE_MSG(TRACE_APS1, ">>test_leave_itself", (FMT__0));
