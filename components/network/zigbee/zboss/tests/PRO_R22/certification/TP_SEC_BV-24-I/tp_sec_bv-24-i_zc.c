 ...
 * DSR.
 */
/* PURPOSE: 11.24 TP/SEC/BV-24-I Security NWK Key Swith (No Preconfigured Key)-ZC
Objective: DUT as ZR issues new NWK Key and implements a SWITCH
*/

#define ZB_TEST_NAME TP_SEC_BV_24_I_ZC
#define ZB_TRACE_FILE_ID 40792
#include "zb_common.h"
...
#ifdef TEST_ENABLED
            /* send Transport Key */
            test_step_register(send_tk, 0, TP_SEC_BV_24_I_STEP_1_TIME_ZC);
            /* send Key Switch */
            test_step_register(send_key_switch, 0, TP_SEC_BV_24_I_STEP_3_TIME_ZC);
            /* send Test Buffer Request by the addr 0xFFFF */
            test_step_register(send_data_bc, 0, TP_SEC_BV_24_I_STEP_5_TIME_ZC);

            test_control_start(TEST_MODE, TP_SEC_BV_24_I_STEP_1_DELAY_ZC);
#endif  /* TEST_ENABLED */
