...
/* PURPOSE:
*/
#ifndef ___SEC____TEST_COMMON_24_
#define ___SEC____TEST_COMMON_24_
...
/* Timeout setup  */
#define TP_SEC_BV_24_I_STEP_1_DELAY_ZC  (30 * ZB_TIME_ONE_SECOND)
#define TP_SEC_BV_24_I_STEP_1_TIME_ZC   (5 * ZB_TIME_ONE_SECOND)
#define TP_SEC_BV_24_I_STEP_3_TIME_ZC   (5 * ZB_TIME_ONE_SECOND)
#define TP_SEC_BV_24_I_STEP_5_TIME_ZC   (5 * ZB_TIME_ONE_SECOND)
#define TP_SEC_BV_24_I_STEP_6_DELAY_ZED  (50 * ZB_TIME_ONE_SECOND)
#define TP_SEC_BV_24_I_STEP_6_TIME_ZED   (5 * ZB_TIME_ONE_SECOND)

//#define TIME_ZC_CONNECTION                 (10 * ZB_TIME_ONE_SECOND)
