 ...
 * DSR.
 */
/* PURPOSE: TP_R21_BV-27 ZigBee Router (gZR): joining to centralized network.
*/

#define ZB_TEST_NAME TP_R21_BV_27_GZR_C
#define ZB_TRACE_FILE_ID 40600
...
static void send_mgmt_leave_cmd2(zb_uint8_t param)
{
  ...
  else
  {
    ...
    ZB_SCHEDULE_CALLBACK(send_mgmt_leave_cmd3, param);
  }
