...
/* PURPOSE:
*/
#ifndef __TP_R21_BV_27_TEST_COMMON
#define __TP_R21_BV_27_TEST_COMMON
...
/* Delay between gZR start and sending mgmt_leave */
#define TEST_SEND_LEAVE_CMD_DELAY (30 * ZB_TIME_ONE_SECOND)
#define TEST_SEND_BUFFER_TEST_REQ_DELAY (10 * ZB_TIME_ONE_SECOND)



#endif  /* __TP_R21_BV_27_TEST_COMMON */
