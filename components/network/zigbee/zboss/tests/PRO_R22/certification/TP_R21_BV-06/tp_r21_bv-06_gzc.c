...
#define ZB_TEST_NAME TP_R21_BV_06_GZC
#define ZB_TRACE_FILE_ID 40802
...
/* Key for gZC */
static zb_uint8_t g_nwk_key[16] = { 0xab, 0xcd, 0xef, 0x01, 0x23, 0x45, 0x67, 0x89, 0, 0, 0, 0, 0, 0, 0, 0};
