...
#define ZB_TEST_NAME TP_PRO_BV_06_ZR
#define ZB_TRACE_FILE_ID 40723
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    if (0 == status)
    {
        ...
        case ZB_ZDO_SIGNAL_DEFAULT_START:
        {
            ...
            {
                buf1 = zb_buf_get_out();
                /* 10/22/2019 EE CR:MAJOR Why do we need to send rrec explicitly? Won't it be handled by the internal logic? Why 10s delay? See TC step 2. */
