...
#define ZB_TEST_NAME TP_BDB_FB_PRE_TC_03B_DUT_ED
#define ZB_TRACE_FILE_ID 40771
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST(fb_pre_tc_03b_dut_ed_basic_attr_list,
                                 &attr_zcl_version,
                                 &attr_power_source);

ZB_ZCL_DECLARE_IDENTIFY_ATTRIB_LIST(fb_pre_tc_03b_dut_ed_identify_attr_list, &attr_identify_time);


/********************* Declare device **************************/
DECLARE_INITIATOR_CLUSTER_LIST(fb_pre_tc_03b_dut_ed_initiator_clusters,
                               fb_pre_tc_03b_dut_ed_basic_attr_list,
                               fb_pre_tc_03b_dut_ed_identify_attr_list);

DECLARE_INITIATOR_EP(fb_pre_tc_03b_dut_ed_device_ep_list, DUT_ENDPOINT1, fb_pre_tc_03b_dut_ed_initiator_clusters);

DECLARE_INITIATOR_NO_REP_CTX(fb_pre_tc_03b_dut_ed_initiator_device_ctx, fb_pre_tc_03b_dut_ed_device_ep_list);
...
MAIN()
{
  ...
  ZB_AF_REGISTER_DEVICE_CTX(&fb_pre_tc_03b_dut_ed_initiator_device_ctx);
  ...
  switch (sig)
  {
    case ZB_BDB_SIGNAL_DEVICE_FIRST_START:
      if (status == 0)
      {
        ...
        ZB_SCHEDULE_ALARM(trigger_fb_initiator, 0, DUT_ZR_ZED_FB_FIRST_START_DELAY);
      }
      else
      {
