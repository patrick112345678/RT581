...
static void send_match_desc_req_invalid(zb_bufid_t buf)
{
    ...
    */
    ...
    zb_zdo_match_desc_req(buf, match_desc_invalid_callback);
}
//! [zb_zdo_match_desc_req]
...
static void match_desc_valid_callback(zb_uint8_t param)
{
    ...
    */
    ...
    send_match_desc_req_invalid(param);
}
...
static void send_match_desc_req_valid(zb_bufid_t buf)
{
    ...
    */
    ...
    zb_zdo_match_desc_req(buf, match_desc_valid_callback);
}
//! [zb_zdo_match_desc_req]
...
static void get_node_desc(zb_uint8_t param)
{
    ...
    {
        req = zb_buf_initial_alloc(asdu, sizeof(zb_zdo_node_desc_req_t));
        req->nwk_addr = 0; //send to coordinator
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    if (0 == status)
    {
        ...
        case ZB_BDB_SIGNAL_DEVICE_REBOOT:
            ...
            ZB_SCHEDULE_ALARM(get_node_desc, 0, HW_CONNECTION_DELAY);
            break;
