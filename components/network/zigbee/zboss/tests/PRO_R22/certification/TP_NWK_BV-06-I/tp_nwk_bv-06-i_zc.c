 ...
 * DSR.
 */
/* PURPOSE: TP/NWK/BV-06-I Network Broadcast to Coordinator
*/

#define ZB_TEST_NAME TP_NWK_BV_06_I_ZC
#define ZB_TRACE_FILE_ID 40576
...
static const zb_ieee_addr_t daintree_1 = {0x00, 0x00, 0x6B, 0x00, 0x00, 0x81, 0x22, 0x00};
...
MAIN()
{
  ...
  MAC_ADD_VISIBLE_LONG((zb_uint8_t*) daintree_1);
  ...
  if (0 == status)
  {
    switch(sig)
    {
      ...
      case ZB_BDB_SIGNAL_DEVICE_REBOOT:
        ...
        test_step_register(schedule_test_cmd, BRCAST_TO_ALL, TP_NWK_BV_06_I_STEP_1_TIME_ZC);
        test_step_register(schedule_test_cmd, BRCAST_TO_ZR_ZC, TP_NWK_BV_06_I_STEP_2_TIME_ZC);
        test_step_register(schedule_test_cmd, BRCAST_TO_RX_ON, TP_NWK_BV_06_I_STEP_3_TIME_ZC);
        test_control_start(TEST_MODE, TP_NWK_BV_06_I_STEP_1_DELAY_ZC);
        break;
