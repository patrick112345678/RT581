...
#define ZB_TEST_NAME TP_R22_BV_15_ZC

#define APS_FRAGMENTATION

#define ZB_TRACE_FILE_ID 40076
#include "zb_common.h"
...
#define TEST_TIMEOUT_SEND_TRANSMIT_COUNT_PACKET    30*ZB_TIME_ONE_SECOND
  ...
  switch (sig)
  {
    case ZB_ZDO_SIGNAL_DEFAULT_START:
      ...
      if (status == 0)
      {
        ...
        ZB_SCHEDULE_ALARM(send_frag_data_delayed, 0, TEST_TIMEOUT_SEND_TRANSMIT_COUNT_PACKET);
      }
