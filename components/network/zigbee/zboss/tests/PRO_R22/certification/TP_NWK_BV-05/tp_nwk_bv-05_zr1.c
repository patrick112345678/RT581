...
#define ZB_TEST_NAME TP_NWK_BV_05_ZR1
#define ZB_TRACE_FILE_ID 40758
...
#ifdef ONLY_TWO_DEV_FOR_ROUTERS
    (15 == g_dev_num) ? zb_set_max_children(2) : zb_set_max_children(1);
#else
    zb_set_max_children(1);
    zb_set_nvram_erase_at_start(ZB_TRUE);
#endif /* ONLY_TWO_DEV_FOR_ROUTERS */

    //MAC_ADD_VISIBLE_LONG((zb_uint8_t*) g_ieee_addr_zc);
...
static zb_ret_t test_nvram_write_app_data(zb_uint8_t page, zb_uint32_t pos)
{
    ...
    ds.dev_num = (g_dev_num <= 15) ? g_dev_num : 1;
