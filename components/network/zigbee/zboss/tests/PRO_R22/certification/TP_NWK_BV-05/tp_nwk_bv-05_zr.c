...
#define ZB_TEST_NAME TP_NWK_BV_05_ZR
#define ZB_TRACE_FILE_ID 40756
  ...
  if (0 == status)
  {
    switch(sig)
    {
      ...
      case ZB_BDB_SIGNAL_DEVICE_REBOOT:
        ...
        ZB_SCHEDULE_CALLBACK(test_after_startup_action, param);
        param = 0;
        break;
