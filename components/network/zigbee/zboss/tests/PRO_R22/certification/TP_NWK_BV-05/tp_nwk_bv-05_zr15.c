...
#define ZB_TEST_NAME TP_NWK_BV_05_ZR15
#define ZB_TRACE_FILE_ID 40764
...
MAIN()
{
    ...
    /* set ieee addr */
    zb_set_long_address(g_ieee_addr_r15);
    //MAC_ADD_VISIBLE_LONG((zb_uint8_t*) g_ieee_addr_r14);
    //MAC_ADD_VISIBLE_LONG((zb_uint8_t*) g_ieee_addr_r16);
