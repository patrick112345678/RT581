 ...
 * DSR.
 */
/* PURPOSE: TP_R22_SGMB_02 DUT_ZSED
*/

#define ZB_TEST_NAME TP_R22_SGMB_02_DUTZSED
#define ZB_TRACE_FILE_ID 40492
...
static const zb_ieee_addr_t g_ieee_addr_dutzsed = IEEE_ADDR_DUTZSED;

MAIN()
{
    ARGV_UNUSED;

    ZB_INIT("zdo_2_dutzsed");
#if UART_CONTROL
    test_control_init();
    ...
    /* set ieee addr */
    zb_set_long_address(g_ieee_addr_dutzsed);
