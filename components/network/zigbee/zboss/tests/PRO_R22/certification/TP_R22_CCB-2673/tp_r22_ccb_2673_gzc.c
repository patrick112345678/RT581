 ...
 * DSR.
 */
/* PURPOSE: TP/R22/CCB-2673 Route Error Generation (AODV) test
*/

#define ZB_TEST_NAME TP_R22_CCB_2673_GZC
#define ZB_TRACE_FILE_ID 63974
...
static zb_uint16_t TEST_PAN_ID = 0xABCD;
...
MAIN()
{
    ...
    MAC_ADD_VISIBLE_LONG(g_ieee_addr_gzr1);
