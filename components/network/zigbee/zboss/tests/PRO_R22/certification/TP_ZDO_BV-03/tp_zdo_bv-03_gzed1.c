 ...
 * DSR.
 */
/* PURPOSE: TP/ZDO/BV-03 ZED1
*/

#define ZB_TEST_NAME TP_ZDO_BV_03_ZED1
#define ZB_TRACE_FILE_ID 40668
  ...
  if (0 == status)
  {
    switch(sig)
    {
      ...
      case ZB_BDB_SIGNAL_DEVICE_REBOOT:
        ...
        ZB_SCHEDULE_ALARM(test_nwk_addr_req, 0, 30 * ZB_TIME_ONE_SECOND);

        /* gZED1 ZDO issues NWK_addr_req to the DUT ZDO IEEEAddr=DUT=ZC 64-bit IEEE address; RequestType=0x01; StartIndex=0x00; */
        ZB_SCHEDULE_ALARM(test_nwk_addr_req, 1, 35 * ZB_TIME_ONE_SECOND);
        ...
        ZB_SCHEDULE_ALARM(test_ieee_addr_req, 0, 40 * ZB_TIME_ONE_SECOND);
        ...
        ZB_SCHEDULE_ALARM(test_ieee_addr_req, 1, 45 * ZB_TIME_ONE_SECOND);
        break;
