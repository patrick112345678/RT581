...
#define ZB_TEST_NAME TP_PED_12_ZED
#define ZB_TRACE_FILE_ID 40912
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
    ...
    if (status == 0)
    {
        ...
        case ZB_BDB_SIGNAL_DEVICE_REBOOT:
            ...
            start_fixed_poll(0);
            ZB_SCHEDULE_ALARM(test_change_ed_timeout, ED_AGING_TIMEOUT_10SEC, ZB_TIME_ONE_SECOND * 10);
        ...
        default:
            TRACE_MSG(TRACE_ERROR, "Unknown signal, status FAILED, status %hd", (FMT__H, sig));
            break;
        }
    }
    else
