...
#define ZB_TEST_NAME TP_SEC_BV_27_I_ZED
#define ZB_TRACE_FILE_ID 40854
#include "zb_common.h"
...
ZB_ZDO_STARTUP_COMPLETE(zb_uint8_t param)
{
  ...
  switch (sig)
  {
	...
	if (is_first_start)
	{
	  ...
	  ZB_SCHEDULE_ALARM(start_fixed_poll, 0, ZB_MILLISECONDS_TO_BEACON_INTERVAL(3000));

	  ZB_SCHEDULE_ALARM(rejoin_me, 0, TIME_ZED_REJOIN);
	}
      }
      else
      {
