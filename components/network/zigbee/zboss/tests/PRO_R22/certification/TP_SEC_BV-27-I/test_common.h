...
/* PURPOSE:
*/
#ifndef ___SEC____TEST_COMMON_27_
#define ___SEC____TEST_COMMON_27_
...
#define TIME_ZC_TK1                        ((20 * ZB_TIME_ONE_SECOND) + TIME_ZC_CONNECTION)
#define TIME_ZC_KEY_SWITCH1                ((10 * ZB_TIME_ONE_SECOND) + TIME_ZC_TK1)
