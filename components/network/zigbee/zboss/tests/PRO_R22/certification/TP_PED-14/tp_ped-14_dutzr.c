 ...
 * DSR.
 */
/* PURPOSE: TP/PED-14 Child Table Management: Parent Announcement ??Splitting & Randomization (DUT ZR)
*/

#define ZB_TEST_NAME TP_PED_14_DUTZR
#define ZB_TRACE_FILE_ID 40917
