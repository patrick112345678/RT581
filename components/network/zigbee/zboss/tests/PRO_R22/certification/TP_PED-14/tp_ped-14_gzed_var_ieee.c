 ...
 * DSR.
 */
/* PURPOSE: TP/PED-14 Child Table Management: Parent Announcement – Splitting & Randomization (gZED)
*/

#define ZB_TEST_NAME TP_PED_14_GZED_VAR_IEEE
#define ZB_TRACE_FILE_ID 40914
...
static zb_ieee_addr_t s_ieee_addr = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
