...
#define TARGET_OUT_CLUSTER_NUM 3 /*!<  OUT (client) clusters number */
...
#define DECLARE_TARGET_CTX(device_ctx, ep_list_name)                             \
    ZBOSS_DECLARE_DEVICE_CTX_1_EP(device_ctx, ep_list_name)
