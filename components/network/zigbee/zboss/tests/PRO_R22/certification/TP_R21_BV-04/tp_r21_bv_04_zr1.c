 ...
 * DSR.
 */
/* PURPOSE: TP/R21/BV-04 gZR1. Formate distributed network
*/

#define ZB_TEST_NAME TP_R21_BV_04_ZR1
#define ZB_TRACE_FILE_ID 40623
...
MAIN()
{
    ...
    zb_cert_test_set_network_addr(0x1aaa);
    ...
    /* First network steering, then formation. (see 6.5 Commissioning) */
