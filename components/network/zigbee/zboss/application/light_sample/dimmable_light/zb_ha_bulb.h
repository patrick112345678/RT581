 ...
 * DSR.
 */
/* PURPOSE: HA Bulb device definitions
*/
 ...
 *  @addtogroup ZB_HA_DEFINE_DEVICE_DIMMABLE_LIGHT
 *  @{
    @details
        - @ref ZB_ZCL_BASIC \n
        - @ref ZB_ZCL_IDENTIFY \n
        - @ref ZB_ZCL_CLUSTER_ID_SCENES \n
        - @ref ZB_ZCL_CLUSTER_ID_GROUPS \n
        - @ref ZB_ZCL_CLUSTER_ID_ON_OFF \n
        - @ref ZB_ZCL_CLUSTER_ID_LEVEL_CONTROL
...
#define ZB_HA_LIGHT_CLUSTER_NUM (ZB_HA_LIGHT_IN_CLUSTER_NUM + \
 ...
 */
#define ZB_HA_DECLARE_LIGHT_CLUSTER_LIST(               \
  cluster_list_name,                                             \
  basic_attr_list,                                               \
  identify_attr_list,                                            \
  groups_attr_list,                                              \
...
#define ZB_HA_DECLARE_LIGHT_EP(ep_name, ep_id, cluster_list)              \
  ZB_ZCL_DECLARE_HA_LIGHT_SIMPLE_DESC(ep_name, ep_id,                     \
    ZB_HA_LIGHT_IN_CLUSTER_NUM, ZB_HA_LIGHT_OUT_CLUSTER_NUM);             \
  ZBOSS_DEVICE_DECLARE_REPORTING_CTX(reporting_info## device_ctx_name,                          \
                                     ZB_HA_LIGHT_REPORT_ATTR_COUNT);                            \
...
/*
  ...
  @param ep_name - endpoint variable name
*/
#define ZB_HA_DECLARE_LIGHT_CTX(device_ctx, ep_name)                                                    \
