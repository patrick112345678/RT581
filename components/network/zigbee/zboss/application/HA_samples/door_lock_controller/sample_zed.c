...
*/
#define ZB_TRACE_FILE_ID 40241
#include "zboss_api.h"
#include "zb_led_button.h"
#include "zb_door_lock_controller.h"
...
ZB_HA_DECLARE_DOOR_LOCK_CONTROLLER_CLUSTER_LIST_ZED(door_lock_controller_clusters,  identify_attr_list, door_lock_attr_list, scenes_attr_list, groups_attr_list);
ZB_HA_DECLARE_DOOR_LOCK_CONTROLLER_EP_ZED(door_lock_controller_ep, ZB_SWITCH_ENDPOINT, door_lock_controller_clusters);
