...
*/
#define ZB_TRACE_FILE_ID 40233
#include "zboss_api.h"
#include "zb_led_button.h"
#include "zb_configuration_tool.h"
...
ZB_HA_DECLARE_CONFIGURATION_TOOL_CLUSTER_LIST_ZED(configuration_tool_clusters,  identify_attr_list, basic_attr_list, groups_attr_list);
ZB_HA_DECLARE_CONFIGURATION_TOOL_EP_ZED(configuration_tool_ep, ZB_SWITCH_ENDPOINT, configuration_tool_clusters);
ZB_HA_DECLARE_CONFIGURATION_TOOL_CTX(device_ctx, configuration_tool_ep);
