...
/********************* Declare device **************************/
ZB_HA_DECLARE_LEVEL_CONTROL_SWITCH_CLUSTER_LIST(level_control_switch_clusters, basic_attr_list, identify_attr_list);
ZB_HA_DECLARE_LEVEL_CONTROL_SWITCH_EP(level_control_switch_ep, ENDPOINT_C, level_control_switch_clusters);
