...
*/
#define ZB_TRACE_FILE_ID 40245
#include "zboss_api.h"
#include "zb_led_button.h"
#include "zb_level_control_switch.h"
...
ZB_HA_DECLARE_LEVEL_CONTROL_SWITCH_CLUSTER_LIST_ZED(level_control_switch_clusters,  on_off_attr_list, level_control_attr_list, identify_attr_list);
ZB_HA_DECLARE_LEVEL_CONTROL_SWITCH_EP_ZED(level_control_switch_ep, ZB_SWITCH_ENDPOINT, level_control_switch_clusters);
ZB_HA_DECLARE_LEVEL_CONTROL_SWITCH_CTX(device_ctx, level_control_switch_ep);
