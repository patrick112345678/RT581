 ...
 * DSR.
 */
/* PURPOSE: ZB LEVEL_CONTROL_SWITCH device
*/

#ifndef ZB_LEVEL_CONTROL_SWITCH_H
#define ZB_LEVEL_CONTROL_SWITCH_H 1

#define ZB_LEVEL_CONTROL_SWITCH_DEVICE_ID 0x0FA5
#define ZB_LEVEL_CONTROL_SWITCH_DEVICE_VER 1
#define ZB_LEVEL_CONTROL_SWITCH_IN_CLUSTER_NUM_ZED 3
#define ZB_LEVEL_CONTROL_SWITCH_OUT_CLUSTER_NUM_ZED 2

/*!
  @brief Declare cluster list for LEVEL_CONTROL_SWITCH Device
...
*/
#define ZB_HA_DECLARE_LEVEL_CONTROL_SWITCH_CLUSTER_LIST_ZED(        \
  cluster_list_name,                                                \
...
/*!
  @brief Declare simple descriptor for LEVEL_CONTROL_SWITCH Device
  @param ep_name - endpoint variable name
  @param ep_id - endpoint ID
  @param in_clust_num - number of supported input clusters
  @param out_clust_num - number of supported output clusters
*/
#define ZB_ZCL_DECLARE_LEVEL_CONTROL_SWITCH_SIMPLE_DESC_ZED(ep_name, ep_id, in_clust_num, out_clust_num)  \
...
/*!
  @brief Declare endpoint for LEVEL_CONTROL_SWITCH Device
  @param ep_name - endpoint variable name
  @param ep_id - endpoint ID
  @param cluster_list - endpoint cluster list
*/
#define ZB_HA_DECLARE_LEVEL_CONTROL_SWITCH_EP_ZED(ep_name, ep_id, cluster_list)                \
...
/*!
  @brief Declare application's device context for LEVEL_CONTROL_SWITCH Device
...
#endif /* ZB_LEVEL_CONTROL_SWITCH_H */
