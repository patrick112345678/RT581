...
ZB_HA_DECLARE_DIMMER_SWITCH_CLUSTER_LIST_ZED(dimmer_switch_clusters,  identify_attr_list, scenes_attr_list, groups_attr_list, on_off_attr_list, level_control_attr_list);
ZB_HA_DECLARE_DIMMER_SWITCH_EP_ZED(dimmer_switch_ep, ZB_SWITCH_ENDPOINT, dimmer_switch_clusters);
ZB_HA_DECLARE_DIMMER_SWITCH_CTX(device_ctx, dimmer_switch_ep);
