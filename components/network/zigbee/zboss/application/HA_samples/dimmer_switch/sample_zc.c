...
/********************* Declare device **************************/
ZB_HA_DECLARE_DIMMER_SWITCH_CLUSTER_LIST(dimmer_switch_clusters, basic_attr_list, identify_attr_list);
ZB_HA_DECLARE_DIMMER_SWITCH_EP(dimmer_switch_ep, ENDPOINT_C, dimmer_switch_clusters);
