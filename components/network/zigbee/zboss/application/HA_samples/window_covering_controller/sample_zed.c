...
*/
#define ZB_TRACE_FILE_ID 40211
#include "zboss_api.h"
#include "zb_led_button.h"
#include "zb_window_covering_controller.h"
...
ZB_HA_DECLARE_WINDOW_COVERING_CONTROLLER_CLUSTER_LIST_ZED(window_covering_controller_clusters,  identify_attr_list, window_covering_attr_list);
ZB_HA_DECLARE_WINDOW_COVERING_CONTROLLER_EP_ZED(window_covering_controller_ep, ZB_SWITCH_ENDPOINT, window_covering_controller_clusters);
ZB_HA_DECLARE_WINDOW_COVERING_CONTROLLER_CTX(device_ctx, window_covering_controller_ep);
