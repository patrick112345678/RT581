...
/********************* Declare device **************************/
ZB_HA_DECLARE_WINDOW_COVERING_CONTROLLER_CLUSTER_LIST(window_covering_controller_clusters, basic_attr_list, identify_attr_list);
ZB_HA_DECLARE_WINDOW_COVERING_CONTROLLER_EP(window_covering_controller_ep, ENDPOINT_C, window_covering_controller_clusters);
