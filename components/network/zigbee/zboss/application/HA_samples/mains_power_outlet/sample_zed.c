...
*/
#define ZB_TRACE_FILE_ID 40209
#include "zboss_api.h"
#include "zb_led_button.h"
#include "zb_mains_power_outlet.h"
...
ZB_HA_DECLARE_MAINS_POWER_OUTLET_CLUSTER_LIST_ZED(mains_power_outlet_clusters);
ZB_HA_DECLARE_MAINS_POWER_OUTLET_EP_ZED(mains_power_outlet_ep, ZB_SWITCH_ENDPOINT, mains_power_outlet_clusters);
ZB_HA_DECLARE_MAINS_POWER_OUTLET_CTX(device_ctx, mains_power_outlet_ep);
