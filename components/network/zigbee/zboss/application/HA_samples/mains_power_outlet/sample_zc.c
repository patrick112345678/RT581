...
/********************* Declare device **************************/
ZB_HA_DECLARE_MAINS_POWER_OUTLET_CLUSTER_LIST(mains_power_outlet_clusters, basic_attr_list, identify_attr_list, on_off_attr_list, scenes_attr_list, groups_attr_list);
ZB_HA_DECLARE_MAINS_POWER_OUTLET_EP(mains_power_outlet_ep, ENDPOINT_C, mains_power_outlet_clusters);
