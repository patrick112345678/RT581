...
*/
#define ZB_TRACE_FILE_ID 40201
#include "zboss_api.h"
#include "zb_led_button.h"
#include "zb_ias_ancillary_control_equipment.h"
...
zb_zcl_ias_ace_zone_table_t g_attr_ace_table[1];
zb_uint16_t g_attr_length = 1;
ZB_ZCL_DECLARE_IAS_ACE_ATTRIB_LIST(ias_ace_attr_list, &g_attr_length, &g_attr_ace_table);
/********************* Declare device **************************/
#define ZB_SWITCH_ENDPOINT          10

ZB_HA_DECLARE_IAS_ANCILLARY_CONTROL_EQUIPMENT_CLUSTER_LIST_ZED(ias_ancillary_control_equipment_clusters, identify_attr_list, ias_ace_attr_list);
ZB_HA_DECLARE_IAS_ANCILLARY_CONTROL_EQUIPMENT_EP_ZED(ias_ancillary_control_equipment_ep, ZB_SWITCH_ENDPOINT, ias_ancillary_control_equipment_clusters);
ZB_HA_DECLARE_IAS_ANCILLARY_CONTROL_EQUIPMENT_CTX(device_ctx, ias_ancillary_control_equipment_ep);
...
void button_2_handler(zb_uint8_t param)
{
  ...
  switch (g_ias_zone_status_cntr)
  {
    case 0:
      ...
      zb_uint8_t a = 0x41;
      ZB_ZCL_IAS_ACE_SEND_ZONE_STATUS_CHANGED_REQ(buf, addr, ZB_APS_ADDR_MODE_16_ENDP_PRESENT, 5, ENDPOINT_ED, 0x0104, ZB_FALSE, NULL,
                                                  0x01, 10, 0x01, &a);
      }
      break;
    case 1:
      ...
      zb_addr_u addr;
      addr.addr_short = 0x0000;
      ZB_ZCL_IAS_ACE_SEND_PANEL_STATUS_CHANGED_REQ(buf, addr, ZB_APS_ADDR_MODE_16_ENDP_PRESENT, 5, ENDPOINT_ED, 0x0104, ZB_FALSE, NULL,
                                                   0x01, 10, 0x01, 0x01);
      }
      break;
    default:
...
static void gpio_init(void)
{
  ...
  //APP_ERROR_CHECK(err_code); /* nordic specific */
