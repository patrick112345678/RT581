...
/********************* Declare device **************************/
ZB_HA_DECLARE_IAS_ANCILLARY_CONTROL_EQUIPMENT_CLUSTER_LIST(ias_ancillary_control_equipment_clusters, basic_attr_list, identify_attr_list, ias_zone_attr_list);
ZB_HA_DECLARE_IAS_ANCILLARY_CONTROL_EQUIPMENT_EP(ias_ancillary_control_equipment_ep, ENDPOINT_C, ias_ancillary_control_equipment_clusters);
