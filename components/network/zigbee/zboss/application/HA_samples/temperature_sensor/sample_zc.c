...
ZB_ZCL_DECLARE_TEMP_MEASUREMENT_ATTRIB_LIST(temp_measurement_attr_list, &g_attr_temp_measurement_value, &g_attr_temp_measurement_min_value, &g_attr_temp_measurement_max_value, &g_attr_temp_measurement_tolerance);
/********************* Declare device **************************/
...
ZB_HA_DECLARE_TEMPERATURE_SENSOR_EP(temperature_sensor_ep, ENDPOINT_C, temperature_sensor_clusters);
