...
enum test_step_e
{
    ...
    TEST_STEP_READ_TEMP_MEASUREMENT_VALUE, /** Read Value attribute from Temperature Measurement cluster */
    TEST_STEP_READ_TEMP_MEASUREMENT_MIN_VALUE, /** Read MinValue attribute from Temperature Measurement cluster */
    TEST_STEP_READ_TEMP_MEASUREMENT_MAX_VALUE, /** Read MaxValue attribute from Temperature Measurement cluster */
    TEST_STEP_READ_TEMP_MEASUREMENT_TOLERANCE, /** Read Tolerance attribute from Temperature Measurement cluster */
...
ZB_HA_DECLARE_TEMPERATURE_SENSOR_CLUSTER_LIST_ZED(temperature_sensor_clusters,  identify_attr_list);
ZB_HA_DECLARE_TEMPERATURE_SENSOR_EP_ZED(temperature_sensor_ep, ZB_SWITCH_ENDPOINT, temperature_sensor_clusters);
...
void test_next_step(zb_uint8_t param)
{
    ...
    break;
    case TEST_STEP_READ_TEMP_MEASUREMENT_VALUE:
        TRACE_MSG(TRACE_APP1, "Read Value attribute from Temperature Measurement cluster", (FMT__0));
        g_test_step++;
        send_read_attr(buffer, ZB_ZCL_CLUSTER_ID_TEMP_MEASUREMENT, ZB_ZCL_ATTR_TEMP_MEASUREMENT_VALUE_ID);
        break;
    case TEST_STEP_READ_TEMP_MEASUREMENT_MIN_VALUE:
        TRACE_MSG(TRACE_APP1, "Read MinValue attribute from Temperature Measurement cluster", (FMT__0));
        g_test_step++;
        send_read_attr(buffer, ZB_ZCL_CLUSTER_ID_TEMP_MEASUREMENT, ZB_ZCL_ATTR_TEMP_MEASUREMENT_MIN_VALUE_ID);
        break;
    case TEST_STEP_READ_TEMP_MEASUREMENT_MAX_VALUE:
        TRACE_MSG(TRACE_APP1, "Read MaxValue attribute from Temperature Measurement cluster", (FMT__0));
        g_test_step++;
        send_read_attr(buffer, ZB_ZCL_CLUSTER_ID_TEMP_MEASUREMENT, ZB_ZCL_ATTR_TEMP_MEASUREMENT_MAX_VALUE_ID);
        break;
    case TEST_STEP_READ_TEMP_MEASUREMENT_TOLERANCE:
        TRACE_MSG(TRACE_APP1, "Read Tolerance attribute from Temperature Measurement cluster", (FMT__0));
        g_test_step++;
        send_read_attr(buffer, ZB_ZCL_CLUSTER_ID_TEMP_MEASUREMENT, ZB_ZCL_ATTR_TEMP_MEASUREMENT_TOLERANCE_ID);
        break;
