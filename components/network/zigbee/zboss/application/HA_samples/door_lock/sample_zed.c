...
enum test_step_e
{
  ...
  TEST_STEP_READ_DOOR_LOCK_LOCK_STATE, /** Read LockState attribute from Door Lock cluster */
  TEST_STEP_DOOR_LOCK_SEND_LOCK_DOOR_REQ, /** Send Lock Door command to Door Lock cluster */
  TEST_STEP_READ_DOOR_LOCK_LOCK_TYPE, /** Read LockType attribute from Door Lock cluster */
  TEST_STEP_DOOR_LOCK_SEND_UNLOCK_DOOR_REQ, /** Send Unlock Door command to Door Lock cluster */
  TEST_STEP_READ_DOOR_LOCK_ACTUATOR_ENABLED, /** Read ActuatorEnabled attribute from Door Lock cluster */
...
ZB_HA_DECLARE_DOOR_LOCK_CLUSTER_LIST_ZED(door_lock_clusters);
ZB_HA_DECLARE_DOOR_LOCK_EP_ZED(door_lock_ep, ZB_SWITCH_ENDPOINT, door_lock_clusters);
...
/* [add_group_if_ident_req] */
  ...
  case TEST_STEP_SCENES_SEND_GET_SCENE_MEMBERSHIP_REQ:
    ...
    break;
  case TEST_STEP_READ_DOOR_LOCK_LOCK_STATE:
    TRACE_MSG(TRACE_APP1, "Read LockState attribute from Door Lock cluster", (FMT__0));
    g_test_step++;
    send_read_attr(buffer, ZB_ZCL_CLUSTER_ID_DOOR_LOCK, ZB_ZCL_ATTR_DOOR_LOCK_LOCK_STATE_ID);
    break;
  case TEST_STEP_DOOR_LOCK_SEND_LOCK_DOOR_REQ:
    {
      TRACE_MSG(TRACE_APP1, "Send Lock Door command to Door Lock cluster", (FMT__0));
      g_test_step++;
/* [send_door_lock_req] */
...
/* [send_door_lock_req] */
    ...
    break;
  case TEST_STEP_READ_DOOR_LOCK_LOCK_TYPE:
    TRACE_MSG(TRACE_APP1, "Read LockType attribute from Door Lock cluster", (FMT__0));
    g_test_step++;
    send_read_attr(buffer, ZB_ZCL_CLUSTER_ID_DOOR_LOCK, ZB_ZCL_ATTR_DOOR_LOCK_LOCK_TYPE_ID);
    break;
  case TEST_STEP_DOOR_LOCK_SEND_UNLOCK_DOOR_REQ:
    {
      TRACE_MSG(TRACE_APP1, "Send Unlock Door command to Door Lock cluster", (FMT__0));
      g_test_step++;
/* [send_door_lock_unlock_req] */
...
/* [send_door_lock_unlock_req] */
    ...
    break;
  case TEST_STEP_READ_DOOR_LOCK_ACTUATOR_ENABLED:
    TRACE_MSG(TRACE_APP1, "Read ActuatorEnabled attribute from Door Lock cluster", (FMT__0));
    g_test_step++;
    send_read_attr(buffer, ZB_ZCL_CLUSTER_ID_DOOR_LOCK, ZB_ZCL_ATTR_DOOR_LOCK_ACTUATOR_ENABLED_ID);
    break;
