...
enum test_step_e
{
    TEST_STEP_IAS_ZONE_SEND_STATUS_CHANGE_NOTIFICATION_REQ, /** Send Zone Status Change Notification command to IAS Zone cluster */
    TEST_STEP_IAS_ZONE_SEND_ZONE_ENROLL_REQUEST_REQ, /** Send Zone Enroll Request command to IAS Zone cluster */
...
/********************* Declare device **************************/
ZB_HA_DECLARE_IAS_WARNING_CLUSTER_LIST(ias_warning_clusters, basic_attr_list, identify_attr_list, ias_wd_attr_list, ias_zone_attr_list, scenes_attr_list, groups_attr_list);
ZB_HA_DECLARE_IAS_WARNING_EP(ias_warning_ep, ENDPOINT_C, ias_warning_clusters);
...
void test_next_step(zb_uint8_t param)
{
    ...
    switch (g_test_step )
    {
    case TEST_STEP_IAS_ZONE_SEND_STATUS_CHANGE_NOTIFICATION_REQ:
    {
        TRACE_MSG(TRACE_APP1, "Send Zone Status Change Notification command to IAS Zone cluster", (FMT__0));
        g_test_step++;
        ZB_ZCL_IAS_ZONE_SEND_STATUS_CHANGE_NOTIFICATION_REQ(buffer, DST_ADDR, DST_ADDR_MODE, ENDPOINT_C, ENDPOINT_ED, ZB_AF_HA_PROFILE_ID, NULL, g_attr_ias_zone_zonestatus, 0, 0, 0);
    }
    break;
    case TEST_STEP_IAS_ZONE_SEND_ZONE_ENROLL_REQUEST_REQ:
    {
        TRACE_MSG(TRACE_APP1, "Send Zone Enroll Request command to IAS Zone cluster", (FMT__0));
        g_test_step++;
        ZB_ZCL_IAS_ZONE_SEND_ZONE_ENROLL_REQUEST_REQ(buffer, DST_ADDR, DST_ADDR_MODE, ENDPOINT_ED, ENDPOINT_C, ZB_AF_HA_PROFILE_ID, NULL, ZB_ZCL_IAS_ZONE_ZONETYPE_MOTION, 123);
    }
    break;
    default:
