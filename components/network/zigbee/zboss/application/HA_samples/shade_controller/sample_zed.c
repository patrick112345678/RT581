...
*/
#define ZB_TRACE_FILE_ID 40195
#include "zboss_api.h"
#include "zb_led_button.h"
#include "zb_shade_controller.h"
...
ZB_HA_DECLARE_SHADE_CONTROLLER_CLUSTER_LIST_ZED(shade_controller_clusters,  identify_attr_list, on_off_attr_list, level_control_attr_list);
ZB_HA_DECLARE_SHADE_CONTROLLER_EP_ZED(shade_controller_ep, ZB_SWITCH_ENDPOINT, shade_controller_clusters);
ZB_HA_DECLARE_SHADE_CONTROLLER_CTX(device_ctx, shade_controller_ep);
