 ...
 * DSR.
 */
/* PURPOSE: ZB LEVEL_CONTROLLABLE_OUTPUT device
*/

#ifndef ZB_LEVEL_CONTROLLABLE_OUTPUT_H
#define ZB_LEVEL_CONTROLLABLE_OUTPUT_H 1

#define ZB_LEVEL_CONTROLLABLE_OUTPUT_DEVICE_ID 0x0FB3
#define ZB_LEVEL_CONTROLLABLE_OUTPUT_DEVICE_VER 1
#define ZB_LEVEL_CONTROLLABLE_OUTPUT_IN_CLUSTER_NUM_ZED 0
#define ZB_LEVEL_CONTROLLABLE_OUTPUT_OUT_CLUSTER_NUM_ZED 6

/*!
  @brief Declare cluster list for LEVEL_CONTROLLABLE_OUTPUT Device
  @param cluster_list_name - cluster list variable name
*/
#define ZB_HA_DECLARE_LEVEL_CONTROLLABLE_OUTPUT_CLUSTER_LIST_ZED(  \
  cluster_list_name)                                               \
...
/*!
  @brief Declare simple descriptor for LEVEL_CONTROLLABLE_OUTPUT Device
  @param ep_name - endpoint variable name
  @param ep_id - endpoint ID
  @param in_clust_num - number of supported input clusters
  @param out_clust_num - number of supported output clusters
*/
#define ZB_ZCL_DECLARE_LEVEL_CONTROLLABLE_OUTPUT_SIMPLE_DESC_ZED(ep_name, ep_id, in_clust_num, out_clust_num)  \
  ZB_DECLARE_SIMPLE_DESC(in_clust_num, out_clust_num);                                                         \
  ZB_AF_SIMPLE_DESC_TYPE(in_clust_num, out_clust_num) simple_desc_##ep_name =                                  \
  {                                                                                                            \
    ep_id,                                                                                                     \
    ZB_AF_HA_PROFILE_ID,                                                                                       \
    ZB_LEVEL_CONTROLLABLE_OUTPUT_DEVICE_ID,                                                                    \
    ZB_LEVEL_CONTROLLABLE_OUTPUT_DEVICE_VER,                                                                   \
    0,                                                                                                         \
    in_clust_num,                                                                                              \
    out_clust_num,                                                                                             \
    {                                                                                                          \
...
/*!
  @brief Declare endpoint for LEVEL_CONTROLLABLE_OUTPUT Device
  @param ep_name - endpoint variable name
  @param ep_id - endpoint ID
  @param cluster_list - endpoint cluster list
*/
#define ZB_HA_DECLARE_LEVEL_CONTROLLABLE_OUTPUT_EP_ZED(ep_name, ep_id, cluster_list)                     \
  ZB_ZCL_DECLARE_LEVEL_CONTROLLABLE_OUTPUT_SIMPLE_DESC_ZED(ep_name, ep_id,                               \
    ZB_LEVEL_CONTROLLABLE_OUTPUT_IN_CLUSTER_NUM_ZED, ZB_LEVEL_CONTROLLABLE_OUTPUT_OUT_CLUSTER_NUM_ZED);  \
...
/*!
  @brief Declare application's device context for LEVEL_CONTROLLABLE_OUTPUT Device
...
#endif /* ZB_LEVEL_CONTROLLABLE_OUTPUT_H */
