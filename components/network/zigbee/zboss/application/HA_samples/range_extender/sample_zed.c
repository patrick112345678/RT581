...
ZB_HA_DECLARE_RANGE_EXTENDER_CLUSTER_LIST_ZED(range_extender_clusters);
ZB_HA_DECLARE_RANGE_EXTENDER_EP_ZED(range_extender_ep, ZB_SWITCH_ENDPOINT, range_extender_clusters);
ZB_HA_DECLARE_RANGE_EXTENDER_CTX(device_ctx, range_extender_ep);
