...
/* Binary Input (Basic) cluster attributes data */
zb_bool_t g_attr_binary_input_out_of_service = ZB_ZCL_BINARY_INPUT_OUT_OF_SERVICE_DEFAULT_VALUE;
zb_bool_t g_attr_binary_input_present_value = ZB_FALSE;
zb_uint8_t g_attr_binary_input_status_flag = ZB_ZCL_BINARY_INPUT_STATUS_FLAG_DEFAULT_VALUE;
ZB_ZCL_DECLARE_IDENTIFY_ATTRIB_LIST(identify_attr_list, &g_attr_identify_identify_time);
ZB_ZCL_DECLARE_BINARY_INPUT_ATTRIB_LIST(binary_input_attr_list, &g_attr_binary_input_out_of_service, &g_attr_binary_input_present_value, &g_attr_binary_input_status_flag);
/********************* Declare device **************************/
ZB_HA_DECLARE_SIMPLE_SENSOR_CLUSTER_LIST(simple_sensor_clusters, basic_attr_list, identify_attr_list, binary_input_attr_list);
ZB_HA_DECLARE_SIMPLE_SENSOR_EP(simple_sensor_ep, ENDPOINT_C, simple_sensor_clusters);
