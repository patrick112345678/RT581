...
*/
#define ZB_TRACE_FILE_ID 40215
#include "zboss_api.h"
#include "zb_led_button.h"
#include "zb_ias_control_indicating_equipment.h"

#include "../common/zcl_ias_zone_attr_list.h"
...
enum test_step_e
{
    ...
    TEST_STEP_IAS_ACE_SEND_ARM_REQ, /** Send Arm command to IAS ACE cluster */
    TEST_STEP_IAS_ACE_SEND_BYPASS_REQ, /** Send Bypass command to IAS ACE cluster */
    TEST_STEP_IAS_ACE_SEND_EMERGENCY_REQ, /** Send Emergency command to IAS ACE cluster */
    TEST_STEP_IAS_ACE_SEND_FIRE_REQ, /** Send Fire command to IAS ACE cluster */
    TEST_STEP_IAS_ACE_SEND_PANIC_REQ, /** Send Panic command to IAS ACE cluster */
    TEST_STEP_IAS_ACE_SEND_GET_ZONE_ID_MAP_REQ, /** Send Get Zone ID Map command to IAS ACE cluster */
    TEST_STEP_IAS_ACE_SEND_GET_ZONE_INFO_REQ, /** Send Get Zone Information command to IAS ACE cluster */
    TEST_STEP_IAS_ACE_SEND_GET_PANEL_STATUS_REQ, /** Send Get Panel Status command to IAS ACE cluster */
    TEST_STEP_IAS_ACE_SEND_GET_BYPASSED_ZONE_LIST_REQ, /** Send Get Bypassed Zone List command to IAS ACE cluster */
    TEST_STEP_IAS_ACE_SEND_GET_ZONE_STATUS_REQ, /** Send Get Zone Status command to IAS ACE cluster */
...
/* IAS WD cluster attributes data */
zb_uint16_t g_attr_ias_wd_max_duration = ZB_ZCL_ATTR_IAS_WD_MAX_DURATION_DEF_VALUE;
/********************* Declare device **************************/
#define ZB_SWITCH_ENDPOINT          10

ZB_ZCL_DECLARE_IDENTIFY_ATTRIB_LIST(identify_attr_list, &g_attr_identify_identify_time);
ZB_ZCL_DECLARE_IAS_WD_ATTRIB_LIST(ias_wd_attr_list, &g_attr_ias_wd_max_duration);
...
ZB_HA_DECLARE_IAS_CONTROL_INDICATING_EQUIPMENT_CLUSTER_LIST_ZED(ias_control_indicating_equipment_clusters,  identify_attr_list, ias_wd_attr_list, ias_zone_attr_list, scenes_attr_list, groups_attr_list);
ZB_HA_DECLARE_IAS_CONTROL_INDICATING_EQUIPMENT_EP_ZED(ias_control_indicating_equipment_ep, ZB_SWITCH_ENDPOINT, ias_control_indicating_equipment_clusters);
ZB_HA_DECLARE_IAS_CONTROL_INDICATING_EQUIPMENT_CTX(device_ctx, ias_control_indicating_equipment_ep);
...
void test_next_step(zb_uint8_t param)
{
    ...
    break;
    case TEST_STEP_IAS_ACE_SEND_ARM_REQ:
    {
        zb_char_t arm_disarm_code[5] = { 4, 'a', 'b', 'c', 'd' };
        TRACE_MSG(TRACE_APP1, "Send Arm command to IAS ACE cluster", (FMT__0));
        g_test_step++;
        ZB_ZCL_IAS_ACE_SEND_ARM_REQ(buffer, DST_ADDR, DST_ADDR_MODE, ENDPOINT_C, ENDPOINT_ED, ZB_AF_HA_PROFILE_ID, ZB_ZCL_ENABLE_DEFAULT_RESPONSE, NULL, ZB_ZCL_IAS_ACE_ARM_MODE_DISARM, arm_disarm_code, 0);
    }
    break;
    case TEST_STEP_IAS_ACE_SEND_BYPASS_REQ:
    {
        zb_uint8_t *cmd_ptr;
        zb_char_t arm_disarm_code[5] = { 4, 'a', 'b', 'c', 'd' };
        TRACE_MSG(TRACE_APP1, "Send Bypass command to IAS ACE cluster", (FMT__0));
        g_test_step++;
        ZB_ZCL_IAS_ACE_SEND_BYPASS_REQ_START(buffer, ZB_ZCL_ENABLE_DEFAULT_RESPONSE, 1, cmd_ptr);
        ZB_ZCL_IAS_ACE_SEND_BYPASS_REQ_ADD(cmd_ptr, 0);
        ZB_ZCL_IAS_ACE_SEND_BYPASS_REQ_END(cmd_ptr, buffer, arm_disarm_code, DST_ADDR, DST_ADDR_MODE, ENDPOINT_C, ENDPOINT_ED, ZB_AF_HA_PROFILE_ID, NULL);
    }
    break;
    case TEST_STEP_IAS_ACE_SEND_EMERGENCY_REQ:
    {
        TRACE_MSG(TRACE_APP1, "Send Emergency command to IAS ACE cluster", (FMT__0));
        g_test_step++;
        ZB_ZCL_IAS_ACE_SEND_EMERGENCY_REQ(buffer, DST_ADDR, DST_ADDR_MODE, ENDPOINT_C, ENDPOINT_ED, ZB_AF_HA_PROFILE_ID, ZB_ZCL_ENABLE_DEFAULT_RESPONSE, NULL);
    }
    break;
    case TEST_STEP_IAS_ACE_SEND_FIRE_REQ:
    {
        TRACE_MSG(TRACE_APP1, "Send Fire command to IAS ACE cluster", (FMT__0));
        g_test_step++;
        ZB_ZCL_IAS_ACE_SEND_FIRE_REQ(buffer, DST_ADDR, DST_ADDR_MODE, ENDPOINT_C, ENDPOINT_ED, ZB_AF_HA_PROFILE_ID, ZB_ZCL_ENABLE_DEFAULT_RESPONSE, NULL);
    }
    break;
    case TEST_STEP_IAS_ACE_SEND_PANIC_REQ:
    {
        TRACE_MSG(TRACE_APP1, "Send Panic command to IAS ACE cluster", (FMT__0));
        g_test_step++;
        ZB_ZCL_IAS_ACE_SEND_PANIC_REQ(buffer, DST_ADDR, DST_ADDR_MODE, ENDPOINT_C, ENDPOINT_ED, ZB_AF_HA_PROFILE_ID, ZB_ZCL_ENABLE_DEFAULT_RESPONSE, NULL);
    }
    break;
    case TEST_STEP_IAS_ACE_SEND_GET_ZONE_ID_MAP_REQ:
    {
        TRACE_MSG(TRACE_APP1, "Send Get Zone ID Map command to IAS ACE cluster", (FMT__0));
        g_test_step++;
        ZB_ZCL_IAS_ACE_SEND_GET_ZONE_ID_MAP_REQ(buffer, DST_ADDR, DST_ADDR_MODE, ENDPOINT_C, ENDPOINT_ED, ZB_AF_HA_PROFILE_ID, ZB_ZCL_ENABLE_DEFAULT_RESPONSE, NULL);
    }
    break;
    case TEST_STEP_IAS_ACE_SEND_GET_ZONE_INFO_REQ:
    {
        TRACE_MSG(TRACE_APP1, "Send Get Zone Information command to IAS ACE cluster", (FMT__0));
        g_test_step++;
        ZB_ZCL_IAS_ACE_SEND_GET_ZONE_INFO_REQ(buffer, DST_ADDR, DST_ADDR_MODE, ENDPOINT_C, ENDPOINT_ED, ZB_AF_HA_PROFILE_ID, ZB_ZCL_ENABLE_DEFAULT_RESPONSE, NULL, 0);
    }
    break;
    case TEST_STEP_IAS_ACE_SEND_GET_PANEL_STATUS_REQ:
    {
        TRACE_MSG(TRACE_APP1, "Send Get Panel Status command to IAS ACE cluster", (FMT__0));
        g_test_step++;
        ZB_ZCL_IAS_ACE_SEND_GET_PANEL_STATUS_REQ(buffer, DST_ADDR, DST_ADDR_MODE, ENDPOINT_C, ENDPOINT_ED, ZB_AF_HA_PROFILE_ID, ZB_ZCL_ENABLE_DEFAULT_RESPONSE, NULL);
    }
    break;
    case TEST_STEP_IAS_ACE_SEND_GET_BYPASSED_ZONE_LIST_REQ:
    {
        TRACE_MSG(TRACE_APP1, "Send Get Bypassed Zone List command to IAS ACE cluster", (FMT__0));
        g_test_step++;
        ZB_ZCL_IAS_ACE_SEND_GET_BYPASSED_ZONE_LIST_REQ(buffer, DST_ADDR, DST_ADDR_MODE, ENDPOINT_C, ENDPOINT_ED, ZB_AF_HA_PROFILE_ID, ZB_ZCL_ENABLE_DEFAULT_RESPONSE, NULL);
    }
    break;
    case TEST_STEP_IAS_ACE_SEND_GET_ZONE_STATUS_REQ:
    {
        TRACE_MSG(TRACE_APP1, "Send Get Zone Status command to IAS ACE cluster", (FMT__0));
        g_test_step++;
        ZB_ZCL_IAS_ACE_SEND_GET_ZONE_STATUS_REQ(buffer, DST_ADDR, DST_ADDR_MODE, ENDPOINT_C, ENDPOINT_ED, ZB_AF_HA_PROFILE_ID, ZB_ZCL_ENABLE_DEFAULT_RESPONSE, NULL, 0, 1, ZB_FALSE, 0);
    }
    break;
