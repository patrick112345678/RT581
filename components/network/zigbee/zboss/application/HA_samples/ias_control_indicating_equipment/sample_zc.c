...
/********************* Declare device **************************/
ZB_HA_DECLARE_IAS_CONTROL_INDICATING_EQUIPMENT_CLUSTER_LIST(ias_control_indicating_equipment_clusters, basic_attr_list, identify_attr_list, ias_ace_attr_list);
ZB_HA_DECLARE_IAS_CONTROL_INDICATING_EQUIPMENT_EP(ias_control_indicating_equipment_ep, ENDPOINT_C, ias_control_indicating_equipment_clusters);
