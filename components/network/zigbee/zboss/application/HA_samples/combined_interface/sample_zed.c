...
*/
#define ZB_TRACE_FILE_ID 40229
#include "zboss_api.h"
#include "zb_led_button.h"
#include "zb_combined_interface.h"
...
ZB_HA_DECLARE_COMBINED_INTERFACE_CLUSTER_LIST_ZED(combined_interface_clusters,  identify_attr_list, basic_attr_list, on_off_switch_configuration_attr_list);
ZB_HA_DECLARE_COMBINED_INTERFACE_EP_ZED(combined_interface_ep, ZB_SWITCH_ENDPOINT, combined_interface_clusters);
ZB_HA_DECLARE_COMBINED_INTERFACE_CTX(device_ctx, combined_interface_ep);
