...
*/
#define ZB_TRACE_FILE_ID 40219
#include "zboss_api.h"
#include "zb_led_button.h"
#include "zb_ha_test_sample_2.h"
...
enum test_step_e
{
  ...
  TEST_STEP_READ_METER_IDENTIFICATION_COMPANY_NAME, /** Read CompanyName attribute from Meter Identification cluster */
  TEST_STEP_READ_METER_IDENTIFICATION_METER_TYPE_ID, /** Read MeterTypeID attribute from Meter Identification cluster */
  TEST_STEP_READ_METER_IDENTIFICATION_DATA_QUALITY_ID, /** Read DataQualityID attribute from Meter Identification cluster */
  TEST_STEP_READ_METER_IDENTIFICATION_MODEL, /** Read Model attribute from Meter Identification cluster */
  TEST_STEP_READ_METER_IDENTIFICATION_POD, /** Read POD attribute from Meter Identification cluster */
  TEST_STEP_READ_METER_IDENTIFICATION_AVAILABLE_POWER, /** Read AvailablePower attribute from Meter Identification cluster */
  TEST_STEP_READ_METER_IDENTIFICATION_POWER_THRESHOLD, /** Read PowerThreshold attribute from Meter Identification cluster */
  TEST_STEP_READ_FAN_CONTROL_FAN_MODE, /** Read FanMode attribute from Fan Control cluster */
  TEST_STEP_WRITE_FAN_CONTROL_FAN_MODE, /** Write FanMode attribute to Fan Control cluster */
  TEST_STEP_READ_FAN_CONTROL_FAN_MODE_SEQUENCE, /** Read FanModeSequence attribute from Fan Control cluster */
  TEST_STEP_WRITE_FAN_CONTROL_FAN_MODE_SEQUENCE, /** Write FanModeSequence attribute to Fan Control cluster */
  TEST_STEP_READ_THERMOSTAT_UI_CONFIG_TEMPERATURE_DISPLAY_MODE, /** Read TemperatureDisplayMode attribute from Thermostat User Interface Configuration cluster */
  TEST_STEP_WRITE_THERMOSTAT_UI_CONFIG_TEMPERATURE_DISPLAY_MODE, /** Write TemperatureDisplayMode attribute to Thermostat User Interface Configuration cluster */
  TEST_STEP_READ_THERMOSTAT_UI_CONFIG_KEYPAD_LOCKOUT, /** Read KeypadLockout attribute from Thermostat User Interface Configuration cluster */
  TEST_STEP_WRITE_THERMOSTAT_UI_CONFIG_KEYPAD_LOCKOUT, /** Write KeypadLockout attribute to Thermostat User Interface Configuration cluster */
  TEST_STEP_EN50523_APPL_EV_AND_ALERTS_SEND_GET_ALERTS_REQ, /** Send Get Alerts command to EN50523 Appliance Events and Alerts cluster */
...
ZB_HA_DECLARE_HA_TEST_SAMPLE_2_CLUSTER_LIST_ZED(ha_test_sample_2_clusters);
ZB_HA_DECLARE_HA_TEST_SAMPLE_2_EP_ZED(ha_test_sample_2_ep, ZB_SWITCH_ENDPOINT, ha_test_sample_2_clusters);
ZB_HA_DECLARE_HA_TEST_SAMPLE_2_CTX(device_ctx, ha_test_sample_2_ep);
...
void test_next_step(zb_uint8_t param)
{
  ...
  case TEST_STEP_IDENTIFY_SEND_TRIGGER_VARIANT_REQ:
    ...
    break;
  case TEST_STEP_READ_METER_IDENTIFICATION_COMPANY_NAME:
    TRACE_MSG(TRACE_APP1, "Read CompanyName attribute from Meter Identification cluster", (FMT__0));
    g_test_step++;
    send_read_attr(buffer, ZB_ZCL_CLUSTER_ID_METER_IDENTIFICATION, ZB_ZCl_ATTR_METER_IDENTIFICATION_COMPANY_NAME);
    break;
  case TEST_STEP_READ_METER_IDENTIFICATION_METER_TYPE_ID:
    TRACE_MSG(TRACE_APP1, "Read MeterTypeID attribute from Meter Identification cluster", (FMT__0));
    g_test_step++;
    send_read_attr(buffer, ZB_ZCL_CLUSTER_ID_METER_IDENTIFICATION, ZB_ZCl_ATTR_METER_IDENTIFICATION_METER_TYPE_ID);
    break;
  case TEST_STEP_READ_METER_IDENTIFICATION_DATA_QUALITY_ID:
    TRACE_MSG(TRACE_APP1, "Read DataQualityID attribute from Meter Identification cluster", (FMT__0));
    g_test_step++;
    send_read_attr(buffer, ZB_ZCL_CLUSTER_ID_METER_IDENTIFICATION, ZB_ZCl_ATTR_METER_IDENTIFICATION_DATA_QUALITY_ID);
    break;
  case TEST_STEP_READ_METER_IDENTIFICATION_MODEL:
    TRACE_MSG(TRACE_APP1, "Read Model attribute from Meter Identification cluster", (FMT__0));
    g_test_step++;
    send_read_attr(buffer, ZB_ZCL_CLUSTER_ID_METER_IDENTIFICATION, ZB_ZCl_ATTR_METER_IDENTIFICATION_MODEL);
    break;
  case TEST_STEP_READ_METER_IDENTIFICATION_POD:
    TRACE_MSG(TRACE_APP1, "Read POD attribute from Meter Identification cluster", (FMT__0));
    g_test_step++;
    send_read_attr(buffer, ZB_ZCL_CLUSTER_ID_METER_IDENTIFICATION, ZB_ZCl_ATTR_METER_IDENTIFICATION_POD);
    break;
  case TEST_STEP_READ_METER_IDENTIFICATION_AVAILABLE_POWER:
    TRACE_MSG(TRACE_APP1, "Read AvailablePower attribute from Meter Identification cluster", (FMT__0));
    g_test_step++;
    send_read_attr(buffer, ZB_ZCL_CLUSTER_ID_METER_IDENTIFICATION, ZB_ZCl_ATTR_METER_IDENTIFICATION_AVAILABLE_POWER);
    break;
  case TEST_STEP_READ_METER_IDENTIFICATION_POWER_THRESHOLD:
    TRACE_MSG(TRACE_APP1, "Read PowerThreshold attribute from Meter Identification cluster", (FMT__0));
    g_test_step++;
    send_read_attr(buffer, ZB_ZCL_CLUSTER_ID_METER_IDENTIFICATION, ZB_ZCl_ATTR_METER_IDENTIFICATION_POWER_THRESHOLD);
    break;
  case TEST_STEP_READ_FAN_CONTROL_FAN_MODE:
    TRACE_MSG(TRACE_APP1, "Read FanMode attribute from Fan Control cluster", (FMT__0));
    g_test_step++;
    send_read_attr(buffer, ZB_ZCL_CLUSTER_ID_FAN_CONTROL, ZB_ZCL_ATTR_FAN_CONTROL_FAN_MODE_ID);
    break;
  case TEST_STEP_WRITE_FAN_CONTROL_FAN_MODE:
    {
      zb_uint8_t fan_control_fan_mode_def = ZB_ZCL_FAN_CONTROL_FAN_MODE_DEFAULT_VALUE;
      TRACE_MSG(TRACE_APP1, "Write FanMode attribute to Fan Control cluster", (FMT__0));
      g_test_step++;
      send_write_attr(buffer, ZB_ZCL_CLUSTER_ID_FAN_CONTROL, ZB_ZCL_ATTR_FAN_CONTROL_FAN_MODE_ID, ZB_ZCL_ATTR_TYPE_8BIT_ENUM, &fan_control_fan_mode_def);
    }
    break;
  case TEST_STEP_READ_FAN_CONTROL_FAN_MODE_SEQUENCE:
    TRACE_MSG(TRACE_APP1, "Read FanModeSequence attribute from Fan Control cluster", (FMT__0));
    g_test_step++;
    send_read_attr(buffer, ZB_ZCL_CLUSTER_ID_FAN_CONTROL, ZB_ZCL_ATTR_FAN_CONTROL_FAN_MODE_SEQUENCE_ID);
    break;
  case TEST_STEP_WRITE_FAN_CONTROL_FAN_MODE_SEQUENCE:
    {
      zb_uint8_t fan_control_fan_mode_sequence_def = ZB_ZCL_FAN_CONTROL_FAN_MODE_SEQUENCE_DEFAULT_VALUE;
      TRACE_MSG(TRACE_APP1, "Write FanModeSequence attribute to Fan Control cluster", (FMT__0));
      g_test_step++;
      send_write_attr(buffer, ZB_ZCL_CLUSTER_ID_FAN_CONTROL, ZB_ZCL_ATTR_FAN_CONTROL_FAN_MODE_SEQUENCE_ID, ZB_ZCL_ATTR_TYPE_8BIT_ENUM, &fan_control_fan_mode_sequence_def);
    }
    break;
  case TEST_STEP_READ_THERMOSTAT_UI_CONFIG_TEMPERATURE_DISPLAY_MODE:
    TRACE_MSG(TRACE_APP1, "Read TemperatureDisplayMode attribute from Thermostat User Interface Configuration cluster", (FMT__0));
    g_test_step++;
    send_read_attr(buffer, ZB_ZCL_CLUSTER_ID_THERMOSTAT_UI_CONFIG, ZB_ZCL_ATTR_THERMOSTAT_UI_CONFIG_TEMPERATURE_DISPLAY_MODE_ID);
    break;
  case TEST_STEP_WRITE_THERMOSTAT_UI_CONFIG_TEMPERATURE_DISPLAY_MODE:
    {
      zb_uint8_t thermostat_ui_config_temperature_display_mode_def = ZB_ZCL_THERMOSTAT_UI_CONFIG_TEMPERATURE_DISPLAY_MODE_DEFAULT_VALUE;
      TRACE_MSG(TRACE_APP1, "Write TemperatureDisplayMode attribute to Thermostat User Interface Configuration cluster", (FMT__0));
      g_test_step++;
      send_write_attr(buffer, ZB_ZCL_CLUSTER_ID_THERMOSTAT_UI_CONFIG, ZB_ZCL_ATTR_THERMOSTAT_UI_CONFIG_TEMPERATURE_DISPLAY_MODE_ID, ZB_ZCL_ATTR_TYPE_8BIT_ENUM, &thermostat_ui_config_temperature_display_mode_def);
    }
    break;
  case TEST_STEP_READ_THERMOSTAT_UI_CONFIG_KEYPAD_LOCKOUT:
    TRACE_MSG(TRACE_APP1, "Read KeypadLockout attribute from Thermostat User Interface Configuration cluster", (FMT__0));
    g_test_step++;
    send_read_attr(buffer, ZB_ZCL_CLUSTER_ID_THERMOSTAT_UI_CONFIG, ZB_ZCL_ATTR_THERMOSTAT_UI_CONFIG_KEYPAD_LOCKOUT_ID);
    break;
  case TEST_STEP_WRITE_THERMOSTAT_UI_CONFIG_KEYPAD_LOCKOUT:
    {
      zb_uint8_t thermostat_ui_config_keypad_lockout_def = ZB_ZCL_THERMOSTAT_UI_CONFIG_KEYPAD_LOCKOUT_DEFAULT_VALUE;
      TRACE_MSG(TRACE_APP1, "Write KeypadLockout attribute to Thermostat User Interface Configuration cluster", (FMT__0));
      g_test_step++;
      send_write_attr(buffer, ZB_ZCL_CLUSTER_ID_THERMOSTAT_UI_CONFIG, ZB_ZCL_ATTR_THERMOSTAT_UI_CONFIG_KEYPAD_LOCKOUT_ID, ZB_ZCL_ATTR_TYPE_8BIT_ENUM, &thermostat_ui_config_keypad_lockout_def);
    }
    break;
  case TEST_STEP_EN50523_APPL_EV_AND_ALERTS_SEND_GET_ALERTS_REQ:
    {
      TRACE_MSG(TRACE_APP1, "Send Get Alerts command to EN50523 Appliance Events and Alerts cluster", (FMT__0));
      g_test_step++;
      ZB_ZCL_EN50523_APPL_EV_AND_ALERTS_SEND_GET_ALERTS_REQ(buffer, DST_ADDR, DST_ADDR_MODE, ENDPOINT_C, ENDPOINT_ED, ZB_AF_HA_PROFILE_ID, ZB_ZCL_ENABLE_DEFAULT_RESPONSE, NULL);
    }
    break;
