...
/* Meter Identification cluster attributes data */
zb_char_t g_attr_meter_identification_company_name[] = "";
zb_uint16_t g_attr_meter_identification_meter_type_id = 0;
zb_uint16_t g_attr_meter_identification_data_quality_id = 0;
zb_char_t g_attr_meter_identification_pod[] = "";
zb_int24_t g_attr_meter_identification_available_power = ZB_INIT_UINT24(0,0);
zb_int24_t g_attr_meter_identification_power_threshold = ZB_INIT_UINT24(0,0);
/* Fan Control cluster attributes data */
zb_uint8_t g_attr_fan_control_fan_mode = ZB_ZCL_FAN_CONTROL_FAN_MODE_DEFAULT_VALUE;
zb_uint8_t g_attr_fan_control_fan_mode_sequence = ZB_ZCL_FAN_CONTROL_FAN_MODE_SEQUENCE_DEFAULT_VALUE;
/* Thermostat User Interface Configuration cluster attributes data */
zb_uint8_t g_attr_thermostat_ui_config_temperature_display_mode = ZB_ZCL_THERMOSTAT_UI_CONFIG_TEMPERATURE_DISPLAY_MODE_DEFAULT_VALUE;
zb_uint8_t g_attr_thermostat_ui_config_keypad_lockout = ZB_ZCL_THERMOSTAT_UI_CONFIG_KEYPAD_LOCKOUT_DEFAULT_VALUE;
ZB_ZCL_DECLARE_IDENTIFY_ATTRIB_LIST(identify_attr_list, &g_attr_identify_identify_time);
ZB_ZCL_DECLARE_METER_IDENTIFICATION_ATTRIB_LIST(meter_identification_attr_list, &g_attr_meter_identification_company_name, &g_attr_meter_identification_meter_type_id, &g_attr_meter_identification_data_quality_id, &g_attr_meter_identification_pod, &g_attr_meter_identification_available_power, &g_attr_meter_identification_power_threshold);
ZB_ZCL_DECLARE_FAN_CONTROL_ATTRIB_LIST(fan_control_attr_list, &g_attr_fan_control_fan_mode, &g_attr_fan_control_fan_mode_sequence);
ZB_ZCL_DECLARE_THERMOSTAT_UI_CONFIG_ATTRIB_LIST(thermostat_ui_config_attr_list, &g_attr_thermostat_ui_config_temperature_display_mode, &g_attr_thermostat_ui_config_keypad_lockout);
/********************* Declare device **************************/
ZB_HA_DECLARE_HA_TEST_SAMPLE_2_CLUSTER_LIST(ha_test_sample_2_clusters, basic_attr_list, identify_attr_list, meter_identification_attr_list, fan_control_attr_list, thermostat_ui_config_attr_list);
ZB_HA_DECLARE_HA_TEST_SAMPLE_2_EP(ha_test_sample_2_ep, ENDPOINT_C, ha_test_sample_2_clusters);
