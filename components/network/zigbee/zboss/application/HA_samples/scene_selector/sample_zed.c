...
*/
#define ZB_TRACE_FILE_ID 40239
#include "zboss_api.h"
#include "zb_led_button.h"
#include "zb_scene_selector.h"
...
ZB_HA_DECLARE_SCENE_SELECTOR_CLUSTER_LIST_ZED(scene_selector_clusters,  scenes_attr_list, groups_attr_list);
ZB_HA_DECLARE_SCENE_SELECTOR_EP_ZED(scene_selector_ep, ZB_SWITCH_ENDPOINT, scene_selector_clusters);
