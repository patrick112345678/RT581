...
*/
#define ZB_TRACE_FILE_ID 40199
#include "zboss_api.h"
#include "zb_led_button.h"
#include "zb_on_off_output.h"
...
/* [onoff_server_send_on_req_param] */
...
ZB_HA_DECLARE_ON_OFF_OUTPUT_CLUSTER_LIST_ZED(on_off_output_clusters);
ZB_HA_DECLARE_ON_OFF_OUTPUT_EP_ZED(on_off_output_ep, ZB_SWITCH_ENDPOINT, on_off_output_clusters);
ZB_HA_DECLARE_ON_OFF_OUTPUT_CTX(device_ctx, on_off_output_ep);
...
void test_next_step(zb_uint8_t param)
{
    ...
    case TEST_STEP_ON_OFF_SEND_ON_REQ:
    {
        ...
        g_test_step++;
        /* [onoff_server_send_on_req_command] */
