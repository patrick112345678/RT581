...
decode_dump()
{
    ...
    set - `ls thermostat_*dump`
    ../../../devtools/dump_converter/dump_converter $1 thermostat.pcap
}
...
../../../devtools/nsng/nsng ./nodes_location.cfg &
PipePID=$!
sleep 1
