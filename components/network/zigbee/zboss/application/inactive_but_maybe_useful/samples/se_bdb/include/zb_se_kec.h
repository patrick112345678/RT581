 ...
 */
#define ZB_KEC_MAX_PUBLIC_KEY_SIZE 37


/** @def ZB_KEC_MAX_PRIVATE_KEY_SIZE
 *  @brief Private key maximum size
 */
#define ZB_KEC_MAX_PRIVATE_KEY_SIZE 36
 ...
 */
#define ZB_KEC_MAX_CERT_SIZE 74


/** @def ZB_MAX_RND_SIZE
 *  @brief Ephemeral data maximum size
 */
#define ZB_MAX_RND_SIZE 36

/** @def ZB_KEC_HASH_LEN
 *  @brief KEC hash size
 */
#define ZB_KEC_HASH_LEN 16

#define ZB_KEC_RETRY_WAIT_TIME_DEFAULT (10 * ZB_TIME_ONE_SECOND)
 ...
 */
#define IS_KEC_KEY_AGREEMENT_FLAG(x) ( ( (x) & ZB_KU_KEY_AGREEMENT ) > 0 )
...
/** Non-standard ZBOSS extention: SE KE endpoint not found */
 ...
 *
 * Holds one of @ref kec_term_status. Kept only for backward compatibility as
 * @ref kec_term_status were declared previously as enum. Can be removed in future releases.
 */
