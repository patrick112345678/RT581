 ...
 *  @par Example
 *  @n Declare clusters
 *  @snippet DOXYGEN_SNIPPETS.dox DECLARE_CLUSTERS_samples_se_in_home_display_se_ihd_zr_c
 *  @n Register device context
 *  @snippet DOXYGEN_SNIPPETS.dox REGISTER_DEVICE_CTX_samples_se_in_home_display_se_ihd_zr_c
 *  @n Command handler example
 *  @snippet DOXYGEN_SNIPPETS.dox COMMAND_HANDLER_samples_se_in_home_display_se_ihd_zr_c
 *  @n Signal handler example
 *  @snippet DOXYGEN_SNIPPETS.dox SIGNAL_HANDLER_samples_se_in_home_display_se_ihd_zr_c
 *  @{
 */
...
#define ZB_BDB_DEVICE_VER_IN_HOME_DISPLAY     1
...
#define ZB_BDB_IN_HOME_DISPLAY_IN_CLUSTER_NUM  1
#define ZB_BDB_IN_HOME_DISPLAY_OUT_CLUSTER_NUM 3
#define ZB_BDB_IN_HOME_DISPLAY_CLUSTER_NUM \
  (ZB_BDB_IN_HOME_DISPLAY_IN_CLUSTER_NUM + ZB_BDB_IN_HOME_DISPLAY_OUT_CLUSTER_NUM)
...
#define ZB_BDB_IN_HOME_DISPLAY_REPORT_ATTR_COUNT 0
...
#define ZB_BDB_DECLARE_IN_HOME_DISPLAY_CLUSTER_LIST(cluster_list_name,  \
                                                    basic_attr_list)  \
  zb_zcl_cluster_desc_t cluster_list_name[] =                         \
  {                                                                   \
    ZB_ZCL_CLUSTER_DESC(                                              \
 ...
 */
#define ZB_SE_DECLARE_IN_HOME_DISPLAY_SIMPLE_DESC(ep_name,                     \
                                                   ep_id,                      \
                                                   in_clust_num,               \
                                                   out_clust_num)              \
...
#define ZB_BDB_DECLARE_IN_HOME_DISPLAY_SIMPLE_DESC(ep_name,                    \
                                                   ep_id,                      \
                                                   in_clust_num,               \
                                                   out_clust_num)              \
  ZB_DECLARE_SIMPLE_DESC(in_clust_num, out_clust_num);                         \
  ...
  {                                                                            \
    ...
    ZB_AF_HA_PROFILE_ID,                                                       \
    ZB_SE_IN_HOME_DISPLAY_DEVICE_ID,                                           \
    ZB_BDB_DEVICE_VER_IN_HOME_DISPLAY,                                         \
    0,                                                                         \
    in_clust_num,                                                              \
    out_clust_num,                                                             \
    {                                                                          \
...
#define ZB_SE_DECLARE_IN_HOME_DISPLAY_EP(ep_name, ep_id, cluster_list)                \
  ZB_SE_DECLARE_IN_HOME_DISPLAY_SIMPLE_DESC(ep_name,                                 \
                                             ep_id,                                   \
...
#define ZB_BDB_DECLARE_IN_HOME_DISPLAY_EP(ep_name, ep_id, cluster_list)                  \
  ZB_BDB_DECLARE_IN_HOME_DISPLAY_SIMPLE_DESC(ep_name,                                   \
                                             ep_id,                                     \
                                             ZB_BDB_IN_HOME_DISPLAY_IN_CLUSTER_NUM,      \
                                             ZB_BDB_IN_HOME_DISPLAY_OUT_CLUSTER_NUM);    \
  ZB_AF_DECLARE_ENDPOINT_DESC(ep_name,                                  \
                              ep_id,                                    \
                          ZB_AF_HA_PROFILE_ID,                                          \
                          0,                                                            \
 ...
 *  @param ep_name - endpoint variable name.
 */
#define ZB_DECLARE_IN_HOME_DISPLAY_CTX(device_ctx_name, ep1_name, ep2_name)  \
