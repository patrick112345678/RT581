 ...
 * DSR.
 */
/* PURPOSE: Dimmable Light sample for HA profile
*/

#define ZB_TRACE_FILE_ID 40157
#include "zb_common.h"
...
/* 2018/08/10 CR:MINOR (rev. 39308): Hmm, COORDINATOR_ROLE check and ED role inside :) */
#if ! defined ZB_COORDINATOR_ROLE
#error define ZB_COORDINATOR_ROLE to compile ze tests
#endif


#define HA_DIMMABLE_LIGHT_ENDPOINT          21
...
ZB_HA_DECLARE_DIMMABLE_LIGHT_EP(dimmable_light_ep,
...
MAIN()
{
  ...
  ZB_INIT("ha_dimmable_light_sample");
