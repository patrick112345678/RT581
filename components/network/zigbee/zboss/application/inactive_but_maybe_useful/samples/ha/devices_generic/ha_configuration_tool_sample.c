 ...
 * DSR.
 */
/* PURPOSE: Configuration tool device sample for HA profile
*/
...
#define HA_CONFIGURATION_TOOL_ENDPOINT          11
...
ZB_HA_DECLARE_CONFIGURATION_TOOL_CLUSTER_LIST(configuration_tool_clusters, basic_attr_list, identify_attr_list);

ZB_HA_DECLARE_CONFIGURATION_TOOL_EP(configuration_tool_ep, HA_CONFIGURATION_TOOL_ENDPOINT, configuration_tool_clusters);

ZB_HA_DECLARE_CONFIGURATION_TOOL_CTX(configuration_tool_ctx, configuration_tool_ep);
/** [COMMON_DECLARATION] */
...
MAIN()
{
  ...
  ZB_INIT("ha_configuration_tool_sample");
  ...
  /****************** Register Device ********************************/
  /** [REGISTER] */
  ZB_AF_REGISTER_DEVICE_CTX(&configuration_tool_ctx);
  ZB_AF_SET_ENDPOINT_HANDLER(HA_CONFIGURATION_TOOL_ENDPOINT, zcl_specific_cluster_cmd_handler);
  /** [REGISTER] */
