...
/* 2018/08/10 CR:MEDIUM (rev. 39308): Either remove or properly fix - do not left the code commented by unknown
 * reason.
 * I understand you commented it because of compilation error, but finalize the fix by modifying or
 * removing this code. */
#define LED_ON()  /* zb_osif_led_on(0) */
#define LED_OFF() /* zb_osif_led_off(0) */
...
MAIN()
{
    ...
    ZB_INIT("ha_on_off_output_sample");
