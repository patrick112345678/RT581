...
static void bdb_finding_binding_initiator_delayed(zb_uint8_t param)
{
  ZVUNUSED(param);
      ...
      case ZB_BDB_SIGNAL_FINDING_AND_BINDING_INITIATOR_FINISHED:
      {
        ...
        if (!all_endpoints_binded)
        {
          ...
          ZB_SCHEDULE_APP_ALARM(
            bdb_finding_binding_initiator_delayed,
            0,
            ZB_BDBC_MIN_COMMISSIONING_TIME_S * ZB_TIME_ONE_SECOND);
        }
#endif
      }
      break;
