...
/* Used channel */
#define IHD_DEV_CHANNEL_MASK (1L << 19)
/** [IHD_DEV_DEFINE_PARAMS] */
...
void zboss_signal_handler(zb_uint8_t param)
{
    ...
    if (ZB_GET_APP_SIGNAL_STATUS(param) == 0)
    {
             ...
             */
        {
            ...
            {
                zb_ieee_addr_t met_addr = MET_DEV_ADDR;
                zb_uint16_t met_short_addr =   zb_address_short_by_ieee(met_addr);
                zb_buf_get_out_delayed_ext(se_send_key_est_match_desc_addr, met_short_addr, 0);
            }
            // do not test partner_lk from our side for whitelist test
            //if (n_sig == 0)
            //{
...
static void test_partner_lk(zb_uint8_t param)
{
    ...
    {
        zb_ieee_addr_t ihd_addr = PEER_DEV_ADDR;
