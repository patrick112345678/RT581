...
/* Tha application callback to get size of application-specific NVRAM dataset */
...
void metering_dev_app_init(zb_uint8_t param)
{
    ...
    /* Set up long address of the device and PAN ID if production configuration is disabled */
#ifdef ENABLE_RUNTIME_APP_CONFIG
    ...
    /* Set up device's role in a network and used channel  */
