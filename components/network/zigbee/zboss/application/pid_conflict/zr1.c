...
/* PURPOSE: Sample application showing behavior of a ZR that does NOT
 * handle PAN ID conflict.
 */

#define ZB_TRACE_FILE_ID 40108
...
static const zb_ieee_addr_t g_zr1_addr = IEEE_ADDR_ZR1;
  ...
  if (ZB_GET_APP_SIGNAL_STATUS(param) == 0)
  {
    switch(sig)
    {
      ...
      case ZB_NWK_SIGNAL_PANID_CONFLICT_DETECTED:
        TRACE_MSG(TRACE_APP1, "I can't detect PID conflicts.", (FMT__0));
        ZB_ASSERT(ZB_FALSE);
        break;
