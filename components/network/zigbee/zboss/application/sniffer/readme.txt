Sniffer application based on Onsemi platform. To be used with ZBOSS Sniffer application (from devtools) and Wireshark.
Starts in promiscuous mode and send captured packets via UART1 to host;
support several commands from host: stop/start and select channel.

Setup:
===========
1. Flash Onsemi or Telink board with sniffer.
