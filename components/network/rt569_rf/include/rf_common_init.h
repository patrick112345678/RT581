...
#define RF_CAL_TYPE                 (RF_CAL_PWR_ON_MODE|RF_CAL_FT_MODE)
#else
...
#define RF_FW_INCLUDE_MAC_ACC       (TRUE)
#endif

#ifndef RF_FW_INCLUDE_HYBRID_INST
#define RF_FW_INCLUDE_HYBRID_INST   (TRUE)
#endif
...
#define RF_FW_LOAD_SELECT_MX_HYBRID_INSTRUCTION   ((RF_FW_LOAD_SELECT)0x21)
...
void rf_common_tx_pwr_comp_seg_set(uint8_t seg_a, uint8_t seg_b, uint8_t seg_c, uint8_t modemType);
